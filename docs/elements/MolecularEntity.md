...
URI: [namo:MolecularEntity](https://w3id.org/monarch-initiative/namo/MolecularEntity)
...
```mermaid
 classDiagram
    ...
    click MolecularEntity href "../MolecularEntity/"
      ...
      MolecularEntity : broad_synonym
        
      MolecularEntity : category
        
      MolecularEntity : chembl_availability_type
        
      MolecularEntity : chembl_black_box_warning
        
      MolecularEntity : chembl_chirality
        
      MolecularEntity : chembl_drug_warning
        
      MolecularEntity : chembl_natural_product
        
      MolecularEntity : chembl_prodrug
        
      MolecularEntity : deprecated
        
      MolecularEntity : description
        
      MolecularEntity : equivalent_identifiers
        
      MolecularEntity : exact_synonym
      ...
      MolecularEntity : information_content
      ...
      MolecularEntity : narrow_synonym
        
      MolecularEntity : provided_by
        
      MolecularEntity : related_synonym
        
      MolecularEntity : routes_of_delivery
        
          
    
        
        
        MolecularEntity --> "*" DrugDeliveryEnum : routes_of_delivery
        click DrugDeliveryEnum href "../DrugDeliveryEnum/"
    

        
      MolecularEntity : subsets
        
      MolecularEntity : synonym
        
      MolecularEntity : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [ChemicalEntity](ChemicalEntity.md) [ [PhysicalEssence](PhysicalEssence.md) [ChemicalOrDrugOrTreatment](ChemicalOrDrugOrTreatment.md) [ChemicalEntityOrGeneOrGeneProduct](ChemicalEntityOrGeneOrGeneProduct.md) [ChemicalEntityOrProteinOrPolypeptide](ChemicalEntityOrProteinOrPolypeptide.md)]
            * **MolecularEntity** [ [OntologyClass](OntologyClass.md)]
...
| ---  | --- | --- | --- |
| [is_metabolite](is_metabolite.md) | 0..1 <br/> [Boolean](Boolean.md) | indicates whether a molecular entity is a metabolite | direct |
...
| ---  | --- | --- | --- |
| [MolecularEntity](MolecularEntity.md) | [is_metabolite](is_metabolite.md) | domain | [MolecularEntity](MolecularEntity.md) |
| [SmallMolecule](SmallMolecule.md) | [is_metabolite](is_metabolite.md) | domain | [MolecularEntity](MolecularEntity.md) |
| [NucleicAcidEntity](NucleicAcidEntity.md) | [is_metabolite](is_metabolite.md) | domain | [MolecularEntity](MolecularEntity.md) |
| [MolecularActivity](MolecularActivity.md) | [has_input](has_input.md) | range | [MolecularEntity](MolecularEntity.md) |
| [MolecularActivity](MolecularActivity.md) | [has_output](has_output.md) | range | [MolecularEntity](MolecularEntity.md) |
| [PairwiseMolecularInteraction](PairwiseMolecularInteraction.md) | [subject](subject.md) | range | [MolecularEntity](MolecularEntity.md) |
| [PairwiseMolecularInteraction](PairwiseMolecularInteraction.md) | [object](object.md) | range | [MolecularEntity](MolecularEntity.md) |
| [ReactionToParticipantAssociation](ReactionToParticipantAssociation.md) | [subject](subject.md) | range | [MolecularEntity](MolecularEntity.md) |
| [ReactionToCatalystAssociation](ReactionToCatalystAssociation.md) | [subject](subject.md) | range | [MolecularEntity](MolecularEntity.md) |
...
| ---  | ---  |
| self | namo:MolecularEntity |
| native | namo:MolecularEntity |
| narrow | STY:T088, STY:T085, CHEBI:23367, bioschemas:MolecularEntity |
