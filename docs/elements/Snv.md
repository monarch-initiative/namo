...
_SNVs are single nucleotide positions in genomic DNA at which different sequence alternatives exist_
...
URI: [namo:Snv](https://w3id.org/monarch-initiative/namo/Snv)
...
| ---  | --- | --- | --- |
| [has_gene](has_gene.md) | * <br/> [Gene](Gene.md) | Each allele can be associated with any number of genes | [SequenceVariant](SequenceVariant.md) |
| [hgvs_nomenclature](hgvs_nomenclature.md) | * <br/> [String](String.md) | HGVS syntax refers to the specific rules and conventions used by the Human Va... | [SequenceVariant](SequenceVariant.md) |
