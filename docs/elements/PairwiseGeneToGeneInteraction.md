...
_An interaction between two genes or two gene products. May be physical (e.g. protein binding) or genetic (between genes). May be symmetric (e.g. protein interaction) or directed (e.g. phosphorylation)_
...
URI: [namo:PairwiseGeneToGeneInteraction](https://w3id.org/monarch-initiative/namo/PairwiseGeneToGeneInteraction)
...
```mermaid
 classDiagram
    class PairwiseGeneToGeneInteraction
    click PairwiseGeneToGeneInteraction href "../PairwiseGeneToGeneInteraction/"
      ...
      PairwiseGeneToGeneInteraction <|-- PairwiseMolecularInteraction
        click PairwiseMolecularInteraction href "../PairwiseMolecularInteraction/"
      ...
      PairwiseGeneToGeneInteraction : agent_type
        ...
        PairwiseGeneToGeneInteraction --> "1" AgentTypeEnum : agent_type
      ...
      PairwiseGeneToGeneInteraction : causal_mechanism_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" CausalMechanismQualifierEnum : causal_mechanism_qualifier
      ...
      PairwiseGeneToGeneInteraction : elevate_to_prediction
        
      PairwiseGeneToGeneInteraction : evidence_count
      ...
      PairwiseGeneToGeneInteraction : has_confidence_score
      ...
      PairwiseGeneToGeneInteraction : has_evidence
        ...
        PairwiseGeneToGeneInteraction --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      PairwiseGeneToGeneInteraction : has_evidence_of_type
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      PairwiseGeneToGeneInteraction : has_supporting_studies
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "*" Study : has_supporting_studies
      ...
      PairwiseGeneToGeneInteraction : knowledge_level
        ...
        PairwiseGeneToGeneInteraction --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      PairwiseGeneToGeneInteraction : object
        ...
        PairwiseGeneToGeneInteraction --> "1" GeneOrGeneProduct : object
        click GeneOrGeneProduct href "../GeneOrGeneProduct/"
    

        
      PairwiseGeneToGeneInteraction : object_activity_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" MolecularActivity : object_activity_qualifier
        click MolecularActivity href "../MolecularActivity/"
    

        
      PairwiseGeneToGeneInteraction : object_aspect_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      PairwiseGeneToGeneInteraction : object_category
        ...
        PairwiseGeneToGeneInteraction --> "0..1" OntologyClass : object_category
      ...
      PairwiseGeneToGeneInteraction : object_context_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" AnatomicalEntity : object_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      PairwiseGeneToGeneInteraction : object_direction_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      PairwiseGeneToGeneInteraction : object_feature_name
        
      PairwiseGeneToGeneInteraction : object_label_closure
        
      PairwiseGeneToGeneInteraction : object_namespace
        
      PairwiseGeneToGeneInteraction : object_process_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" BiologicalProcess : object_process_qualifier
      ...
      PairwiseGeneToGeneInteraction : qualified_predicate
      ...
      PairwiseGeneToGeneInteraction : semmed_agreement_count
        
      PairwiseGeneToGeneInteraction : sources
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
    

        
      PairwiseGeneToGeneInteraction : species_context_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" OrganismTaxon : species_context_qualifier
      ...
      PairwiseGeneToGeneInteraction : subject
        ...
        PairwiseGeneToGeneInteraction --> "1" GeneOrGeneProduct : subject
        click GeneOrGeneProduct href "../GeneOrGeneProduct/"
    

        
      PairwiseGeneToGeneInteraction : subject_activity_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" MolecularActivity : subject_activity_qualifier
        click MolecularActivity href "../MolecularActivity/"
    

        
      PairwiseGeneToGeneInteraction : subject_aspect_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      PairwiseGeneToGeneInteraction : subject_category
        ...
        PairwiseGeneToGeneInteraction --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      PairwiseGeneToGeneInteraction : subject_context_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" AnatomicalEntity : subject_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      PairwiseGeneToGeneInteraction : subject_direction_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      PairwiseGeneToGeneInteraction : subject_feature_name
        
      PairwiseGeneToGeneInteraction : subject_label_closure
        
      PairwiseGeneToGeneInteraction : subject_namespace
        
      PairwiseGeneToGeneInteraction : subject_process_qualifier
        
          
    
        
        
        PairwiseGeneToGeneInteraction --> "0..1" BiologicalProcess : subject_process_qualifier
        click BiologicalProcess href "../BiologicalProcess/"
    

        
      PairwiseGeneToGeneInteraction : supporting_text
        
      PairwiseGeneToGeneInteraction : timepoint
        
      PairwiseGeneToGeneInteraction : type
        
      PairwiseGeneToGeneInteraction : update_date
...
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | interaction relationship type | [GeneToGeneAssociation](GeneToGeneAssociation.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:PairwiseGeneToGeneInteraction |
| native | namo:PairwiseGeneToGeneInteraction |
| narrow | dcid:ProteinProteinInteraction |
...
attributes:
  subject aspect qualifier:
    ...
    owner: pairwise gene to gene interaction
    domain_of:
    - predicate mapping
