...
_An association between a biochemical reaction and a participating molecular entity, qualified by the stoichiometry, the side (reactant vs. product) on which the participant appears, and the direction of the reaction._
...
URI: [namo:ReactionToParticipantAssociation](https://w3id.org/monarch-initiative/namo/ReactionToParticipantAssociation)
 ...
 classDiagram
    ...
    click ReactionToParticipantAssociation href "../ReactionToParticipantAssociation/"
      ...
      ReactionToParticipantAssociation <|-- ReactionToCatalystAssociation
        click ReactionToCatalystAssociation href "../ReactionToCatalystAssociation/"
      ...
      ReactionToParticipantAssociation : agent_type
        ...
        ReactionToParticipantAssociation --> "1" AgentTypeEnum : agent_type
      ...
      ReactionToParticipantAssociation : elevate_to_prediction
        
      ReactionToParticipantAssociation : evidence_count
      ...
      ReactionToParticipantAssociation : has_confidence_score
      ...
      ReactionToParticipantAssociation : has_evidence
        ...
        ReactionToParticipantAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      ReactionToParticipantAssociation : has_evidence_of_type
        
          
    
        
        
        ReactionToParticipantAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      ReactionToParticipantAssociation : has_supporting_studies
        
          
    
        
        
        ReactionToParticipantAssociation --> "*" Study : has_supporting_studies
      ...
      ReactionToParticipantAssociation : knowledge_level
        ...
        ReactionToParticipantAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      ReactionToParticipantAssociation : object
        ...
        ReactionToParticipantAssociation --> "1" ChemicalEntity : object
      ...
      ReactionToParticipantAssociation : object_category
        ...
        ReactionToParticipantAssociation --> "0..1" OntologyClass : object_category
      ...
      ReactionToParticipantAssociation : object_feature_name
      ...
      ReactionToParticipantAssociation : reaction_direction
        ...
        ReactionToParticipantAssociation --> "0..1" ReactionDirectionEnum : reaction_direction
        click ReactionDirectionEnum href "../ReactionDirectionEnum/"
      ...
      ReactionToParticipantAssociation : reaction_side
        ...
        ReactionToParticipantAssociation --> "0..1" ReactionSideEnum : reaction_side
        click ReactionSideEnum href "../ReactionSideEnum/"
      ...
      ReactionToParticipantAssociation : semmed_agreement_count
        
      ReactionToParticipantAssociation : sources
        
          
    
        
        
        ReactionToParticipantAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
    

        
      ReactionToParticipantAssociation : species_context_qualifier
        
          
    
        
        
        ReactionToParticipantAssociation --> "0..1" OrganismTaxon : species_context_qualifier
      ...
      ReactionToParticipantAssociation : subject
        ...
        ReactionToParticipantAssociation --> "1" MolecularEntity : subject
      ...
      ReactionToParticipantAssociation : subject_category
        ...
        ReactionToParticipantAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [stoichiometry](stoichiometry.md) | 0..1 <br/> [Integer](Integer.md) | the relationship between the relative quantities of substances taking part in... | direct |
| [reaction_direction](reaction_direction.md) | 0..1 <br/> [ReactionDirectionEnum](ReactionDirectionEnum.md) | the direction of a reaction as constrained by the direction enum (ie: left_to... | direct |
| [reaction_side](reaction_side.md) | 0..1 <br/> [ReactionSideEnum](ReactionSideEnum.md) | the side of a reaction being modeled (ie: left or right) | direct |
| [subject](subject.md) | 1 <br/> [MolecularEntity](MolecularEntity.md) | connects an association to the subject of the association | [Association](Association.md), [ChemicalEntityToChemicalEntityAssociation](ChemicalEntityToChemicalEntityAssociation.md) |
...
| [object](object.md) | 1 <br/> [ChemicalEntity](ChemicalEntity.md) | the chemical element that is the target of the statement | [Association](Association.md), [ChemicalEntityToChemicalEntityAssociation](ChemicalEntityToChemicalEntityAssociation.md) |
...
| ---  | ---  |
| self | namo:ReactionToParticipantAssociation |
| native | namo:ReactionToParticipantAssociation |
...
description: An association between a biochemical reaction and a participating molecular
  entity, qualified by the stoichiometry, the side (reactant vs. product) on which
  the participant appears, and the direction of the reaction.
...
attributes:
  ...
  reaction direction:
    ...
    description: 'the direction of a reaction as constrained by the direction enum
