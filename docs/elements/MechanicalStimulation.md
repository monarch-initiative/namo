...
```mermaid
 classDiagram
    ...
    click MechanicalStimulation href "../MechanicalStimulation/"
      ...
      MechanicalStimulation : broad_synonym
        
      MechanicalStimulation : category
        
      MechanicalStimulation : cyclic_stretch_percent
        
      MechanicalStimulation : deprecated
        
      MechanicalStimulation : description
        
      MechanicalStimulation : duration_minutes
        
      MechanicalStimulation : equivalent_identifiers
        
      MechanicalStimulation : exact_synonym
        
      MechanicalStimulation : frequency_hz
        
      MechanicalStimulation : full_name
        
      MechanicalStimulation : has_attribute
        
          
    
        
        
        MechanicalStimulation --> "*" Attribute : has_attribute
      ...
      MechanicalStimulation : information_content
        
      MechanicalStimulation : iri
        
      MechanicalStimulation : name
        
      MechanicalStimulation : narrow_synonym
        
      MechanicalStimulation : pressure_pascal
        
      MechanicalStimulation : provided_by
        
      MechanicalStimulation : related_synonym
      ...
      MechanicalStimulation : synonym
        
      MechanicalStimulation : taxon
        
      MechanicalStimulation : type
        
      MechanicalStimulation : xref
