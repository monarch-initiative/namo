...
# Slot: elevate_to_prediction 


_A boolean flag indicating whether a clinical trial finding should be elevated to a prediction._
...
URI: [namo:elevate_to_prediction](https://w3id.org/monarch-initiative/namo/elevate_to_prediction)
...
| ---  | ---  |
| self | namo:elevate_to_prediction |
| native | namo:elevate_to_prediction |
...
description: A boolean flag indicating whether a clinical trial finding should be
