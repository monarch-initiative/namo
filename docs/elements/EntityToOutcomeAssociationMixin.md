...
URI: [namo:EntityToOutcomeAssociationMixin](https://w3id.org/monarch-initiative/namo/EntityToOutcomeAssociationMixin)
 ...
 classDiagram
    ...
    click EntityToOutcomeAssociationMixin href "../EntityToOutcomeAssociationMixin/"
      ...
      EntityToOutcomeAssociationMixin : object
        ...
        EntityToOutcomeAssociationMixin --> "1" Outcome : object
      ...
      EntityToOutcomeAssociationMixin : subject
        ...
        EntityToOutcomeAssociationMixin --> "1" NamedThing : subject
...
| [object](object.md) | 1 <br/> [Outcome](Outcome.md) | connects an association to the object of the association | direct |
...
| ---  | ---  |
| self | namo:EntityToOutcomeAssociationMixin |
| native | namo:EntityToOutcomeAssociationMixin |
...
attributes:
  subject:
    ...
    owner: entity to outcome association mixin
    domain_of:
    - association
