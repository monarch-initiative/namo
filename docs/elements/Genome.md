...
_A genome is the sum of genetic material within a cell or virion._
...
URI: [namo:Genome](https://w3id.org/monarch-initiative/namo/Genome)
...
```mermaid
 classDiagram
    ...
    click Genome href "../Genome/"
      ...
      Genome : equivalent_identifiers
        
      Genome : exact_synonym
      ...
      Genome : information_content
        
      Genome : iri
        
      Genome : name
        
      Genome : narrow_synonym
        
      Genome : provided_by
        
      Genome : related_synonym
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **Genome** [ [GenomicEntity](GenomicEntity.md) [PhysicalEssence](PhysicalEssence.md) [OntologyClass](OntologyClass.md)]
