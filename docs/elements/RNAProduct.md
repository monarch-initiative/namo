...
_High molecular weight, linear polymers, composed of nucleotides containing ribose and linked by phosphodiester bonds typically synthesized by a DNA- or RNA-dependent RNA polymerase that constitutes the product of a gene. Distinct in emphasis from `biolink:Transcript`, which denotes the informational output of transcription at the gene-model level rather than the chemical species itself._
...
URI: [namo:RNAProduct](https://w3id.org/monarch-initiative/namo/RNAProduct)
 ...
 classDiagram
    ...
    click RNAProduct href "../RNAProduct/"
      ...
      RNAProduct <|-- NoncodingRNAProduct
        click NoncodingRNAProduct href "../NoncodingRNAProduct/"
      

      RNAProduct : broad_synonym
      ...
      RNAProduct : equivalent_identifiers
        
      RNAProduct : exact_synonym
      ...
      RNAProduct : information_content
        
      RNAProduct : iri
        
      RNAProduct : name
        
      RNAProduct : narrow_synonym
        
      RNAProduct : provided_by
        
      RNAProduct : related_synonym
...
| ---  | --- | --- | --- |
| [synonym](synonym.md) | * <br/> [LabelType](LabelType.md) | Alternate human-readable names for a thing | [GeneProductMixin](GeneProductMixin.md), [NamedThing](NamedThing.md) |
| [xref](xref.md) | * <br/> [Uriorcurie](Uriorcurie.md) | A database cross reference or alternative identifier for a NamedThing or edge... | [GeneProductMixin](GeneProductMixin.md), [NamedThing](NamedThing.md) |
...
| ---  | ---  |
| self | namo:RNAProduct |
| native | namo:RNAProduct |
...
- RNACENTRAL
- mirbase
description: High molecular weight, linear polymers, composed of nucleotides containing
  ribose and linked by phosphodiester bonds typically synthesized by a DNA- or RNA-dependent
  RNA polymerase that constitutes the product of a gene. Distinct in emphasis from
  `biolink:Transcript`, which denotes the informational output of transcription at
  the gene-model level rather than the chemical species itself.
examples:
