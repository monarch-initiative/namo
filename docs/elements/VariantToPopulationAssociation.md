...
URI: [namo:VariantToPopulationAssociation](https://w3id.org/monarch-initiative/namo/VariantToPopulationAssociation)
 ...
 classDiagram
    ...
    click VariantToPopulationAssociation href "../VariantToPopulationAssociation/"
      ...
      VariantToPopulationAssociation : agent_type
        ...
        VariantToPopulationAssociation --> "1" AgentTypeEnum : agent_type
      ...
      VariantToPopulationAssociation : elevate_to_prediction
        
      VariantToPopulationAssociation : evidence_count
      ...
      VariantToPopulationAssociation : has_confidence_score
      ...
      VariantToPopulationAssociation : has_evidence
        ...
        VariantToPopulationAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      VariantToPopulationAssociation : has_evidence_of_type
        
          
    
        
        
        VariantToPopulationAssociation --> "*" EvidenceType : has_evidence_of_type
      ...
      VariantToPopulationAssociation : knowledge_level
        ...
        VariantToPopulationAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      VariantToPopulationAssociation : object
        ...
        VariantToPopulationAssociation --> "1" PopulationOfIndividualOrganisms : object
      ...
      VariantToPopulationAssociation : object_category
        ...
        VariantToPopulationAssociation --> "0..1" OntologyClass : object_category
      ...
      VariantToPopulationAssociation : object_feature_name
      ...
      VariantToPopulationAssociation : semmed_agreement_count
        
      VariantToPopulationAssociation : sources
        
          
    
        
        
        VariantToPopulationAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      VariantToPopulationAssociation : subject
        ...
        VariantToPopulationAssociation --> "1" SequenceVariant : subject
      ...
      VariantToPopulationAssociation : subject_category
        ...
        VariantToPopulationAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToPopulationAssociation** [ [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md) [FrequencyQuantifier](FrequencyQuantifier.md) [FrequencyQualifierMixin](FrequencyQualifierMixin.md)]
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [SequenceVariant](SequenceVariant.md) | an allele that has a certain frequency in a given population | [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [Association](Association.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | Has a value from the Biolink 'related_to' hierarchy | [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [Association](Association.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md) |
| [object](object.md) | 1 <br/> [PopulationOfIndividualOrganisms](PopulationOfIndividualOrganisms.md) | the population that is observed to have the frequency | [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [Association](Association.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md) |
| [has_count](has_count.md) | 0..1 <br/> [Integer](Integer.md) | number in object population that carry a particular allele, aka allele count | [FrequencyQuantifier](FrequencyQuantifier.md) |
| [has_total](has_total.md) | 0..1 <br/> [Integer](Integer.md) | number all populations that carry a particular allele, aka allele number | [FrequencyQuantifier](FrequencyQuantifier.md) |
| [has_quotient](has_quotient.md) | 0..1 <br/> [Double](Double.md) | frequency of allele in population, expressed as a number with allele divided ... | [FrequencyQuantifier](FrequencyQuantifier.md) |
...
| ---  | ---  |
| self | namo:VariantToPopulationAssociation |
| native | namo:VariantToPopulationAssociation |
