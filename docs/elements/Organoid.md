...
```mermaid
 classDiagram
    ...
    click Organoid href "../Organoid/"
      ...
      Organoid : equivalent_identifiers
        
      Organoid : exact_synonym
        
      Organoid : full_name
        
      Organoid : has_attribute
        
          
    
        
        
        Organoid --> "*" Attribute : has_attribute
