...
_A database cross reference or alternative identifier for a NamedThing or edge between two NamedThings.  This property should point to a database record or webpage that supports the existence of the edge, or gives more detail about the edge. This property can be used on a node or edge to provide multiple URIs or CURIE cross references._
...
URI: [namo:xref](https://w3id.org/monarch-initiative/namo/xref)
...
| Domain Of | [NamedThing](NamedThing.md), [Publication](Publication.md), [RetrievalSource](RetrievalSource.md), [Gene](Gene.md), [GeneProductMixin](GeneProductMixin.md) |
...
| self | namo:xref |
| native | namo:xref |
| narrow | gff3:Dbxref, gpi:DB_Xrefs |
