...
# Slot: has_evidence_of_type 


_Connects an association to an evidence type ontology term. Generally represents terms from the ECO ontology._
...
URI: [namo:has_evidence_of_type](https://w3id.org/monarch-initiative/namo/has_evidence_of_type)
...
| ---  | ---  |
| self | namo:has_evidence_of_type |
| native | namo:has_evidence_of_type |
