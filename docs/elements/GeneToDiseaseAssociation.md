...
_An association between a gene or gene product and a disease, where variation in the gene is correlated with the disease._
...
URI: [namo:GeneToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/GeneToDiseaseAssociation)
 ...
 classDiagram
    ...
    click GeneToDiseaseAssociation href "../GeneToDiseaseAssociation/"
      ...
      GeneToDiseaseAssociation <|-- GeneHasVariantThatContributesToDiseaseAssociation
        click GeneHasVariantThatContributesToDiseaseAssociation href "../GeneHasVariantThatContributesToDiseaseAssociation/"
      ...
      GeneToDiseaseAssociation : agent_type
        ...
        GeneToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GeneToDiseaseAssociation : allelic_requirement
      ...
      GeneToDiseaseAssociation : diseases_confidence_score
        
      GeneToDiseaseAssociation : elevate_to_prediction
        
      GeneToDiseaseAssociation : evidence_count
        
      GeneToDiseaseAssociation : gene2phenotype_confidence_category
      ...
      GeneToDiseaseAssociation : has_confidence_score
      ...
      GeneToDiseaseAssociation : has_evidence
        ...
        GeneToDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GeneToDiseaseAssociation : has_evidence_of_type
      ...
      GeneToDiseaseAssociation : knowledge_level
        ...
        GeneToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GeneToDiseaseAssociation : object
        ...
        GeneToDiseaseAssociation --> "1" Disease : object
      ...
      GeneToDiseaseAssociation : object_category
        ...
        GeneToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      GeneToDiseaseAssociation : object_direction_qualifier
        ...
        GeneToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      GeneToDiseaseAssociation : object_feature_name
      ...
      GeneToDiseaseAssociation : predicate
        ...
        GeneToDiseaseAssociation --> "1" GeneToDiseasePredicateEnum : predicate
      ...
      GeneToDiseaseAssociation : semmed_agreement_count
        
      GeneToDiseaseAssociation : sources
        
          
    
        
        
        GeneToDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GeneToDiseaseAssociation : subject
        ...
        GeneToDiseaseAssociation --> "1" GeneOrGeneProduct : subject
      ...
      GeneToDiseaseAssociation : subject_aspect_qualifier
        ...
        GeneToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
      ...
      GeneToDiseaseAssociation : subject_category
        ...
        GeneToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      GeneToDiseaseAssociation : subject_feature_name
        
      GeneToDiseaseAssociation : subject_form_or_variant_qualifier
        
          
    
        
        
        GeneToDiseaseAssociation --> "0..1" ChemicalOrGeneOrGeneProductFormOrVariantEnum : subject_form_or_variant_qualifier
      ...
      GeneToDiseaseAssociation : supporting_text
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **GeneToDiseaseAssociation** [ [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md)]
            * [DruggableGeneToDiseaseAssociation](DruggableGeneToDiseaseAssociation.md) [ [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md) [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md)]
            * [GeneAsAModelOfDiseaseAssociation](GeneAsAModelOfDiseaseAssociation.md) [ [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md) [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md)]
...
| [gene2phenotype_confidence_category](gene2phenotype_confidence_category.md) | 0..1 <br/> [String](String.md) | A term used by EBI Gene2Phenotype to describe the confidence that the associa... | direct |
| [subject](subject.md) | 1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | gene in which variation is correlated with the disease | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [GeneToDiseasePredicateEnum](GeneToDiseasePredicateEnum.md) | Has a value from the Biolink 'related_to' hierarchy | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [Association](Association.md) |
| [object](object.md) | 1 <br/> [Disease](Disease.md) | connects an association to the object of the association | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GeneToDiseaseAssociation |
| native | namo:GeneToDiseaseAssociation |
| exact | SIO:000983 |
...
attributes:
  subject form or variant qualifier:
    ...
    owner: gene to disease association
    domain_of:
    - predicate mapping
