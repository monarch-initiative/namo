...
_A region (or regions) of a chromatinized genome that has been measured to be more accessible to an enzyme such as DNase-I or Tn5 Transpose_
...
URI: [namo:AccessibleDnaRegion](https://w3id.org/monarch-initiative/namo/AccessibleDnaRegion)
...
```mermaid
 classDiagram
    ...
    click AccessibleDnaRegion href "../AccessibleDnaRegion/"
      ...
      AccessibleDnaRegion : broad_synonym
      ...
      AccessibleDnaRegion : equivalent_identifiers
        
      AccessibleDnaRegion : exact_synonym
      ...
      AccessibleDnaRegion : information_content
        
      AccessibleDnaRegion : iri
        
      AccessibleDnaRegion : name
        
      AccessibleDnaRegion : narrow_synonym
        
      AccessibleDnaRegion : provided_by
        
      AccessibleDnaRegion : related_synonym
        
      AccessibleDnaRegion : subsets
        
      AccessibleDnaRegion : synonym
        
      AccessibleDnaRegion : taxon
    ...
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * [RegulatoryRegion](RegulatoryRegion.md) [ [GenomicEntity](GenomicEntity.md) [ChemicalEntityOrGeneOrGeneProduct](ChemicalEntityOrGeneOrGeneProduct.md) [PhysicalEssence](PhysicalEssence.md) [OntologyClass](OntologyClass.md)]
                * **AccessibleDnaRegion** [ [GenomicEntity](GenomicEntity.md) [ChemicalEntityOrGeneOrGeneProduct](ChemicalEntityOrGeneOrGeneProduct.md) [PhysicalEssence](PhysicalEssence.md) [OntologyClass](OntologyClass.md)]
...
| ---  | ---  |
| self | namo:AccessibleDnaRegion |
| native | namo:AccessibleDnaRegion |
| exact | SO:0002231 |
