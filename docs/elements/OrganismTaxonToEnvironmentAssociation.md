...
_An abstract association between an organism taxon and an environmental context (e.g., a habitat, biome, or ecological setting) in which the taxon occurs._
...
URI: [namo:OrganismTaxonToEnvironmentAssociation](https://w3id.org/monarch-initiative/namo/OrganismTaxonToEnvironmentAssociation)
 ...
 classDiagram
    ...
    click OrganismTaxonToEnvironmentAssociation href "../OrganismTaxonToEnvironmentAssociation/"
      ...
      OrganismTaxonToEnvironmentAssociation : agent_type
        ...
        OrganismTaxonToEnvironmentAssociation --> "1" AgentTypeEnum : agent_type
      ...
      OrganismTaxonToEnvironmentAssociation : elevate_to_prediction
        
      OrganismTaxonToEnvironmentAssociation : evidence_count
      ...
      OrganismTaxonToEnvironmentAssociation : has_confidence_score
      ...
      OrganismTaxonToEnvironmentAssociation : has_evidence
        ...
        OrganismTaxonToEnvironmentAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      OrganismTaxonToEnvironmentAssociation : has_evidence_of_type
        
          
    
        
        
        OrganismTaxonToEnvironmentAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      OrganismTaxonToEnvironmentAssociation : has_supporting_studies
        
          
    
        
        
        OrganismTaxonToEnvironmentAssociation --> "*" Study : has_supporting_studies
      ...
      OrganismTaxonToEnvironmentAssociation : knowledge_level
        ...
        OrganismTaxonToEnvironmentAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      OrganismTaxonToEnvironmentAssociation : object
        ...
        OrganismTaxonToEnvironmentAssociation --> "1" NamedThing : object
      ...
      OrganismTaxonToEnvironmentAssociation : object_category
        ...
        OrganismTaxonToEnvironmentAssociation --> "0..1" OntologyClass : object_category
      ...
      OrganismTaxonToEnvironmentAssociation : object_feature_name
      ...
      OrganismTaxonToEnvironmentAssociation : semmed_agreement_count
        
      OrganismTaxonToEnvironmentAssociation : sources
        
          
    
        
        
        OrganismTaxonToEnvironmentAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      OrganismTaxonToEnvironmentAssociation : subject
        ...
        OrganismTaxonToEnvironmentAssociation --> "1" OrganismTaxon : subject
      ...
      OrganismTaxonToEnvironmentAssociation : subject_category
        ...
        OrganismTaxonToEnvironmentAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **OrganismTaxonToEnvironmentAssociation** [ [OrganismTaxonToEntityAssociation](OrganismTaxonToEntityAssociation.md)]
...
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | predicate describing the relationship between the taxon and the environment | [OrganismTaxonToEntityAssociation](OrganismTaxonToEntityAssociation.md), [Association](Association.md) |
| [object](object.md) | 1 <br/> [NamedThing](NamedThing.md) | the environment in which the organism occurs | [OrganismTaxonToEntityAssociation](OrganismTaxonToEntityAssociation.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:OrganismTaxonToEnvironmentAssociation |
| native | namo:OrganismTaxonToEnvironmentAssociation |
...
description: An abstract association between an organism taxon and an environmental
  context (e.g., a habitat, biome, or ecological setting) in which the taxon occurs.
...
attributes:
  subject:
    ...
    owner: organism taxon to environment association
    domain_of:
    - association
