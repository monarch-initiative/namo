...
_A specialization of reaction-to-participant association in which the participant is a gene or gene product (e.g., an enzyme) that catalyses the reaction._
...
URI: [namo:ReactionToCatalystAssociation](https://w3id.org/monarch-initiative/namo/ReactionToCatalystAssociation)
 ...
 classDiagram
    ...
    click ReactionToCatalystAssociation href "../ReactionToCatalystAssociation/"
      ...
      ReactionToCatalystAssociation : agent_type
        ...
        ReactionToCatalystAssociation --> "1" AgentTypeEnum : agent_type
      ...
      ReactionToCatalystAssociation : elevate_to_prediction
        
      ReactionToCatalystAssociation : evidence_count
      ...
      ReactionToCatalystAssociation : has_confidence_score
      ...
      ReactionToCatalystAssociation : has_evidence
        ...
        ReactionToCatalystAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      ReactionToCatalystAssociation : has_evidence_of_type
        
          
    
        
        
        ReactionToCatalystAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      ReactionToCatalystAssociation : has_supporting_studies
        
          
    
        
        
        ReactionToCatalystAssociation --> "*" Study : has_supporting_studies
      ...
      ReactionToCatalystAssociation : knowledge_level
        ...
        ReactionToCatalystAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      ReactionToCatalystAssociation : object
        ...
        ReactionToCatalystAssociation --> "1" GeneOrGeneProduct : object
      ...
      ReactionToCatalystAssociation : object_category
        ...
        ReactionToCatalystAssociation --> "0..1" OntologyClass : object_category
      ...
      ReactionToCatalystAssociation : object_feature_name
      ...
      ReactionToCatalystAssociation : reaction_direction
        ...
        ReactionToCatalystAssociation --> "0..1" ReactionDirectionEnum : reaction_direction
      ...
      ReactionToCatalystAssociation : reaction_side
        ...
        ReactionToCatalystAssociation --> "0..1" ReactionSideEnum : reaction_side
      ...
      ReactionToCatalystAssociation : semmed_agreement_count
        
      ReactionToCatalystAssociation : sources
        
          
    
        
        
        ReactionToCatalystAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
    

        
      ReactionToCatalystAssociation : species_context_qualifier
        
          
    
        
        
        ReactionToCatalystAssociation --> "0..1" OrganismTaxon : species_context_qualifier
      ...
      ReactionToCatalystAssociation : subject
        ...
        ReactionToCatalystAssociation --> "1" MolecularEntity : subject
      ...
      ReactionToCatalystAssociation : subject_category
        ...
        ReactionToCatalystAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [stoichiometry](stoichiometry.md) | 0..1 <br/> [Integer](Integer.md) | the relationship between the relative quantities of substances taking part in... | [ReactionToParticipantAssociation](ReactionToParticipantAssociation.md) |
| [reaction_direction](reaction_direction.md) | 0..1 <br/> [ReactionDirectionEnum](ReactionDirectionEnum.md) | the direction of a reaction as constrained by the direction enum (ie: left_to... | [ReactionToParticipantAssociation](ReactionToParticipantAssociation.md) |
| [reaction_side](reaction_side.md) | 0..1 <br/> [ReactionSideEnum](ReactionSideEnum.md) | the side of a reaction being modeled (ie: left or right) | [ReactionToParticipantAssociation](ReactionToParticipantAssociation.md) |
...
| [object](object.md) | 1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | the chemical element that is the target of the statement | [Association](Association.md), [ChemicalEntityToChemicalEntityAssociation](ChemicalEntityToChemicalEntityAssociation.md) |
...
| ---  | ---  |
| self | namo:ReactionToCatalystAssociation |
| native | namo:ReactionToCatalystAssociation |
...
description: A specialization of reaction-to-participant association in which the
  participant is a gene or gene product (e.g., an enzyme) that catalyses the reaction.
