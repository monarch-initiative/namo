...
# Slot: object_process_qualifier 

<div data-search-exclude markdown="1">



URI: [namo:object_process_qualifier](https://w3id.org/monarch-initiative/namo/object_process_qualifier)
...
| ---  | ---  |
| self | namo:object_process_qualifier |
| native | namo:object_process_qualifier |
