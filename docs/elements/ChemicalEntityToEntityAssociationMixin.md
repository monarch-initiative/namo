...
URI: [namo:ChemicalEntityToEntityAssociationMixin](https://w3id.org/monarch-initiative/namo/ChemicalEntityToEntityAssociationMixin)
 ...
 classDiagram
    ...
    click ChemicalEntityToEntityAssociationMixin href "../ChemicalEntityToEntityAssociationMixin/"
      ...
      ChemicalEntityToEntityAssociationMixin : object
        ...
        ChemicalEntityToEntityAssociationMixin --> "1" NamedThing : object
      ...
      ChemicalEntityToEntityAssociationMixin : subject
        ...
        ChemicalEntityToEntityAssociationMixin --> "1" ChemicalEntityOrGeneOrGeneProduct : subject
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [ChemicalEntityOrGeneOrGeneProduct](ChemicalEntityOrGeneOrGeneProduct.md) | the chemical entity that is an interactor | direct |
...
| ---  | ---  |
| self | namo:ChemicalEntityToEntityAssociationMixin |
| native | namo:ChemicalEntityToEntityAssociationMixin |
...
attributes:
  subject:
    ...
    owner: chemical entity to entity association mixin
    domain_of:
    - association
