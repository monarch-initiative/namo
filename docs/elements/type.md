...
_An rdf:type property asserting that an entity is an instance of a particular class. In Biolink the value is typically used to indicate the most specific category of which the entity is an instance._
...
| [Book](Book.md) | This class may rarely be instantiated except if use cases of a given knowledg... |  yes  |
| [BookChapter](BookChapter.md) | A section of a book that forms a discrete unit of a larger published work and... |  no  |
| [Serial](Serial.md) | This class may rarely be instantiated except if use cases of a given knowledg... |  yes  |
...
| self | rdf:type |
| native | namo:type |
| exact | gff3:type, gpi:DB_Object_Type |
