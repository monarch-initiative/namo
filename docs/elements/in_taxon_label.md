...
_The human readable scientific name for the taxon of the entity._
...
URI: [namo:in_taxon_label](https://w3id.org/monarch-initiative/namo/in_taxon_label)
...
| Domain Of | [ThingWithTaxon](ThingWithTaxon.md) |
...
| ---  | ---  |
| self | namo:in_taxon_label |
| native | namo:in_taxon_label |
| exact | WIKIDATA_PROPERTY:P225 |
