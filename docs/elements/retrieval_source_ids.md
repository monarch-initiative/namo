...
# Slot: retrieval_source_ids 


_A list of retrieval sources that served as a source of knowledge expressed in an Edge, or a source of data used to generate this knowledge._
...
URI: [namo:retrieval_source_ids](https://w3id.org/monarch-initiative/namo/retrieval_source_ids)
...
| ---  | ---  |
| self | namo:retrieval_source_ids |
| native | namo:retrieval_source_ids |
