...
_Composes with the core concept (+ aspect if provided) to describe a change in its direction or degree. This qualifier qualifies the object of an association (aka: statement)._
...
URI: [namo:object_direction_qualifier](https://w3id.org/monarch-initiative/namo/object_direction_qualifier)
...
| ---  | ---  |
| self | namo:object_direction_qualifier |
| native | namo:object_direction_qualifier |
