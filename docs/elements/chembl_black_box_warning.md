...
# Slot: chembl_black_box_warning 


_Text describing black box warnings for use of chemicals as therapeutics._
...
URI: [namo:chembl_black_box_warning](https://w3id.org/monarch-initiative/namo/chembl_black_box_warning)
...
| ---  | ---  |
| self | namo:chembl_black_box_warning |
| native | namo:chembl_black_box_warning |
