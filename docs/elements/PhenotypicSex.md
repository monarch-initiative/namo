...
_An attribute corresponding to the phenotypic sex of the individual, based upon the reproductive organs present._
...
URI: [namo:PhenotypicSex](https://w3id.org/monarch-initiative/namo/PhenotypicSex)
...
```mermaid
 classDiagram
    ...
    click PhenotypicSex href "../PhenotypicSex/"
      ...
      PhenotypicSex : equivalent_identifiers
        
      PhenotypicSex : exact_synonym
      ...
      PhenotypicSex : has_attribute_type
        ...
        PhenotypicSex --> "1" OntologyClass : has_attribute_type
      ...
      PhenotypicSex : has_qualitative_value
        ...
        PhenotypicSex --> "0..1" NamedThing : has_qualitative_value
      ...
      PhenotypicSex : information_content
        
      PhenotypicSex : iri
        
      PhenotypicSex : name
        
      PhenotypicSex : narrow_synonym
        
      PhenotypicSex : provided_by
        
      PhenotypicSex : related_synonym
        
      PhenotypicSex : subsets
...
| ---  | ---  |
| self | namo:PhenotypicSex |
| native | namo:PhenotypicSex |
| exact | PATO:0001894 |
