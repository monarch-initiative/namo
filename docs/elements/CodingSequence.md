...
_A contiguous sequence which begins with, and includes, a start codon and ends with, and includes, a stop codon._
...
URI: [namo:CodingSequence](https://w3id.org/monarch-initiative/namo/CodingSequence)
...
```mermaid
 classDiagram
    ...
    click CodingSequence href "../CodingSequence/"
      ...
      CodingSequence : equivalent_identifiers
        
      CodingSequence : exact_synonym
      ...
      CodingSequence : information_content
        
      CodingSequence : iri
        
      CodingSequence : name
        
      CodingSequence : narrow_synonym
        
      CodingSequence : provided_by
        
      CodingSequence : related_synonym
        
      CodingSequence : synonym
        
      CodingSequence : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **CodingSequence** [ [GenomicEntity](GenomicEntity.md)]
...
| ---  | --- | --- | --- |
| [GenomicSequenceLocalization](GenomicSequenceLocalization.md) | [phase](phase.md) | domain | [CodingSequence](CodingSequence.md) |
...
| ---  | ---  |
| self | namo:CodingSequence |
| native | namo:CodingSequence |
...
description: A contiguous sequence which begins with, and includes, a start codon
