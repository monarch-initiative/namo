...
_A homology association between two genes. May be orthology (in which case the species of subject and object should differ) or paralogy (in which case the species may be the same)_
...
URI: [namo:GeneToGeneHomologyAssociation](https://w3id.org/monarch-initiative/namo/GeneToGeneHomologyAssociation)
...
```mermaid
 classDiagram
    class GeneToGeneHomologyAssociation
    click GeneToGeneHomologyAssociation href "../GeneToGeneHomologyAssociation/"
      ...
      GeneToGeneHomologyAssociation : agent_type
        ...
        GeneToGeneHomologyAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GeneToGeneHomologyAssociation : causal_mechanism_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" CausalMechanismQualifierEnum : causal_mechanism_qualifier
      ...
      GeneToGeneHomologyAssociation : elevate_to_prediction
        
      GeneToGeneHomologyAssociation : evidence_count
      ...
      GeneToGeneHomologyAssociation : has_confidence_score
      ...
      GeneToGeneHomologyAssociation : has_evidence
        ...
        GeneToGeneHomologyAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GeneToGeneHomologyAssociation : has_evidence_of_type
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GeneToGeneHomologyAssociation : has_supporting_studies
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "*" Study : has_supporting_studies
      ...
      GeneToGeneHomologyAssociation : knowledge_level
        ...
        GeneToGeneHomologyAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GeneToGeneHomologyAssociation : object
        ...
        GeneToGeneHomologyAssociation --> "1" GeneOrGeneProduct : object
        click GeneOrGeneProduct href "../GeneOrGeneProduct/"
    

        
      GeneToGeneHomologyAssociation : object_activity_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" MolecularActivity : object_activity_qualifier
        click MolecularActivity href "../MolecularActivity/"
    

        
      GeneToGeneHomologyAssociation : object_aspect_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      GeneToGeneHomologyAssociation : object_category
        ...
        GeneToGeneHomologyAssociation --> "0..1" OntologyClass : object_category
      ...
      GeneToGeneHomologyAssociation : object_context_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" AnatomicalEntity : object_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      GeneToGeneHomologyAssociation : object_direction_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      GeneToGeneHomologyAssociation : object_feature_name
        
      GeneToGeneHomologyAssociation : object_label_closure
        
      GeneToGeneHomologyAssociation : object_namespace
        
      GeneToGeneHomologyAssociation : object_process_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" BiologicalProcess : object_process_qualifier
      ...
      GeneToGeneHomologyAssociation : qualified_predicate
      ...
      GeneToGeneHomologyAssociation : semmed_agreement_count
        
      GeneToGeneHomologyAssociation : sources
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
    

        
      GeneToGeneHomologyAssociation : species_context_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" OrganismTaxon : species_context_qualifier
      ...
      GeneToGeneHomologyAssociation : subject
        ...
        GeneToGeneHomologyAssociation --> "1" GeneOrGeneProduct : subject
        click GeneOrGeneProduct href "../GeneOrGeneProduct/"
    

        
      GeneToGeneHomologyAssociation : subject_activity_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" MolecularActivity : subject_activity_qualifier
        click MolecularActivity href "../MolecularActivity/"
    

        
      GeneToGeneHomologyAssociation : subject_aspect_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      GeneToGeneHomologyAssociation : subject_category
        ...
        GeneToGeneHomologyAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      GeneToGeneHomologyAssociation : subject_context_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" AnatomicalEntity : subject_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      GeneToGeneHomologyAssociation : subject_direction_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      GeneToGeneHomologyAssociation : subject_feature_name
        
      GeneToGeneHomologyAssociation : subject_label_closure
        
      GeneToGeneHomologyAssociation : subject_namespace
        
      GeneToGeneHomologyAssociation : subject_process_qualifier
        
          
    
        
        
        GeneToGeneHomologyAssociation --> "0..1" BiologicalProcess : subject_process_qualifier
        click BiologicalProcess href "../BiologicalProcess/"
    

        
      GeneToGeneHomologyAssociation : supporting_text
        
      GeneToGeneHomologyAssociation : timepoint
        
      GeneToGeneHomologyAssociation : type
        
      GeneToGeneHomologyAssociation : update_date
...
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | homology relationship type | [GeneToGeneAssociation](GeneToGeneAssociation.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GeneToGeneHomologyAssociation |
| native | namo:GeneToGeneHomologyAssociation |
...
attributes:
  subject aspect qualifier:
    ...
    owner: gene to gene homology association
    domain_of:
    - predicate mapping
