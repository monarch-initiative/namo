...
_A disease or an individual phenotypic feature, grouped as a single class to accommodate source vocabularies and assertions that do not distinguish the two. Prefer the more specific subclasses disease or phenotypic feature when the distinction is known._
...
URI: [namo:DiseaseOrPhenotypicFeature](https://w3id.org/monarch-initiative/namo/DiseaseOrPhenotypicFeature)
...
```mermaid
 classDiagram
    ...
    click DiseaseOrPhenotypicFeature href "../DiseaseOrPhenotypicFeature/"
      ...
      DiseaseOrPhenotypicFeature : broad_synonym
      ...
      DiseaseOrPhenotypicFeature : equivalent_identifiers
        
      DiseaseOrPhenotypicFeature : exact_synonym
      ...
      DiseaseOrPhenotypicFeature : information_content
        
      DiseaseOrPhenotypicFeature : inheritance
        
          
    
        
        
        DiseaseOrPhenotypicFeature --> "0..1" GeneticInheritance : inheritance
      ...
      DiseaseOrPhenotypicFeature : narrow_synonym
        
      DiseaseOrPhenotypicFeature : provided_by
        
      DiseaseOrPhenotypicFeature : related_synonym
        
      DiseaseOrPhenotypicFeature : subsets
        
      DiseaseOrPhenotypicFeature : synonym
        
      DiseaseOrPhenotypicFeature : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **DiseaseOrPhenotypicFeature** [ [OntologyClass](OntologyClass.md)]
                * [Disease](Disease.md)
...
| ---  | --- | --- | --- |
| [inheritance](inheritance.md) | 0..1 <br/> [GeneticInheritance](GeneticInheritance.md) | Connects genetic inheritance to a disease or phenotypic feature, as a node pr... | direct |
...
| ---  | --- | --- | --- |
| [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) | [inheritance](inheritance.md) | domain | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [Disease](Disease.md) | [inheritance](inheritance.md) | domain | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [PhenotypicFeature](PhenotypicFeature.md) | [inheritance](inheritance.md) | domain | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [BehavioralFeature](BehavioralFeature.md) | [inheritance](inheritance.md) | domain | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [ClinicalTrial](ClinicalTrial.md) | [clinical_trial_conditions](clinical_trial_conditions.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [ClinicalFinding](ClinicalFinding.md) | [inheritance](inheritance.md) | domain | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [GeneExpressionMixin](GeneExpressionMixin.md) | [phenotypic_state](phenotypic_state.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [GeneToGeneCoexpressionAssociation](GeneToGeneCoexpressionAssociation.md) | [phenotypic_state](phenotypic_state.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [CellLineToDiseaseOrPhenotypicFeatureAssociation](CellLineToDiseaseOrPhenotypicFeatureAssociation.md) | [subject](subject.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [CellLineToDiseaseOrPhenotypicFeatureAssociation](CellLineToDiseaseOrPhenotypicFeatureAssociation.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [ChemicalEntityToDiseaseOrPhenotypicFeatureAssociation](ChemicalEntityToDiseaseOrPhenotypicFeatureAssociation.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [ChemicalOrDrugOrTreatmentToDiseaseOrPhenotypicFeatureAssociation](ChemicalOrDrugOrTreatmentToDiseaseOrPhenotypicFeatureAssociation.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [ChemicalOrDrugOrTreatmentAdverseEventAssociation](ChemicalOrDrugOrTreatmentAdverseEventAssociation.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [ChemicalOrDrugOrTreatmentSideEffectAssociation](ChemicalOrDrugOrTreatmentSideEffectAssociation.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [MaterialSampleToDiseaseOrPhenotypicFeatureAssociation](MaterialSampleToDiseaseOrPhenotypicFeatureAssociation.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [DiseaseOrPhenotypicFeatureToEntityAssociationMixin](DiseaseOrPhenotypicFeatureToEntityAssociationMixin.md) | [subject](subject.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [DiseaseOrPhenotypicFeatureToLocationAssociation](DiseaseOrPhenotypicFeatureToLocationAssociation.md) | [subject](subject.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation](DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation.md) | [subject](subject.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [EntityToDiseaseOrPhenotypicFeatureAssociationMixin](EntityToDiseaseOrPhenotypicFeatureAssociationMixin.md) | [object](object.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
| [VariantToGeneExpressionAssociation](VariantToGeneExpressionAssociation.md) | [phenotypic_state](phenotypic_state.md) | range | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) |
...
| ---  | ---  |
| self | namo:DiseaseOrPhenotypicFeature |
| native | namo:DiseaseOrPhenotypicFeature |
| related | STY:T033 |
...
description: A disease or an individual phenotypic feature, grouped as a single class
  to accommodate source vocabularies and assertions that do not distinguish the two.
  Prefer the more specific subclasses disease or phenotypic feature when the distinction
  is known.
...
attributes:
  inheritance:
    ...
    owner: disease or phenotypic feature
    domain_of:
