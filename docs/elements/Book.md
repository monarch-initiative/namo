...
URI: [namo:Book](https://w3id.org/monarch-initiative/namo/Book)
...
| [id](id.md) | 1 <br/> [String](String.md) | Books should have industry-standard identifier such as from ISBN | [Entity](Entity.md) |
...
| [type](type.md) | * <br/> [String](String.md) | Should generally be set to an ontology class defined term for 'book' | [Entity](Entity.md) |
