...
_An association between two organism taxa, capturing ecological or evolutionary relationships between the taxa (e.g., a host-pathogen relationship or shared habitat)._
...
URI: [namo:TaxonToTaxonAssociation](https://w3id.org/monarch-initiative/namo/TaxonToTaxonAssociation)
 ...
 classDiagram
    ...
    click TaxonToTaxonAssociation href "../TaxonToTaxonAssociation/"
      ...
      TaxonToTaxonAssociation : agent_type
        ...
        TaxonToTaxonAssociation --> "1" AgentTypeEnum : agent_type
      ...
      TaxonToTaxonAssociation : elevate_to_prediction
        
      TaxonToTaxonAssociation : evidence_count
      ...
      TaxonToTaxonAssociation : has_confidence_score
      ...
      TaxonToTaxonAssociation : has_evidence
        ...
        TaxonToTaxonAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      TaxonToTaxonAssociation : has_evidence_of_type
        
          
    
        
        
        TaxonToTaxonAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      TaxonToTaxonAssociation : has_supporting_studies
        
          
    
        
        
        TaxonToTaxonAssociation --> "*" Study : has_supporting_studies
      ...
      TaxonToTaxonAssociation : knowledge_level
        ...
        TaxonToTaxonAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      TaxonToTaxonAssociation : object
        ...
        TaxonToTaxonAssociation --> "1" OrganismTaxon : object
      ...
      TaxonToTaxonAssociation : object_category
        ...
        TaxonToTaxonAssociation --> "0..1" OntologyClass : object_category
      ...
      TaxonToTaxonAssociation : object_feature_name
      ...
      TaxonToTaxonAssociation : semmed_agreement_count
        
      TaxonToTaxonAssociation : sources
        
          
    
        
        
        TaxonToTaxonAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      TaxonToTaxonAssociation : subject
        ...
        TaxonToTaxonAssociation --> "1" OrganismTaxon : subject
        click OrganismTaxon href "../OrganismTaxon/"
      ...
      TaxonToTaxonAssociation : subject_category
        ...
        TaxonToTaxonAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [OrganismTaxon](OrganismTaxon.md) | connects an association to the subject of the association | [Association](Association.md) |
...
| [object](object.md) | 1 <br/> [OrganismTaxon](OrganismTaxon.md) | An association between individuals of different taxa | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:TaxonToTaxonAssociation |
| native | namo:TaxonToTaxonAssociation |
...
description: An association between two organism taxa, capturing ecological or evolutionary
  relationships between the taxa (e.g., a host-pathogen relationship or shared habitat).
...
attributes:
  subject:
    ...
    owner: taxon to taxon association
    domain_of:
    - association
