...
_The number of times this concept has been asserted in the SemMedDB literature database._
...
URI: [namo:semmed_agreement_count](https://w3id.org/monarch-initiative/namo/semmed_agreement_count)
...
| ---  | ---  |
| self | namo:semmed_agreement_count |
| native | namo:semmed_agreement_count |
