...
_Set membership of a gene in a family of genes related by common evolutionary ancestry usually inferred by sequence comparisons. The genes in a given family generally share common sequence motifs which generally map onto shared gene product structure-function relationships._
...
URI: [namo:GeneToGeneFamilyAssociation](https://w3id.org/monarch-initiative/namo/GeneToGeneFamilyAssociation)
 ...
 classDiagram
    ...
    click GeneToGeneFamilyAssociation href "../GeneToGeneFamilyAssociation/"
      ...
      GeneToGeneFamilyAssociation : agent_type
        ...
        GeneToGeneFamilyAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GeneToGeneFamilyAssociation : elevate_to_prediction
        
      GeneToGeneFamilyAssociation : evidence_count
      ...
      GeneToGeneFamilyAssociation : has_confidence_score
      ...
      GeneToGeneFamilyAssociation : has_evidence
        ...
        GeneToGeneFamilyAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GeneToGeneFamilyAssociation : has_evidence_of_type
        
          
    
        
        
        GeneToGeneFamilyAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GeneToGeneFamilyAssociation : has_supporting_studies
        
          
    
        
        
        GeneToGeneFamilyAssociation --> "*" Study : has_supporting_studies
      ...
      GeneToGeneFamilyAssociation : knowledge_level
        ...
        GeneToGeneFamilyAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GeneToGeneFamilyAssociation : object
        ...
        GeneToGeneFamilyAssociation --> "1" GeneFamily : object
      ...
      GeneToGeneFamilyAssociation : object_category
        ...
        GeneToGeneFamilyAssociation --> "0..1" OntologyClass : object_category
      ...
      GeneToGeneFamilyAssociation : object_feature_name
      ...
      GeneToGeneFamilyAssociation : semmed_agreement_count
        
      GeneToGeneFamilyAssociation : sources
        
          
    
        
        
        GeneToGeneFamilyAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GeneToGeneFamilyAssociation : subject
        ...
        GeneToGeneFamilyAssociation --> "1" Gene : subject
      ...
      GeneToGeneFamilyAssociation : subject_category
        ...
        GeneToGeneFamilyAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [Gene](Gene.md) | connects an association to the subject of the association | [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | membership of the gene in the given gene family | [Association](Association.md) |
| [object](object.md) | 1 <br/> [GeneFamily](GeneFamily.md) | connects an association to the object of the association | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GeneToGeneFamilyAssociation |
| native | namo:GeneToGeneFamilyAssociation |
...
attributes:
  subject:
    ...
    owner: gene to gene family association
    domain_of:
    - association
