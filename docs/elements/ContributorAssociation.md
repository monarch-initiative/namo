...
_Any association between an entity (such as a publication) and various agents that contribute to its realisation_
...
URI: [namo:ContributorAssociation](https://w3id.org/monarch-initiative/namo/ContributorAssociation)
 ...
 classDiagram
    ...
    click ContributorAssociation href "../ContributorAssociation/"
      ...
      ContributorAssociation : agent_type
        ...
        ContributorAssociation --> "1" AgentTypeEnum : agent_type
      ...
      ContributorAssociation : elevate_to_prediction
        
      ContributorAssociation : evidence_count
      ...
      ContributorAssociation : has_confidence_score
      ...
      ContributorAssociation : has_evidence
        ...
        ContributorAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      ContributorAssociation : has_evidence_of_type
        
          
    
        
        
        ContributorAssociation --> "*" EvidenceType : has_evidence_of_type
      ...
      ContributorAssociation : knowledge_level
        ...
        ContributorAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      ContributorAssociation : object
        ...
        ContributorAssociation --> "1" Agent : object
      ...
      ContributorAssociation : object_category
        ...
        ContributorAssociation --> "0..1" OntologyClass : object_category
      ...
      ContributorAssociation : object_feature_name
      ...
      ContributorAssociation : semmed_agreement_count
        
      ContributorAssociation : sources
        
          
    
        
        
        ContributorAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      ContributorAssociation : subject
        ...
        ContributorAssociation --> "1" InformationContentEntity : subject
        click InformationContentEntity href "../InformationContentEntity/"
      ...
      ContributorAssociation : subject_category
        ...
        ContributorAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [InformationContentEntity](InformationContentEntity.md) | information content entity which an agent has helped realise | [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | generally one of the predicate values 'provider', 'publisher', 'editor' or 'a... | [Association](Association.md) |
| [object](object.md) | 1 <br/> [Agent](Agent.md) | agent helping to realise the given entity (e | [Association](Association.md) |
...
| [qualifiers](qualifiers.md) | * <br/> [OntologyClass](OntologyClass.md) | this field can be used to annotate special characteristics of an agent relati... | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:ContributorAssociation |
| native | namo:ContributorAssociation |
