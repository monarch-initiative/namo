...
_An alternate label for an entity whose meaning is narrower (more specific) than the primary label, for example naming a particular sub-type._
...
URI: [namo:narrow_synonym](https://w3id.org/monarch-initiative/namo/narrow_synonym)
...
| ---  | ---  |
| self | namo:narrow_synonym |
| native | namo:narrow_synonym |
| exact | oboInOwl:hasNarrowSynonym |
...
```yaml
name: narrow synonym
description: An alternate label for an entity whose meaning is narrower (more specific)
  than the primary label, for example naming a particular sub-type.
