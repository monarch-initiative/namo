...
_a legal document granted by a patent issuing authority which confers upon the patenter the sole right to make, use and sell an invention for a set period of time._
...
URI: [namo:Patent](https://w3id.org/monarch-initiative/namo/Patent)
...
```mermaid
 classDiagram
    ...
    click Patent href "../Patent/"
      ...
      Patent : equivalent_identifiers
        
      Patent : exact_synonym
...
| self | namo:Patent |
| native | namo:Patent |
| exact | SIO:000153, IAO:0000313, fabio:Patent |
