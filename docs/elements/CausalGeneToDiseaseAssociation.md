...
_An association between a gene and a disease where variation in the gene has been shown to have a causal role in the disease._
...
URI: [namo:CausalGeneToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/CausalGeneToDiseaseAssociation)
 ...
 classDiagram
    ...
    click CausalGeneToDiseaseAssociation href "../CausalGeneToDiseaseAssociation/"
      ...
      CausalGeneToDiseaseAssociation : agent_type
        ...
        CausalGeneToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      CausalGeneToDiseaseAssociation : allelic_requirement
      ...
      CausalGeneToDiseaseAssociation : elevate_to_prediction
        
      CausalGeneToDiseaseAssociation : evidence_count
      ...
      CausalGeneToDiseaseAssociation : has_confidence_score
      ...
      CausalGeneToDiseaseAssociation : has_evidence
        ...
        CausalGeneToDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      CausalGeneToDiseaseAssociation : has_evidence_of_type
        
          
    
        
        
        CausalGeneToDiseaseAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      CausalGeneToDiseaseAssociation : has_supporting_studies
        
          
    
        
        
        CausalGeneToDiseaseAssociation --> "*" Study : has_supporting_studies
      ...
      CausalGeneToDiseaseAssociation : knowledge_level
        ...
        CausalGeneToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      CausalGeneToDiseaseAssociation : object
        ...
        CausalGeneToDiseaseAssociation --> "1" Disease : object
      ...
      CausalGeneToDiseaseAssociation : object_category
        ...
        CausalGeneToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      CausalGeneToDiseaseAssociation : object_direction_qualifier
        ...
        CausalGeneToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      CausalGeneToDiseaseAssociation : object_feature_name
      ...
      CausalGeneToDiseaseAssociation : semmed_agreement_count
        
      CausalGeneToDiseaseAssociation : sources
        
          
    
        
        
        CausalGeneToDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      CausalGeneToDiseaseAssociation : subject
        ...
        CausalGeneToDiseaseAssociation --> "1" GeneOrGeneProduct : subject
      ...
      CausalGeneToDiseaseAssociation : subject_aspect_qualifier
        ...
        CausalGeneToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
      ...
      CausalGeneToDiseaseAssociation : subject_category
        ...
        CausalGeneToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      CausalGeneToDiseaseAssociation : subject_feature_name
        
      CausalGeneToDiseaseAssociation : subject_form_or_variant_qualifier
        
      CausalGeneToDiseaseAssociation : subject_label_closure
        
      CausalGeneToDiseaseAssociation : subject_namespace
        
      CausalGeneToDiseaseAssociation : supporting_text
        
      CausalGeneToDiseaseAssociation : timepoint
        
      CausalGeneToDiseaseAssociation : type
        
      CausalGeneToDiseaseAssociation : update_date
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **CausalGeneToDiseaseAssociation** [ [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md)]
...
| [subject](subject.md) | 1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | gene in which variation is shown to cause the disease | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | Has a value from the Biolink 'related_to' hierarchy | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:CausalGeneToDiseaseAssociation |
| native | namo:CausalGeneToDiseaseAssociation |
...
description: An association between a gene and a disease where variation in the gene
  has been shown to have a causal role in the disease.
...
attributes:
  subject form or variant qualifier:
    ...
    owner: causal gene to disease association
    domain_of:
    - predicate mapping
