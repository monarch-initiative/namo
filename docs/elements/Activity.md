...
_An activity is something that occurs over a period of time and acts upon or with entities; it may include consuming, processing, transforming, modifying, relocating, using, or generating entities._
...
URI: [namo:Activity](https://w3id.org/monarch-initiative/namo/Activity)
...
```mermaid
 classDiagram
    ...
    click Activity href "../Activity/"
      ...
      Activity : equivalent_identifiers
        
      Activity : exact_synonym
      ...
      Activity : information_content
        
      Activity : iri
        
      Activity : name
        
      Activity : narrow_synonym
        
      Activity : provided_by
        
      Activity : related_synonym
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **Activity** [ [ActivityAndBehavior](ActivityAndBehavior.md)]
            * [Study](Study.md)
