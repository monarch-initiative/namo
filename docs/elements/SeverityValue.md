...
# Class: SeverityValue  <span style="color: red;"><strong> (DEPRECATED) </strong></span> 
...
URI: [namo:SeverityValue](https://w3id.org/monarch-initiative/namo/SeverityValue)
...
```mermaid
 classDiagram
    ...
    click SeverityValue href "../SeverityValue/"
      ...
      SeverityValue : equivalent_identifiers
        
      SeverityValue : exact_synonym
      ...
      SeverityValue : has_attribute_type
        ...
        SeverityValue --> "1" OntologyClass : has_attribute_type
      ...
      SeverityValue : has_qualitative_value
        ...
        SeverityValue --> "0..1" NamedThing : has_qualitative_value
      ...
      SeverityValue : information_content
        
      SeverityValue : iri
        
      SeverityValue : name
        
      SeverityValue : narrow_synonym
        
      SeverityValue : provided_by
        
      SeverityValue : related_synonym
        
      SeverityValue : subsets
...
| ---  | ---  |
| self | namo:SeverityValue |
| native | namo:SeverityValue |
