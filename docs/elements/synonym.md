...
URI: [namo:synonym](https://w3id.org/monarch-initiative/namo/synonym)
...
| Domain Of | [NamedThing](NamedThing.md), [GeneProductMixin](GeneProductMixin.md) |
...
| self | namo:synonym |
| native | namo:synonym |
| narrow | skos:altLabel, gff3:Alias, AGRKB:synonyms, gpi:DB_Object_Synonyms, HANCESTRO:0330, IAO:0000136, RXNORM:has_tradename |
