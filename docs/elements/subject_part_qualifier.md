...
_defines a specific part/component of the core concept (used in cases there this specific part has no IRI we can use to directly represent it).  This qualifier is for the subject of an association (or statement)._
...
URI: [namo:subject_part_qualifier](https://w3id.org/monarch-initiative/namo/subject_part_qualifier)
...
| ---  | ---  |
| self | namo:subject_part_qualifier |
| native | namo:subject_part_qualifier |
