...
_An alternate label that is related to the primary label but is neither exactly synonymous nor cleanly broader or narrower; useful as a lexical pointer but not for strict equivalence. Corresponds to oboInOwl:hasRelatedSynonym._
...
URI: [namo:related_synonym](https://w3id.org/monarch-initiative/namo/related_synonym)
...
| ---  | ---  |
| self | namo:related_synonym |
| native | namo:related_synonym |
| exact | oboInOwl:hasRelatedSynonym |
