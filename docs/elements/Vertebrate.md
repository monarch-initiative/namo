...
# Class: Vertebrate  <span style="color: red;"><strong> (DEPRECATED) </strong></span> 

<div data-search-exclude markdown="1">



URI: [namo:Vertebrate](https://w3id.org/monarch-initiative/namo/Vertebrate)
...
```mermaid
 classDiagram
    ...
    click Vertebrate href "../Vertebrate/"
      ...
      Vertebrate : equivalent_identifiers
        
      Vertebrate : exact_synonym
      ...
      Vertebrate : information_content
        
      Vertebrate : iri
        
      Vertebrate : name
        
      Vertebrate : narrow_synonym
        
      Vertebrate : provided_by
        
      Vertebrate : related_synonym
...
| ---  | ---  |
| self | namo:Vertebrate |
| native | namo:Vertebrate |
| exact | STY:T010, NCBITaxon:7742, OMIT:0015545 |
| related | NCBITaxon:2662825 |
