...
# Slot: exposure_additional_condition 


_Additional conditions impacting an exposure event._
...
URI: [namo:exposure_additional_condition](https://w3id.org/monarch-initiative/namo/exposure_additional_condition)
...
| ---  | ---  |
| self | namo:exposure_additional_condition |
| native | namo:exposure_additional_condition |
