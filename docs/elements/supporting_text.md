...
_The segment of text from a document that supports the mined assertion._
...
URI: [namo:supporting_text](https://w3id.org/monarch-initiative/namo/supporting_text)
...
| Domain Of | [TextMiningStudyResult](TextMiningStudyResult.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:supporting_text |
| native | namo:supporting_text |
