...
URI: [namo:MaterialSampleToEntityAssociationMixin](https://w3id.org/monarch-initiative/namo/MaterialSampleToEntityAssociationMixin)
 ...
 classDiagram
    ...
    click MaterialSampleToEntityAssociationMixin href "../MaterialSampleToEntityAssociationMixin/"
      ...
      MaterialSampleToEntityAssociationMixin : object
        ...
        MaterialSampleToEntityAssociationMixin --> "1" NamedThing : object
      ...
      MaterialSampleToEntityAssociationMixin : subject
        ...
        MaterialSampleToEntityAssociationMixin --> "1" MaterialSample : subject
...
| ---  | ---  |
| self | namo:MaterialSampleToEntityAssociationMixin |
| native | namo:MaterialSampleToEntityAssociationMixin |
...
attributes:
  subject:
    ...
    owner: material sample to entity association mixin
    domain_of:
    - association
