...
_a variable that is used as a measure in the investigation of a study_
...
URI: [namo:StudyVariable](https://w3id.org/monarch-initiative/namo/StudyVariable)
...
```mermaid
 classDiagram
    ...
    click StudyVariable href "../StudyVariable/"
      ...
      StudyVariable : equivalent_identifiers
        
      StudyVariable : exact_synonym
      ...
      StudyVariable : information_content
      ...
      StudyVariable : narrow_synonym
        
      StudyVariable : provided_by
        
      StudyVariable : related_synonym
...
| ---  | ---  |
| self | namo:StudyVariable |
| native | namo:StudyVariable |
| narrow | NCIT:C142192 |
| close | STATO:0000258, SIO:000367 |
