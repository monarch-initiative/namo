...
_An association between a variant and a gene, where the variant has a genetic association with the gene (i.e. is in linkage disequilibrium)_
...
URI: [namo:VariantToGeneAssociation](https://w3id.org/monarch-initiative/namo/VariantToGeneAssociation)
 ...
 classDiagram
    ...
    click VariantToGeneAssociation href "../VariantToGeneAssociation/"
      ...
      VariantToGeneAssociation : agent_type
        ...
        VariantToGeneAssociation --> "1" AgentTypeEnum : agent_type
      ...
      VariantToGeneAssociation : elevate_to_prediction
        
      VariantToGeneAssociation : evidence_count
      ...
      VariantToGeneAssociation : has_confidence_score
      ...
      VariantToGeneAssociation : has_evidence
        ...
        VariantToGeneAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      VariantToGeneAssociation : has_evidence_of_type
        
          
    
        
        
        VariantToGeneAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      VariantToGeneAssociation : has_supporting_studies
        
          
    
        
        
        VariantToGeneAssociation --> "*" Study : has_supporting_studies
      ...
      VariantToGeneAssociation : knowledge_level
        ...
        VariantToGeneAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      VariantToGeneAssociation : object
        ...
        VariantToGeneAssociation --> "1" Gene : object
      ...
      VariantToGeneAssociation : object_category
        ...
        VariantToGeneAssociation --> "0..1" OntologyClass : object_category
      ...
      VariantToGeneAssociation : object_feature_name
      ...
      VariantToGeneAssociation : semmed_agreement_count
        
      VariantToGeneAssociation : sources
        
          
    
        
        
        VariantToGeneAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      VariantToGeneAssociation : subject
        ...
        VariantToGeneAssociation --> "1" SequenceVariant : subject
      ...
      VariantToGeneAssociation : subject_category
        ...
        VariantToGeneAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToGeneAssociation** [ [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md)]
            * [VariantToGeneExpressionAssociation](VariantToGeneExpressionAssociation.md) [ [GeneExpressionMixin](GeneExpressionMixin.md)]
...
| ---  | ---  |
| self | namo:VariantToGeneAssociation |
| native | namo:VariantToGeneAssociation |
...
attributes:
  subject:
    ...
    owner: variant to gene association
    domain_of:
    - association
