...
```mermaid
 classDiagram
    ...
    click ModelSystem href "../ModelSystem/"
      ...
      ModelSystem : broad_synonym
        
      ModelSystem : category
        
      ModelSystem : deprecated
        
      ModelSystem : description
        
      ModelSystem : equivalent_identifiers
        
      ModelSystem : exact_synonym
        
      ModelSystem : full_name
        
      ModelSystem : has_attribute
        
          
    
        
        
        ModelSystem --> "*" Attribute : has_attribute
      ...
      ModelSystem : information_content
      ...
      ModelSystem : narrow_synonym
        
      ModelSystem : provided_by
        
      ModelSystem : related_synonym
...
| ---  | --- | --- | --- |
| [NAMDataset](NAMDataset.md) | [model_systems](model_systems.md) | range | [ModelSystem](ModelSystem.md) |
