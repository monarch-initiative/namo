...
```mermaid
 classDiagram
    ...
    click NAMModel href "../NAMModel/"
      ...
      NAMModel : equivalent_identifiers
        
      NAMModel : exact_synonym
        
      NAMModel : full_name
        
      NAMModel : has_attribute
        
          
    
        
        
        NAMModel --> "*" Attribute : has_attribute
      ...
      NAMModel : narrow_synonym
        
      NAMModel : provided_by
