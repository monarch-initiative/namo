...
_Qualifiers for disease or phenotype to entity associations._
...
URI: [namo:FeatureOrDiseaseQualifiersToEntityMixin](https://w3id.org/monarch-initiative/namo/FeatureOrDiseaseQualifiersToEntityMixin)
 ...
 classDiagram
    ...
    click FeatureOrDiseaseQualifiersToEntityMixin href "../FeatureOrDiseaseQualifiersToEntityMixin/"
      ...
      FeatureOrDiseaseQualifiersToEntityMixin : object
        ...
        FeatureOrDiseaseQualifiersToEntityMixin --> "1" NamedThing : object
      ...
      FeatureOrDiseaseQualifiersToEntityMixin : object_aspect_qualifier
        ...
        FeatureOrDiseaseQualifiersToEntityMixin --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      FeatureOrDiseaseQualifiersToEntityMixin : object_direction_qualifier
        ...
        FeatureOrDiseaseQualifiersToEntityMixin --> "0..1" DirectionQualifierEnum : object_direction_qualifier
      ...
      FeatureOrDiseaseQualifiersToEntityMixin : subject
        ...
        FeatureOrDiseaseQualifiersToEntityMixin --> "1" NamedThing : subject
        click NamedThing href "../NamedThing/"
      ...
      FeatureOrDiseaseQualifiersToEntityMixin : subject_aspect_qualifier
        ...
        FeatureOrDiseaseQualifiersToEntityMixin --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      FeatureOrDiseaseQualifiersToEntityMixin : subject_direction_qualifier
        ...
        FeatureOrDiseaseQualifiersToEntityMixin --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
...
* [FrequencyQualifierMixin](FrequencyQualifierMixin.md)
    * **FeatureOrDiseaseQualifiersToEntityMixin**
        * [PhenotypicFeatureToEntityAssociationMixin](PhenotypicFeatureToEntityAssociationMixin.md) [ [FrequencyQuantifier](FrequencyQuantifier.md)]
...
| ---  | ---  |
| self | namo:FeatureOrDiseaseQualifiersToEntityMixin |
| native | namo:FeatureOrDiseaseQualifiersToEntityMixin |
...
attributes:
  subject aspect qualifier:
    ...
    owner: feature or disease qualifiers to entity mixin
    domain_of:
    - predicate mapping
