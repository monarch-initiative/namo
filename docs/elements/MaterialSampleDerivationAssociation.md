...
_An association between a material sample and the material entity from which it is derived._
...
URI: [namo:MaterialSampleDerivationAssociation](https://w3id.org/monarch-initiative/namo/MaterialSampleDerivationAssociation)
 ...
 classDiagram
    ...
    click MaterialSampleDerivationAssociation href "../MaterialSampleDerivationAssociation/"
      ...
      MaterialSampleDerivationAssociation : agent_type
        ...
        MaterialSampleDerivationAssociation --> "1" AgentTypeEnum : agent_type
      ...
      MaterialSampleDerivationAssociation : elevate_to_prediction
        
      MaterialSampleDerivationAssociation : evidence_count
      ...
      MaterialSampleDerivationAssociation : has_confidence_score
      ...
      MaterialSampleDerivationAssociation : has_evidence
        ...
        MaterialSampleDerivationAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      MaterialSampleDerivationAssociation : has_evidence_of_type
        
          
    
        
        
        MaterialSampleDerivationAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      MaterialSampleDerivationAssociation : has_supporting_studies
        
          
    
        
        
        MaterialSampleDerivationAssociation --> "*" Study : has_supporting_studies
      ...
      MaterialSampleDerivationAssociation : knowledge_level
        ...
        MaterialSampleDerivationAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      MaterialSampleDerivationAssociation : object
        ...
        MaterialSampleDerivationAssociation --> "1" NamedThing : object
      ...
      MaterialSampleDerivationAssociation : object_category
        ...
        MaterialSampleDerivationAssociation --> "0..1" OntologyClass : object_category
      ...
      MaterialSampleDerivationAssociation : object_feature_name
      ...
      MaterialSampleDerivationAssociation : semmed_agreement_count
        
      MaterialSampleDerivationAssociation : sources
        
          
    
        
        
        MaterialSampleDerivationAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      MaterialSampleDerivationAssociation : subject
        ...
        MaterialSampleDerivationAssociation --> "1" MaterialSample : subject
      ...
      MaterialSampleDerivationAssociation : subject_category
        ...
        MaterialSampleDerivationAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [MaterialSample](MaterialSample.md) | the material sample being described | direct |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | derivation relationship | direct |
| [object](object.md) | 1 <br/> [NamedThing](NamedThing.md) | the material entity the sample was derived from | direct |
...
| ---  | ---  |
| self | namo:MaterialSampleDerivationAssociation |
| native | namo:MaterialSampleDerivationAssociation |
...
attributes:
  subject:
    ...
    owner: material sample derivation association
    domain_of:
    - association
