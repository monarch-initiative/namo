...
_A Common Data Element (CDE) is a standardized, precisely defined question, paired with a set of allowable responses, used systematically across different sites, studies, or clinical trials to ensure consistent data collection. Multiple CDEs (from one or more Collections) can be curated into Forms. (https://cde.nlm.nih.gov/home)_
...
URI: [namo:CommonDataElement](https://w3id.org/monarch-initiative/namo/CommonDataElement)
...
```mermaid
 classDiagram
    ...
    click CommonDataElement href "../CommonDataElement/"
      ...
      CommonDataElement : broad_synonym
      ...
      CommonDataElement : equivalent_identifiers
        
      CommonDataElement : exact_synonym
      ...
      CommonDataElement : information_content
      ...
      CommonDataElement : narrow_synonym
        
      CommonDataElement : provided_by
        
      CommonDataElement : related_synonym
        
      CommonDataElement : rights
        
      CommonDataElement : synonym
        
      CommonDataElement : taxon
...
| ---  | ---  |
| self | namo:CommonDataElement |
| native | namo:CommonDataElement |
| close | NCIT:C19984 |
