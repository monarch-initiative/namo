...
_A result of a log odds ratio analysis._
...
URI: [namo:LogOddsAnalysisResult](https://w3id.org/monarch-initiative/namo/LogOddsAnalysisResult)
...
```mermaid
 classDiagram
    ...
    click LogOddsAnalysisResult href "../LogOddsAnalysisResult/"
      ...
      LogOddsAnalysisResult : broad_synonym
      ...
      LogOddsAnalysisResult : equivalent_identifiers
        
      LogOddsAnalysisResult : exact_synonym
      ...
      LogOddsAnalysisResult : information_content
        
      LogOddsAnalysisResult : iri
        
      LogOddsAnalysisResult : name
        
      LogOddsAnalysisResult : narrow_synonym
        
      LogOddsAnalysisResult : provided_by
        
      LogOddsAnalysisResult : related_synonym
        
      LogOddsAnalysisResult : synonym
        
      LogOddsAnalysisResult : taxon
...
| ---  | ---  |
| self | namo:LogOddsAnalysisResult |
| native | namo:LogOddsAnalysisResult |
...
attributes:
  provided by:
    ...
    domain: named thing
    alias: provided_by
    owner: log odds analysis result
    domain_of:
    - named thing
    range: string
    multivalued: true
