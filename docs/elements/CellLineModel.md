...
```mermaid
 classDiagram
    ...
    click CellLineModel href "../CellLineModel/"
      ...
      CellLineModel : broad_synonym
        
      CellLineModel : category
      ...
      CellLineModel : deprecated
        
      CellLineModel : description
        
      CellLineModel : equivalent_identifiers
        
      CellLineModel : exact_synonym
        
      CellLineModel : full_name
        
      CellLineModel : has_attribute
        
          
    
        
        
        CellLineModel --> "*" Attribute : has_attribute
      ...
      CellLineModel : information_content
