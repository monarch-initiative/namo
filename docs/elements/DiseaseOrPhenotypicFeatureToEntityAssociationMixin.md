...
URI: [namo:DiseaseOrPhenotypicFeatureToEntityAssociationMixin](https://w3id.org/monarch-initiative/namo/DiseaseOrPhenotypicFeatureToEntityAssociationMixin)
 ...
 classDiagram
    ...
    click DiseaseOrPhenotypicFeatureToEntityAssociationMixin href "../DiseaseOrPhenotypicFeatureToEntityAssociationMixin/"
      ...
      DiseaseOrPhenotypicFeatureToEntityAssociationMixin : object
        ...
        DiseaseOrPhenotypicFeatureToEntityAssociationMixin --> "1" NamedThing : object
      ...
      DiseaseOrPhenotypicFeatureToEntityAssociationMixin : subject
        ...
        DiseaseOrPhenotypicFeatureToEntityAssociationMixin --> "1" DiseaseOrPhenotypicFeature : subject
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) | disease or phenotype | direct |
...
| ---  | ---  |
| self | namo:DiseaseOrPhenotypicFeatureToEntityAssociationMixin |
| native | namo:DiseaseOrPhenotypicFeatureToEntityAssociationMixin |
...
attributes:
  subject:
    ...
    owner: disease or phenotypic feature to entity association mixin
    domain_of:
    - association
