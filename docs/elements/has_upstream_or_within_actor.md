...
# Slot: has_upstream_or_within_actor 

<div data-search-exclude markdown="1">



URI: [namo:has_upstream_or_within_actor](https://w3id.org/monarch-initiative/namo/has_upstream_or_within_actor)
...
| Property | Value |
| --- | --- |
| Inverse | [acts_upstream_of_or_within](acts_upstream_of_or_within.md) |
...
| ---  | ---  |
| self | namo:has_upstream_or_within_actor |
| native | namo:has_upstream_or_within_actor |
