...
URI: [namo:is_nonsense_variant_of](https://w3id.org/monarch-initiative/namo/is_nonsense_variant_of)
...
| ---  | ---  |
| self | namo:is_nonsense_variant_of |
| native | namo:is_nonsense_variant_of |
| broad | SO:0002054 |
