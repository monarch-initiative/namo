...
_A phenotypic feature which is behavioral in nature._
...
URI: [namo:BehavioralFeature](https://w3id.org/monarch-initiative/namo/BehavioralFeature)
...
```mermaid
 classDiagram
    ...
    click BehavioralFeature href "../BehavioralFeature/"
      ...
      BehavioralFeature : broad_synonym
      ...
      BehavioralFeature : equivalent_identifiers
        
      BehavioralFeature : exact_synonym
      ...
      BehavioralFeature : information_content
        
      BehavioralFeature : inheritance
        
          
    
        
        
        BehavioralFeature --> "0..1" GeneticInheritance : inheritance
      ...
      BehavioralFeature : narrow_synonym
        
      BehavioralFeature : provided_by
        
      BehavioralFeature : related_synonym
        
      BehavioralFeature : subsets
        
      BehavioralFeature : synonym
        
      BehavioralFeature : taxon
...
| ---  | --- | --- | --- |
| [BehaviorToBehavioralFeatureAssociation](BehaviorToBehavioralFeatureAssociation.md) | [object](object.md) | range | [BehavioralFeature](BehavioralFeature.md) |
...
| ---  | ---  |
| self | namo:BehavioralFeature |
| native | namo:BehavioralFeature |
| exact | NBO:0000243 |
