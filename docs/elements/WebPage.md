...
_a document that is published according to World Wide Web standards, which may incorporate text, graphics, sound, and/or other features._
...
URI: [namo:WebPage](https://w3id.org/monarch-initiative/namo/WebPage)
...
```mermaid
 classDiagram
    ...
    click WebPage href "../WebPage/"
      ...
      WebPage : equivalent_identifiers
        
      WebPage : exact_synonym
...
| self | namo:WebPage |
| native | namo:WebPage |
| exact | SIO:000302, NCIT-OBO:C142749, fabio:WebPage |
