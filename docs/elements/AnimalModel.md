...
```mermaid
 classDiagram
    ...
    click AnimalModel href "../AnimalModel/"
      ...
      AnimalModel : broad_synonym
        
      AnimalModel : category
        
      AnimalModel : deprecated
      ...
      AnimalModel : equivalent_identifiers
        
      AnimalModel : exact_synonym
        
      AnimalModel : full_name
        
      AnimalModel : has_attribute
        
          
    
        
        
        AnimalModel --> "*" Attribute : has_attribute
      ...
      AnimalModel : information_content
      ...
      AnimalModel : narrow_synonym
        
      AnimalModel : provided_by
        
      AnimalModel : related_synonym
...
| [strain](strain.md) | 0..1 <br/> [OrganismTaxon](OrganismTaxon.md) | The specific strain of the animal used in the model system, as a strain-rank ... | direct |
...
attributes:
  ...
  strain:
    name: strain
    description: The specific strain of the animal used in the model system, as a
      strain-rank NCBITaxon term or an equivalent strain-registry CURIE.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    domain_of:
    - AnimalModel
  ...
  life_stage:
    ...
    description: The developmental or life-cycle stage of the animal used in the model
      system (e.g. HsapDv, MmusDv, or UBERON life cycle stage terms).
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    domain_of:
    - AnimalModel
  ...
  age_value:
    ...
    description: Chronological age of the animal at the time of study, as a numeric
      value with a unit (e.g. has_numeric_value 8, has_unit UO:0000034).
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    domain_of:
    - AnimalModel
