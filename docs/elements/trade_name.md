...
_A proprietary brand or trade name under which a chemical entity (typically a drug) is manufactured and marketed by a vendor._
...
URI: [namo:trade_name](https://w3id.org/monarch-initiative/namo/trade_name)
Alias: trade_name
...
| ---  | ---  |
| self | namo:trade_name |
| native | namo:trade_name |
