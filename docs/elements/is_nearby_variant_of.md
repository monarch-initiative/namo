...
URI: [namo:is_nearby_variant_of](https://w3id.org/monarch-initiative/namo/is_nearby_variant_of)
...
| ---  | ---  |
| self | namo:is_nearby_variant_of |
| native | namo:is_nearby_variant_of |
