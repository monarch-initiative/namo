...
_Any association between a genotype and a sequence variant._
...
URI: [namo:GenotypeToVariantAssociation](https://w3id.org/monarch-initiative/namo/GenotypeToVariantAssociation)
 ...
 classDiagram
    ...
    click GenotypeToVariantAssociation href "../GenotypeToVariantAssociation/"
      ...
      GenotypeToVariantAssociation : agent_type
        ...
        GenotypeToVariantAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GenotypeToVariantAssociation : elevate_to_prediction
        
      GenotypeToVariantAssociation : evidence_count
      ...
      GenotypeToVariantAssociation : has_confidence_score
      ...
      GenotypeToVariantAssociation : has_evidence
        ...
        GenotypeToVariantAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GenotypeToVariantAssociation : has_evidence_of_type
        
          
    
        
        
        GenotypeToVariantAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GenotypeToVariantAssociation : has_supporting_studies
        
          
    
        
        
        GenotypeToVariantAssociation --> "*" Study : has_supporting_studies
      ...
      GenotypeToVariantAssociation : knowledge_level
        ...
        GenotypeToVariantAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GenotypeToVariantAssociation : object
        ...
        GenotypeToVariantAssociation --> "1" SequenceVariant : object
      ...
      GenotypeToVariantAssociation : object_category
        ...
        GenotypeToVariantAssociation --> "0..1" OntologyClass : object_category
      ...
      GenotypeToVariantAssociation : object_feature_name
      ...
      GenotypeToVariantAssociation : semmed_agreement_count
        
      GenotypeToVariantAssociation : sources
        
          
    
        
        
        GenotypeToVariantAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GenotypeToVariantAssociation : subject
        ...
        GenotypeToVariantAssociation --> "1" Genotype : subject
      ...
      GenotypeToVariantAssociation : subject_category
        ...
        GenotypeToVariantAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [Genotype](Genotype.md) | parent genotype | [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | the relationship type used to connect genotype to gene | [Association](Association.md) |
| [object](object.md) | 1 <br/> [SequenceVariant](SequenceVariant.md) | gene implicated in genotype | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GenotypeToVariantAssociation |
| native | namo:GenotypeToVariantAssociation |
...
attributes:
  subject:
    ...
    owner: genotype to variant association
    domain_of:
    - association
