...
_An association between a gene (or gene product) and a disease in which the gene is classified by its druggability (e.g., via the IDG/Pharos target development-level tiers)._
...
URI: [namo:DruggableGeneToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/DruggableGeneToDiseaseAssociation)
 ...
 classDiagram
    ...
    click DruggableGeneToDiseaseAssociation href "../DruggableGeneToDiseaseAssociation/"
      ...
      DruggableGeneToDiseaseAssociation : agent_type
        ...
        DruggableGeneToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      DruggableGeneToDiseaseAssociation : allelic_requirement
      ...
      DruggableGeneToDiseaseAssociation : disease_context_qualifier
        
          
    
        
        
        DruggableGeneToDiseaseAssociation --> "0..1" Disease : disease_context_qualifier
        click Disease href "../Disease/"
    

        
      DruggableGeneToDiseaseAssociation : diseases_confidence_score
        
      DruggableGeneToDiseaseAssociation : druggable_gene_category
        
          
    
        
        
        DruggableGeneToDiseaseAssociation --> "0..1" DruggableGeneCategoryEnum : druggable_gene_category
        click DruggableGeneCategoryEnum href "../DruggableGeneCategoryEnum/"
    

        
      DruggableGeneToDiseaseAssociation : elevate_to_prediction
        
      DruggableGeneToDiseaseAssociation : evidence_count
        
      DruggableGeneToDiseaseAssociation : frequency_qualifier
        
      DruggableGeneToDiseaseAssociation : gene2phenotype_confidence_category
      ...
      DruggableGeneToDiseaseAssociation : has_confidence_score
      ...
      DruggableGeneToDiseaseAssociation : has_evidence
        ...
        DruggableGeneToDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      DruggableGeneToDiseaseAssociation : has_evidence_of_type
        
          
    
        
        
        DruggableGeneToDiseaseAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      DruggableGeneToDiseaseAssociation : has_supporting_studies
        
          
    
        
        
        DruggableGeneToDiseaseAssociation --> "*" Study : has_supporting_studies
      ...
      DruggableGeneToDiseaseAssociation : knowledge_level
        ...
        DruggableGeneToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      DruggableGeneToDiseaseAssociation : object
        ...
        DruggableGeneToDiseaseAssociation --> "1" Disease : object
        click Disease href "../Disease/"
      ...
      DruggableGeneToDiseaseAssociation : object_aspect_qualifier
        ...
        DruggableGeneToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      DruggableGeneToDiseaseAssociation : object_category
        ...
        DruggableGeneToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      DruggableGeneToDiseaseAssociation : object_direction_qualifier
        ...
        DruggableGeneToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      DruggableGeneToDiseaseAssociation : object_feature_name
      ...
      DruggableGeneToDiseaseAssociation : predicate
        ...
        DruggableGeneToDiseaseAssociation --> "1" GeneToDiseasePredicateEnum : predicate
      ...
      DruggableGeneToDiseaseAssociation : semmed_agreement_count
        
      DruggableGeneToDiseaseAssociation : sources
        
          
    
        
        
        DruggableGeneToDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      DruggableGeneToDiseaseAssociation : subject
        ...
        DruggableGeneToDiseaseAssociation --> "1" GeneOrGeneProduct : subject
      ...
      DruggableGeneToDiseaseAssociation : subject_aspect_qualifier
        ...
        DruggableGeneToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      DruggableGeneToDiseaseAssociation : subject_category
        ...
        DruggableGeneToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      DruggableGeneToDiseaseAssociation : subject_direction_qualifier
        ...
        DruggableGeneToDiseaseAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      DruggableGeneToDiseaseAssociation : subject_feature_name
        
      DruggableGeneToDiseaseAssociation : subject_form_or_variant_qualifier
        
          
    
        
        
        DruggableGeneToDiseaseAssociation --> "0..1" ChemicalOrGeneOrGeneProductFormOrVariantEnum : subject_form_or_variant_qualifier
      ...
      DruggableGeneToDiseaseAssociation : supporting_text
        
      DruggableGeneToDiseaseAssociation : timepoint
        
      DruggableGeneToDiseaseAssociation : type
        
      DruggableGeneToDiseaseAssociation : update_date
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * [GeneToDiseaseAssociation](GeneToDiseaseAssociation.md) [ [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md)]
            * **DruggableGeneToDiseaseAssociation** [ [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md) [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md)]
...
| ---  | --- | --- | --- |
| [druggable_gene_category](druggable_gene_category.md) | 0..1 <br/> [DruggableGeneCategoryEnum](DruggableGeneCategoryEnum.md) | Classification of druggable genes based on knowledge about drug or small mole... | direct |
| [subject](subject.md) | 1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | gene in which variation is correlated with the disease in a protective manner... | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [GeneToDiseasePredicateEnum](GeneToDiseasePredicateEnum.md) | Has a value from the Biolink 'related_to' hierarchy | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:DruggableGeneToDiseaseAssociation |
| native | namo:DruggableGeneToDiseaseAssociation |
...
description: An association between a gene (or gene product) and a disease in which
  the gene is classified by its druggability (e.g., via the IDG/Pharos target development-level
  tiers).
...
attributes:
  druggable gene category:
    name: druggable gene category
    description: Classification of druggable genes based on knowledge about drug or
      small molecule activities.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    alias: druggable_gene_category
    owner: druggable gene to disease association
    domain_of:
