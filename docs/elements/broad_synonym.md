...
_An alternate label for an entity whose meaning is broader (more general) than the primary label but is still useful as a lexical alternative._
...
URI: [namo:broad_synonym](https://w3id.org/monarch-initiative/namo/broad_synonym)
Alias: broad_synonym
...
| ---  | ---  |
| self | namo:broad_synonym |
| native | namo:broad_synonym |
| exact | oboInOwl:hasBroadSynonym |
