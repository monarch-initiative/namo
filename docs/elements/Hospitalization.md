...
_The admission and care of a patient in a hospital for observation, diagnosis, or treatment._
...
URI: [namo:Hospitalization](https://w3id.org/monarch-initiative/namo/Hospitalization)
...
```mermaid
 classDiagram
    ...
    click Hospitalization href "../Hospitalization/"
      ...
      Hospitalization : equivalent_identifiers
        
      Hospitalization : exact_synonym
      ...
      Hospitalization : information_content
        
      Hospitalization : iri
        
      Hospitalization : name
        
      Hospitalization : narrow_synonym
        
      Hospitalization : provided_by
        
      Hospitalization : related_synonym
        
      Hospitalization : synonym
        
      Hospitalization : taxon
...
| ---  | ---  |
| self | namo:Hospitalization |
| native | namo:Hospitalization |
| exact | SNOMEDCT:32485007, WIKIDATA:Q3140971 |
...
description: The admission and care of a patient in a hospital for observation, diagnosis,
  or treatment.
