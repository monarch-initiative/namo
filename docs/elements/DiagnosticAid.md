...
_A device or substance used to help diagnose disease or injury_
...
URI: [namo:DiagnosticAid](https://w3id.org/monarch-initiative/namo/DiagnosticAid)
...
```mermaid
 classDiagram
    ...
    click DiagnosticAid href "../DiagnosticAid/"
      ...
      DiagnosticAid : equivalent_identifiers
        
      DiagnosticAid : exact_synonym
      ...
      DiagnosticAid : information_content
        
      DiagnosticAid : iri
        
      DiagnosticAid : name
        
      DiagnosticAid : narrow_synonym
        
      DiagnosticAid : provided_by
        
      DiagnosticAid : related_synonym
...
| ---  | ---  |
| self | namo:DiagnosticAid |
| native | namo:DiagnosticAid |
| exact | STY:T130, SNOMED:2949005 |
