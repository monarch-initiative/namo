...
_a document reresenting an early version of an author's original scholarly work, such as a research paper or a review, prior to formal peer review and publication in a peer-reviewed scholarly or scientific journal._
...
URI: [namo:PreprintPublication](https://w3id.org/monarch-initiative/namo/PreprintPublication)
...
```mermaid
 classDiagram
    ...
    click PreprintPublication href "../PreprintPublication/"
      ...
      PreprintPublication : broad_synonym
      ...
      PreprintPublication : equivalent_identifiers
        
      PreprintPublication : exact_synonym
      ...
      PreprintPublication : information_content
      ...
      PreprintPublication : narrow_synonym
      ...
      PreprintPublication : related_synonym
...
| ---  | ---  |
| self | namo:PreprintPublication |
| native | namo:PreprintPublication |
| exact | EFO:0010558, fabio:Preprint |
