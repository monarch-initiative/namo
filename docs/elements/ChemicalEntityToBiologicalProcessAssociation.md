...
_An association between a chemical entity and a biological process, where the chemical entity has some effect on the biological process._
...
URI: [namo:ChemicalEntityToBiologicalProcessAssociation](https://w3id.org/monarch-initiative/namo/ChemicalEntityToBiologicalProcessAssociation)
 ...
 classDiagram
    ...
    click ChemicalEntityToBiologicalProcessAssociation href "../ChemicalEntityToBiologicalProcessAssociation/"
      ...
      ChemicalEntityToBiologicalProcessAssociation : agent_type
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "1" AgentTypeEnum : agent_type
      ...
      ChemicalEntityToBiologicalProcessAssociation : evidence_count
      ...
      ChemicalEntityToBiologicalProcessAssociation : has_evidence
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      ChemicalEntityToBiologicalProcessAssociation : has_evidence_of_type
        
          
    
        
        
        ChemicalEntityToBiologicalProcessAssociation --> "*" EvidenceType : has_evidence_of_type
      ...
      ChemicalEntityToBiologicalProcessAssociation : knowledge_level
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      ChemicalEntityToBiologicalProcessAssociation : object
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "1" BiologicalProcess : object
      ...
      ChemicalEntityToBiologicalProcessAssociation : object_category
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "0..1" OntologyClass : object_category
      ...
      ChemicalEntityToBiologicalProcessAssociation : object_direction_qualifier
        
          
    
        
        
        ChemicalEntityToBiologicalProcessAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
      ...
      ChemicalEntityToBiologicalProcessAssociation : semmed_agreement_count
      ...
      ChemicalEntityToBiologicalProcessAssociation : species_context_qualifier
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "0..1" OrganismTaxon : species_context_qualifier
      ...
      ChemicalEntityToBiologicalProcessAssociation : subject
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "1" ChemicalEntity : subject
      ...
      ChemicalEntityToBiologicalProcessAssociation : subject_category
        ...
        ChemicalEntityToBiologicalProcessAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      ChemicalEntityToBiologicalProcessAssociation : supporting_text
...
| [subject](subject.md) | 1 <br/> [ChemicalEntity](ChemicalEntity.md) | the chemical entity that affects the biological process | [Association](Association.md) |
...
| [object](object.md) | 1 <br/> [BiologicalProcess](BiologicalProcess.md) | the biological process that is affected by the chemical entity | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:ChemicalEntityToBiologicalProcessAssociation |
| native | namo:ChemicalEntityToBiologicalProcessAssociation |
...
attributes:
  species context qualifier:
    ...
    owner: chemical entity to biological process association
    domain_of:
    - predicate mapping
