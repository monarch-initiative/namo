...
# Slot: subject_specialization_qualifier 
...
URI: [namo:subject_specialization_qualifier](https://w3id.org/monarch-initiative/namo/subject_specialization_qualifier)
...
| Domain Of | [EntityToDiseaseOrPhenotypicFeatureAssociationMixin](EntityToDiseaseOrPhenotypicFeatureAssociationMixin.md) |
...
| ---  | ---  |
| self | namo:subject_specialization_qualifier |
| native | namo:subject_specialization_qualifier |
