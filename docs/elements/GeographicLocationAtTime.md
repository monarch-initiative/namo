...
_a location that can be described in lat/long coordinates, for a particular time_
...
URI: [namo:GeographicLocationAtTime](https://w3id.org/monarch-initiative/namo/GeographicLocationAtTime)
...
```mermaid
 classDiagram
    class GeographicLocationAtTime
    click GeographicLocationAtTime href "../GeographicLocationAtTime/"
      GeographicLocation <|-- GeographicLocationAtTime
        click GeographicLocation href "../GeographicLocation/"
      
      GeographicLocationAtTime : broad_synonym
      ...
      GeographicLocationAtTime : equivalent_identifiers
        
      GeographicLocationAtTime : exact_synonym
      ...
      GeographicLocationAtTime : information_content
      ...
      GeographicLocationAtTime : narrow_synonym
        
      GeographicLocationAtTime : provided_by
        
      GeographicLocationAtTime : related_synonym
        
      GeographicLocationAtTime : synonym
        
      GeographicLocationAtTime : taxon
...
| [latitude](latitude.md) | 0..1 <br/> [Float](Float.md) | latitude | [GeographicLocation](GeographicLocation.md) |
| [longitude](longitude.md) | 0..1 <br/> [Float](Float.md) | longitude | [GeographicLocation](GeographicLocation.md) |
...
| ---  | ---  |
| self | namo:GeographicLocationAtTime |
| native | namo:GeographicLocationAtTime |
