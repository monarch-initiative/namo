...
_A gene altered in its expression level in the context of some experiment as a result of being targeted by gene-knockdown reagent(s) such as a morpholino or RNAi._
...
URI: [namo:ReagentTargetedGene](https://w3id.org/monarch-initiative/namo/ReagentTargetedGene)
...
```mermaid
 classDiagram
    ...
    click ReagentTargetedGene href "../ReagentTargetedGene/"
      ...
      ReagentTargetedGene : broad_synonym
      ...
      ReagentTargetedGene : equivalent_identifiers
        
      ReagentTargetedGene : exact_synonym
      ...
      ReagentTargetedGene : information_content
        
      ReagentTargetedGene : iri
        
      ReagentTargetedGene : name
        
      ReagentTargetedGene : narrow_synonym
        
      ReagentTargetedGene : provided_by
        
      ReagentTargetedGene : related_synonym
        
      ReagentTargetedGene : subsets
        
      ReagentTargetedGene : synonym
        
      ReagentTargetedGene : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **ReagentTargetedGene** [ [GenomicEntity](GenomicEntity.md) [PhysicalEssence](PhysicalEssence.md) [OntologyClass](OntologyClass.md)]
...
| ---  | ---  |
| self | namo:ReagentTargetedGene |
| native | namo:ReagentTargetedGene |
| exact | GENO:0000504 |
