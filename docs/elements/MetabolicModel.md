...
```mermaid
 classDiagram
    ...
    click MetabolicModel href "../MetabolicModel/"
      ...
      MetabolicModel : broad_synonym
        
      MetabolicModel : category
      ...
      MetabolicModel : deprecated
        
      MetabolicModel : description
        
      MetabolicModel : equivalent_identifiers
        
      MetabolicModel : exact_synonym
        
      MetabolicModel : full_name
        
      MetabolicModel : has_attribute
        
          
    
        
        
        MetabolicModel --> "*" Attribute : has_attribute
      ...
      MetabolicModel : information_content
      ...
      MetabolicModel : narrow_synonym
        
      MetabolicModel : prediction_scope
        
      MetabolicModel : provided_by
      ...
      MetabolicModel : related_synonym
        
      MetabolicModel : software_platform
        
      MetabolicModel : spatial_context
        
      MetabolicModel : synonym
        
      MetabolicModel : taxon
