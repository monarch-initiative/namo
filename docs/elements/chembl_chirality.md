...
# Slot: chembl_chirality 


_Tern indicating the chirality of the chemical entity._
...
URI: [namo:chembl_chirality](https://w3id.org/monarch-initiative/namo/chembl_chirality)
...
| ---  | ---  |
| self | namo:chembl_chirality |
| native | namo:chembl_chirality |
