...
# Slot: subject_label_closure 


_Used to hold the subject label closure of an association. This is a denormalized field used primarily in the SQL serialization of a knowledge graph via KGX._
...
URI: [namo:subject_label_closure](https://w3id.org/monarch-initiative/namo/subject_label_closure)
...
| ---  | ---  |
| self | namo:subject_label_closure |
| native | namo:subject_label_closure |
