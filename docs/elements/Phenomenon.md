...
_a fact or situation that is observed to exist or happen, especially one whose cause or explanation is in question_
...
URI: [namo:Phenomenon](https://w3id.org/monarch-initiative/namo/Phenomenon)
...
```mermaid
 classDiagram
    ...
    click Phenomenon href "../Phenomenon/"
      ...
      Phenomenon : equivalent_identifiers
        
      Phenomenon : exact_synonym
      ...
      Phenomenon : information_content
        
      Phenomenon : iri
        
      Phenomenon : name
        
      Phenomenon : narrow_synonym
        
      Phenomenon : provided_by
        
      Phenomenon : related_synonym
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **Phenomenon** [ [Occurrent](Occurrent.md)]
...
| ---  | ---  |
| self | namo:Phenomenon |
| native | namo:Phenomenon |
| exact | UMLSSG:PHEN |
| narrow | STY:T034, STY:T038, STY:T069 |
| broad | STY:T067, STY:T068, STY:T070 |
