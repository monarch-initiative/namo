...
_A differential-expression measurement for a single gene in a model system._
...
URI: [namo:GeneExpressionResult](https://w3id.org/monarch-initiative/namo/GeneExpressionResult)
...
```mermaid
 classDiagram
    ...
    click GeneExpressionResult href "../GeneExpressionResult/"
      ...
      GeneExpressionResult : adjusted_p_value
        
      GeneExpressionResult : broad_synonym
        
      GeneExpressionResult : category
        
      GeneExpressionResult : deprecated
        
      GeneExpressionResult : description
        
      GeneExpressionResult : equivalent_identifiers
        
      GeneExpressionResult : exact_synonym
        
      GeneExpressionResult : fold_change
        
      GeneExpressionResult : full_name
        
      GeneExpressionResult : gene
        
          
    
        
        
        GeneExpressionResult --> "0..1" Gene : gene
        click Gene href "../Gene/"
    

        
      GeneExpressionResult : has_attribute
        
          
    
        
        
        GeneExpressionResult --> "*" Attribute : has_attribute
        click Attribute href "../Attribute/"
    

        
      GeneExpressionResult : id
        
      GeneExpressionResult : information_content
        
      GeneExpressionResult : iri
        
      GeneExpressionResult : name
        
      GeneExpressionResult : narrow_synonym
        
      GeneExpressionResult : p_value
        
      GeneExpressionResult : provided_by
        
      GeneExpressionResult : related_synonym
        
      GeneExpressionResult : synonym
        
      GeneExpressionResult : taxon
        
      GeneExpressionResult : type
        
      GeneExpressionResult : xref
...
| ---  | --- | --- | --- |
| [gene](gene.md) | 0..1 <br/> [Gene](Gene.md) | The gene this measurement is about | direct |
...
| ---  | --- | --- | --- |
| [MolecularSimilarity](MolecularSimilarity.md) | [differentially_expressed_genes](differentially_expressed_genes.md) | range | [GeneExpressionResult](GeneExpressionResult.md) |
| [MolecularSimilarity](MolecularSimilarity.md) | [conserved_genes](conserved_genes.md) | range | [GeneExpressionResult](GeneExpressionResult.md) |
...
| ---  | ---  |
| self | namo:GeneExpressionResult |
| native | namo:GeneExpressionResult |
...
<details>
```yaml
name: GeneExpressionResult
description: A differential-expression measurement for a single gene in a model system.
...
attributes:
  gene:
    ...
    description: The gene this measurement is about. Identifier prefixes follow Biolink's
      `gene` (HGNC, NCBIGene, ENSEMBL, ...), which replaces the former gene_symbol
      / ensembl_id / entrez_id attributes.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    domain_of:
    - GeneExpressionResult
