...
```mermaid
 classDiagram
    ...
    click MicrophysiologicalSystem href "../MicrophysiologicalSystem/"
      ...
      MicrophysiologicalSystem : broad_synonym
        
      MicrophysiologicalSystem : category
      ...
      MicrophysiologicalSystem : deprecated
        
      MicrophysiologicalSystem : description
        
      MicrophysiologicalSystem : equivalent_identifiers
        
      MicrophysiologicalSystem : exact_synonym
        
      MicrophysiologicalSystem : full_name
        
      MicrophysiologicalSystem : has_attribute
        
          
    
        
        
        MicrophysiologicalSystem --> "*" Attribute : has_attribute
      ...
      MicrophysiologicalSystem : information_content
        
      MicrophysiologicalSystem : iri
      ...
      MicrophysiologicalSystem : narrow_synonym
        
      MicrophysiologicalSystem : perfusion_system
        
      MicrophysiologicalSystem : provided_by
      ...
      MicrophysiologicalSystem : related_synonym
      ...
      MicrophysiologicalSystem : synonym
        
      MicrophysiologicalSystem : taxon
        
      MicrophysiologicalSystem : type
        
      MicrophysiologicalSystem : xref
