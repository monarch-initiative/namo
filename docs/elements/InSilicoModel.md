...
```mermaid
 classDiagram
    ...
    click InSilicoModel href "../InSilicoModel/"
      ...
      InSilicoModel : broad_synonym
        
      InSilicoModel : category
      ...
      InSilicoModel : deprecated
        
      InSilicoModel : description
        
      InSilicoModel : equivalent_identifiers
        
      InSilicoModel : exact_synonym
        
      InSilicoModel : full_name
        
      InSilicoModel : has_attribute
        
          
    
        
        
        InSilicoModel --> "*" Attribute : has_attribute
      ...
      InSilicoModel : information_content
      ...
      InSilicoModel : narrow_synonym
        
      InSilicoModel : prediction_scope
        
      InSilicoModel : provided_by
