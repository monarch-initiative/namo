...
_A sample is a limited quantity of something (e.g. an individual or set of individuals from a population, or a portion of a substance) to be used for testing, analysis, inspection, investigation, demonstration, or trial use. [SIO]_
...
URI: [namo:MaterialSample](https://w3id.org/monarch-initiative/namo/MaterialSample)
...
```mermaid
 classDiagram
    ...
    click MaterialSample href "../MaterialSample/"
      ...
      MaterialSample : equivalent_identifiers
        
      MaterialSample : exact_synonym
      ...
      MaterialSample : information_content
        
      MaterialSample : iri
        
      MaterialSample : name
        
      MaterialSample : narrow_synonym
        
      MaterialSample : provided_by
        
      MaterialSample : related_synonym
        
      MaterialSample : synonym
        
      MaterialSample : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [PhysicalEntity](PhysicalEntity.md) [ [PhysicalEssence](PhysicalEssence.md)]
            * **MaterialSample** [ [SubjectOfInvestigation](SubjectOfInvestigation.md)]
...
| ---  | --- | --- | --- |
| [MaterialSampleToEntityAssociationMixin](MaterialSampleToEntityAssociationMixin.md) | [subject](subject.md) | range | [MaterialSample](MaterialSample.md) |
| [MaterialSampleDerivationAssociation](MaterialSampleDerivationAssociation.md) | [subject](subject.md) | range | [MaterialSample](MaterialSample.md) |
| [MaterialSampleToDiseaseOrPhenotypicFeatureAssociation](MaterialSampleToDiseaseOrPhenotypicFeatureAssociation.md) | [subject](subject.md) | range | [MaterialSample](MaterialSample.md) |
...
| ---  | ---  |
| self | namo:MaterialSample |
| native | namo:MaterialSample |
