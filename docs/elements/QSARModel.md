...
```mermaid
 classDiagram
    ...
    click QSARModel href "../QSARModel/"
      ...
      QSARModel : deprecated
        
      QSARModel : description
        
      QSARModel : equivalent_identifiers
        
      QSARModel : exact_synonym
        
      QSARModel : full_name
        
      QSARModel : has_attribute
        
          
    
        
        
        QSARModel --> "*" Attribute : has_attribute
      ...
      QSARModel : narrow_synonym
        
      QSARModel : prediction_scope
        
      QSARModel : provided_by
