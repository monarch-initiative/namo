...
# Class: TextMiningStudyResult 


_A study result that represents information extracted from text using natural language processing techniques. This includes the extracted text, location offsets within the source document, confidence scores, and other metadata related to the text mining process._
...
URI: [namo:TextMiningStudyResult](https://w3id.org/monarch-initiative/namo/TextMiningStudyResult)
...
```mermaid
 classDiagram
    class TextMiningStudyResult
    click TextMiningStudyResult href "../TextMiningStudyResult/"
      StudyResult <|-- TextMiningStudyResult
        click StudyResult href "../StudyResult/"
      
      TextMiningStudyResult : broad_synonym
        
      TextMiningStudyResult : category
        
      TextMiningStudyResult : deprecated
        
      TextMiningStudyResult : description
        
      TextMiningStudyResult : equivalent_identifiers
        
      TextMiningStudyResult : exact_synonym
        
      TextMiningStudyResult : extraction_confidence_score
        
      TextMiningStudyResult : full_name
        
      TextMiningStudyResult : has_attribute
        
          
    
        
        
        TextMiningStudyResult --> "*" Attribute : has_attribute
        click Attribute href "../Attribute/"
    

        
      TextMiningStudyResult : id
        
      TextMiningStudyResult : information_content
        
      TextMiningStudyResult : iri
        
      TextMiningStudyResult : name
        
      TextMiningStudyResult : narrow_synonym
        
      TextMiningStudyResult : object_location_in_text
        
      TextMiningStudyResult : provided_by
        
      TextMiningStudyResult : related_synonym
        
      TextMiningStudyResult : subject_location_in_text
        
      TextMiningStudyResult : supporting_document_type
        
      TextMiningStudyResult : supporting_document_year
        
      TextMiningStudyResult : supporting_text
        
      TextMiningStudyResult : supporting_text_section_type
        
      TextMiningStudyResult : synonym
        
      TextMiningStudyResult : taxon
        
      TextMiningStudyResult : type
        
      TextMiningStudyResult : xref
...
| [subject_location_in_text](subject_location_in_text.md) | * <br/> [Integer](Integer.md) | Character offsets for the text span(s) in the supporting text corresponding t... | direct |
| [object_location_in_text](object_location_in_text.md) | * <br/> [Integer](Integer.md) | Character offsets for the text span(s) in the supporting text corresponding t... | direct |
| [extraction_confidence_score](extraction_confidence_score.md) | 0..1 <br/> [Float](Float.md) | A quantitative confidence value that represents the probability of obtaining ... | direct |
| [supporting_document_type](supporting_document_type.md) | 0..1 <br/> [String](String.md) | The document type (e | direct |
| [supporting_document_year](supporting_document_year.md) | 0..1 <br/> [Integer](Integer.md) | The document year (typically the publication year) for the supporting documen... | direct |
| [supporting_text_section_type](supporting_text_section_type.md) | 0..1 <br/> [String](String.md) | The section of the supporting text of a Text Mining Result within the support... | direct |
...
| ---  | ---  |
| self | namo:TextMiningStudyResult |
| native | namo:TextMiningStudyResult |
...
attributes:
  supporting text:
    ...
    owner: text mining study result
    domain_of:
  ...
  supporting document type:
    ...
    description: The document type (e.g., Journal Article, Case Study, Preprint) for
  ...
  supporting text section type:
    ...
    description: The section of the supporting text of a Text Mining Result within
