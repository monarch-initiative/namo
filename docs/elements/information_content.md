...
_Information content (IC) value for a term, primarily from Automats._
...
URI: [namo:information_content](https://w3id.org/monarch-initiative/namo/information_content)
...
| ---  | ---  |
| self | namo:information_content |
| native | namo:information_content |
