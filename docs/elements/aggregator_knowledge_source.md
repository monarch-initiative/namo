...
URI: [namo:aggregator_knowledge_source](https://w3id.org/monarch-initiative/namo/aggregator_knowledge_source)
...
| ---  | ---  |
| self | namo:aggregator_knowledge_source |
| native | namo:aggregator_knowledge_source |
