...
URI: [namo:NAMDataset](https://w3id.org/monarch-initiative/namo/NAMDataset)
...
```mermaid
 classDiagram
    class NAMDataset
    click NAMDataset href "../NAMDataset/"
      Dataset <|-- NAMDataset
        click Dataset href "../Dataset/"
      
      NAMDataset : broad_synonym
        
      NAMDataset : category
        
      NAMDataset : creation_date
        
      NAMDataset : deprecated
        
      NAMDataset : description
        
      NAMDataset : equivalent_identifiers
        
      NAMDataset : exact_synonym
        
      NAMDataset : format
        
      NAMDataset : full_name
        
      NAMDataset : has_attribute
        
          
    
        
        
        NAMDataset --> "*" Attribute : has_attribute
      ...
      NAMDataset : information_content
        
      NAMDataset : iri
        
      NAMDataset : license
        
      NAMDataset : model_systems
        
          
    
        
        
        NAMDataset --> "*" ModelSystem : model_systems
      ...
      NAMDataset : narrow_synonym
        
      NAMDataset : provided_by
        
      NAMDataset : related_synonym
...
| [studies](studies.md) | * <br/> [NAMStudy](NAMStudy.md) |  | direct |
...
| ---  | ---  |
| self | namo:NAMDataset |
| native | namo:NAMDataset |
