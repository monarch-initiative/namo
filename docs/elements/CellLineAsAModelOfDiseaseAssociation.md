...
_An association in which a cell line - typically derived from an organismal entity with a disease state - serves as a model for that disease in experimental settings._
...
URI: [namo:CellLineAsAModelOfDiseaseAssociation](https://w3id.org/monarch-initiative/namo/CellLineAsAModelOfDiseaseAssociation)
 ...
 classDiagram
    ...
    click CellLineAsAModelOfDiseaseAssociation href "../CellLineAsAModelOfDiseaseAssociation/"
      ...
      CellLineAsAModelOfDiseaseAssociation : agent_type
        ...
        CellLineAsAModelOfDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      CellLineAsAModelOfDiseaseAssociation : anatomical_context_qualifier
      ...
      CellLineAsAModelOfDiseaseAssociation : disease_context_qualifier
        
          
    
        
        
        CellLineAsAModelOfDiseaseAssociation --> "0..1" Disease : disease_context_qualifier
        click Disease href "../Disease/"
    

        
      CellLineAsAModelOfDiseaseAssociation : elevate_to_prediction
        
      CellLineAsAModelOfDiseaseAssociation : evidence_count
      ...
      CellLineAsAModelOfDiseaseAssociation : has_confidence_score
      ...
      CellLineAsAModelOfDiseaseAssociation : has_evidence
        ...
        CellLineAsAModelOfDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      CellLineAsAModelOfDiseaseAssociation : has_evidence_of_type
        
          
    
        
        
        CellLineAsAModelOfDiseaseAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      CellLineAsAModelOfDiseaseAssociation : has_supporting_studies
        
          
    
        
        
        CellLineAsAModelOfDiseaseAssociation --> "*" Study : has_supporting_studies
      ...
      CellLineAsAModelOfDiseaseAssociation : knowledge_level
        ...
        CellLineAsAModelOfDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      CellLineAsAModelOfDiseaseAssociation : object
        ...
        CellLineAsAModelOfDiseaseAssociation --> "1" Disease : object
        click Disease href "../Disease/"
      ...
      CellLineAsAModelOfDiseaseAssociation : object_aspect_qualifier
        ...
        CellLineAsAModelOfDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      CellLineAsAModelOfDiseaseAssociation : object_category
        ...
        CellLineAsAModelOfDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      CellLineAsAModelOfDiseaseAssociation : object_direction_qualifier
        ...
        CellLineAsAModelOfDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      CellLineAsAModelOfDiseaseAssociation : object_feature_name
        
      CellLineAsAModelOfDiseaseAssociation : object_label_closure
        
      CellLineAsAModelOfDiseaseAssociation : object_namespace
        
      CellLineAsAModelOfDiseaseAssociation : object_specialization_qualifier
      ...
      CellLineAsAModelOfDiseaseAssociation : semmed_agreement_count
        
      CellLineAsAModelOfDiseaseAssociation : sources
        
          
    
        
        
        CellLineAsAModelOfDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      CellLineAsAModelOfDiseaseAssociation : subject
        ...
        CellLineAsAModelOfDiseaseAssociation --> "1" CellLine : subject
      ...
      CellLineAsAModelOfDiseaseAssociation : subject_aspect_qualifier
        ...
        CellLineAsAModelOfDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      CellLineAsAModelOfDiseaseAssociation : subject_category
        ...
        CellLineAsAModelOfDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      CellLineAsAModelOfDiseaseAssociation : subject_direction_qualifier
        ...
        CellLineAsAModelOfDiseaseAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      CellLineAsAModelOfDiseaseAssociation : subject_feature_name
        
      CellLineAsAModelOfDiseaseAssociation : subject_label_closure
        
      CellLineAsAModelOfDiseaseAssociation : subject_namespace
        
      CellLineAsAModelOfDiseaseAssociation : subject_specialization_qualifier
        
      CellLineAsAModelOfDiseaseAssociation : supporting_text
        
      CellLineAsAModelOfDiseaseAssociation : timepoint
        
      CellLineAsAModelOfDiseaseAssociation : type
        
      CellLineAsAModelOfDiseaseAssociation : update_date
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * [CellLineToDiseaseOrPhenotypicFeatureAssociation](CellLineToDiseaseOrPhenotypicFeatureAssociation.md) [ [CellLineToEntityAssociationMixin](CellLineToEntityAssociationMixin.md) [EntityToDiseaseOrPhenotypicFeatureAssociationMixin](EntityToDiseaseOrPhenotypicFeatureAssociationMixin.md)]
            * **CellLineAsAModelOfDiseaseAssociation** [ [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md) [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md)]
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [CellLine](CellLine.md) | A cell line derived from an organismal entity with a disease state that is us... | [Association](Association.md), [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md), [EntityToDiseaseOrPhenotypicFeatureAssociationMixin](EntityToDiseaseOrPhenotypicFeatureAssociationMixin.md), [CellLineToEntityAssociationMixin](CellLineToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | The relationship to the disease | [Association](Association.md), [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md), [EntityToDiseaseOrPhenotypicFeatureAssociationMixin](EntityToDiseaseOrPhenotypicFeatureAssociationMixin.md), [CellLineToEntityAssociationMixin](CellLineToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md) |
| [object](object.md) | 1 <br/> [Disease](Disease.md) | disease | [Association](Association.md), [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md), [EntityToDiseaseOrPhenotypicFeatureAssociationMixin](EntityToDiseaseOrPhenotypicFeatureAssociationMixin.md), [CellLineToEntityAssociationMixin](CellLineToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md) |
...
| ---  | ---  |
| self | namo:CellLineAsAModelOfDiseaseAssociation |
| native | namo:CellLineAsAModelOfDiseaseAssociation |
...
description: An association in which a cell line - typically derived from an organismal
  entity with a disease state - serves as a model for that disease in experimental
  settings.
...
attributes:
  subject:
    ...
    owner: cell line as a model of disease association
    domain_of:
    - association
