...
_Any association between a genotype and a gene. The genotype have have multiple variants in that gene or a single one. There is no assumption of cardinality_
...
URI: [namo:GenotypeToGeneAssociation](https://w3id.org/monarch-initiative/namo/GenotypeToGeneAssociation)
 ...
 classDiagram
    ...
    click GenotypeToGeneAssociation href "../GenotypeToGeneAssociation/"
      ...
      GenotypeToGeneAssociation : agent_type
        ...
        GenotypeToGeneAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GenotypeToGeneAssociation : elevate_to_prediction
        
      GenotypeToGeneAssociation : evidence_count
      ...
      GenotypeToGeneAssociation : has_confidence_score
      ...
      GenotypeToGeneAssociation : has_evidence
        ...
        GenotypeToGeneAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GenotypeToGeneAssociation : has_evidence_of_type
        
          
    
        
        
        GenotypeToGeneAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GenotypeToGeneAssociation : has_supporting_studies
        
          
    
        
        
        GenotypeToGeneAssociation --> "*" Study : has_supporting_studies
      ...
      GenotypeToGeneAssociation : knowledge_level
        ...
        GenotypeToGeneAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GenotypeToGeneAssociation : object
        ...
        GenotypeToGeneAssociation --> "1" Gene : object
      ...
      GenotypeToGeneAssociation : object_category
        ...
        GenotypeToGeneAssociation --> "0..1" OntologyClass : object_category
      ...
      GenotypeToGeneAssociation : object_feature_name
      ...
      GenotypeToGeneAssociation : semmed_agreement_count
        
      GenotypeToGeneAssociation : sources
        
          
    
        
        
        GenotypeToGeneAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GenotypeToGeneAssociation : subject
        ...
        GenotypeToGeneAssociation --> "1" Genotype : subject
      ...
      GenotypeToGeneAssociation : subject_category
        ...
        GenotypeToGeneAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| [object](object.md) | 1 <br/> [Gene](Gene.md) | gene implicated in genotype | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GenotypeToGeneAssociation |
| native | namo:GenotypeToGeneAssociation |
...
attributes:
  subject:
    ...
    owner: genotype to gene association
    domain_of:
    - association
