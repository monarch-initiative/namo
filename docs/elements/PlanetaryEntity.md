...
_Any entity or process that exists at the level of the whole planet_
...
URI: [namo:PlanetaryEntity](https://w3id.org/monarch-initiative/namo/PlanetaryEntity)
...
```mermaid
 classDiagram
    ...
    click PlanetaryEntity href "../PlanetaryEntity/"
      ...
      PlanetaryEntity : equivalent_identifiers
        
      PlanetaryEntity : exact_synonym
      ...
      PlanetaryEntity : information_content
        
      PlanetaryEntity : iri
        
      PlanetaryEntity : name
        
      PlanetaryEntity : narrow_synonym
        
      PlanetaryEntity : provided_by
        
      PlanetaryEntity : related_synonym
        
      PlanetaryEntity : synonym
        
      PlanetaryEntity : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **PlanetaryEntity**
            * [EnvironmentalProcess](EnvironmentalProcess.md) [ [Occurrent](Occurrent.md)]
...
| ---  | ---  |
| self | namo:PlanetaryEntity |
| native | namo:PlanetaryEntity |
