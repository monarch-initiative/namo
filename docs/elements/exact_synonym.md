...
_An alternate label for an entity that denotes exactly the same meaning as the primary label and is interchangeable with it in all contexts._
...
URI: [namo:exact_synonym](https://w3id.org/monarch-initiative/namo/exact_synonym)
Alias: exact_synonym
...
| ---  | ---  |
| self | namo:exact_synonym |
| native | namo:exact_synonym |
