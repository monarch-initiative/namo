...
URI: [namo:NAMStudy](https://w3id.org/monarch-initiative/namo/NAMStudy)
...
```mermaid
 classDiagram
    ...
    click NAMStudy href "../NAMStudy/"
      ...
      NAMStudy : biological_context
        
      NAMStudy : broad_synonym
        
      NAMStudy : category
        
      NAMStudy : context_of_use
        
      NAMStudy : deprecated
        
      NAMStudy : description
        
      NAMStudy : endpoints
        
      NAMStudy : equivalent_identifiers
        
      NAMStudy : exact_synonym
        
      NAMStudy : full_name
        
      NAMStudy : has_attribute
        
          
    
        
        
        NAMStudy --> "*" Attribute : has_attribute
        click Attribute href "../Attribute/"
    

        
      NAMStudy : has_study_results
        
          
    
        
        
        NAMStudy --> "*" StudyResult : has_study_results
      ...
      NAMStudy : information_content
        
      NAMStudy : iri
        
      NAMStudy : name
        
      NAMStudy : narrow_synonym
        
      NAMStudy : perturbations
        
      NAMStudy : plan_comparators
        
      NAMStudy : provided_by
        
      NAMStudy : related_synonym
...
| ---  | --- | --- | --- |
| [NAMDataset](NAMDataset.md) | [studies](studies.md) | range | [NAMStudy](NAMStudy.md) |
