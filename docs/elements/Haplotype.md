...
_A set of zero or more Alleles on a single instance of a Sequence[VMC]_
...
URI: [namo:Haplotype](https://w3id.org/monarch-initiative/namo/Haplotype)
...
```mermaid
 classDiagram
    ...
    click Haplotype href "../Haplotype/"
      ...
      Haplotype : equivalent_identifiers
        
      Haplotype : exact_synonym
      ...
      Haplotype : information_content
        
      Haplotype : iri
        
      Haplotype : name
        
      Haplotype : narrow_synonym
        
      Haplotype : provided_by
        
      Haplotype : related_synonym
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **Haplotype** [ [GenomicEntity](GenomicEntity.md) [PhysicalEssence](PhysicalEssence.md) [OntologyClass](OntologyClass.md)]
...
| ---  | ---  |
| self | namo:Haplotype |
| native | namo:Haplotype |
| exact | GENO:0000871, SO:0001024, VMC:Haplotype |
