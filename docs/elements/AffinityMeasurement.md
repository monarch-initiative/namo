...
URI: [namo:AffinityMeasurement](https://w3id.org/monarch-initiative/namo/AffinityMeasurement)
...
```mermaid
 classDiagram
    ...
    click AffinityMeasurement href "../AffinityMeasurement/"
      ...
      AffinityMeasurement : affinity
        
      AffinityMeasurement : affinity_parameter
        
          
    
        
        
        AffinityMeasurement --> "0..1" AffinityParameterEnum : affinity_parameter
        click AffinityParameterEnum href "../AffinityParameterEnum/"
    

        
      AffinityMeasurement : broad_synonym
        
      AffinityMeasurement : category
        
      AffinityMeasurement : deprecated
        
      AffinityMeasurement : description
        
      AffinityMeasurement : equivalent_identifiers
        
      AffinityMeasurement : exact_synonym
        
      AffinityMeasurement : full_name
        
      AffinityMeasurement : has_attribute
        
          
    
        
        
        AffinityMeasurement --> "*" Attribute : has_attribute
        click Attribute href "../Attribute/"
    

        
      AffinityMeasurement : has_binary_relation
        
          
    
        
        
        AffinityMeasurement --> "0..1" BinaryRelationEnum : has_binary_relation
        click BinaryRelationEnum href "../BinaryRelationEnum/"
    

        
      AffinityMeasurement : id
        
      AffinityMeasurement : information_content
        
      AffinityMeasurement : iri
        
      AffinityMeasurement : name
        
      AffinityMeasurement : narrow_synonym
        
      AffinityMeasurement : provided_by
        
      AffinityMeasurement : related_synonym
        
      AffinityMeasurement : synonym
        
      AffinityMeasurement : taxon
        
      AffinityMeasurement : type
        
      AffinityMeasurement : xref
...
| ---  | --- | --- | --- |
| [affinity_parameter](affinity_parameter.md) | 0..1 <br/> [AffinityParameterEnum](AffinityParameterEnum.md) | The type of parameter describing the strength of an affinity between two enti... | direct |
| [affinity](affinity.md) | 0..1 <br/> [Float](Float.md) | The numerical value describing the strength of an affinity between two entiti... | direct |
| [has_binary_relation](has_binary_relation.md) | 0..1 <br/> [BinaryRelationEnum](BinaryRelationEnum.md) | Qualifies a value context with a mathematical binary relation | direct |
...
| ---  | --- | --- | --- |
| [ChemicalGeneInteractionAssociation](ChemicalGeneInteractionAssociation.md) | [has_affinity](has_affinity.md) | range | [AffinityMeasurement](AffinityMeasurement.md) |
...
| ---  | ---  |
| self | namo:AffinityMeasurement |
| native | namo:AffinityMeasurement |
...
<details>
```yaml
name: affinity measurement
description: The type of measurement describing the strength of an affinity between
  two entities. For instance, if a chemical inhibits a protein with a pIC50 of 8.6,
  the affinity parameter is pIC50 and the affinity value is 8.6. The binary relation,
  if given, qualifies the affinity as greater than, less than, or equal.
...
attributes:
  affinity parameter:
    ...
    description: The type of parameter describing the strength of an affinity between
      two entities.  For instance, if a chemical inhibits a protein with a pIC50 of
      8.6, the 'affinity parameter' is pIC50. Used in conjunction with the 'affinity'
      slot, within an 'affinity measurement'.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    is_a: node property
    domain: named thing
    alias: affinity_parameter
    owner: affinity measurement
    domain_of:
    - affinity measurement
    range: AffinityParameterEnum
  affinity:
    name: affinity
    description: The numerical value describing the strength of an affinity between
      two entities.  For instance, if a chemical inhibits a protein with a pIC50 of
      8.6, the affinity is 8.6. Used in conjunction with the affinity parameter slot.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    is_a: node property
    domain: named thing
    ...
    range: float
  has binary relation:
    name: has binary relation
    description: Qualifies a value context with a mathematical binary relation.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    alias: has_binary_relation
    owner: affinity measurement
    domain_of:
    - affinity measurement
