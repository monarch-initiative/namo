...
# Slot: condition_ameliorated_by 

<div data-search-exclude markdown="1">



URI: [namo:condition_ameliorated_by](https://w3id.org/monarch-initiative/namo/condition_ameliorated_by)
...
| Property | Value |
| --- | --- |
| Inverse | [ameliorates_condition](ameliorates_condition.md) |
...
| ---  | ---  |
| self | namo:condition_ameliorated_by |
| native | namo:condition_ameliorated_by |
