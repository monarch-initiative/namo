...
# Class: ChemicalAffectsBiologicalEntityAssociation 


_Describes an effect that a chemical has on a biological entity (e.g. an impact of on its abundance, activity,localization, processing, expression, etc.)_
...
URI: [namo:ChemicalAffectsBiologicalEntityAssociation](https://w3id.org/monarch-initiative/namo/ChemicalAffectsBiologicalEntityAssociation)
...
```mermaid
 classDiagram
    ...
    click ChemicalAffectsBiologicalEntityAssociation href "../ChemicalAffectsBiologicalEntityAssociation/"
      ...
      ChemicalAffectsBiologicalEntityAssociation <|-- ChemicalAffectsGeneAssociation
        click ChemicalAffectsGeneAssociation href "../ChemicalAffectsGeneAssociation/"
      

      ChemicalAffectsBiologicalEntityAssociation : adjusted_p_value
        
      ChemicalAffectsBiologicalEntityAssociation : agent_type
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "1" AgentTypeEnum : agent_type
        click AgentTypeEnum href "../AgentTypeEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : aggregator_knowledge_source
        
      ChemicalAffectsBiologicalEntityAssociation : anatomical_context_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" AnatomicalEntity : anatomical_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : category
        
      ChemicalAffectsBiologicalEntityAssociation : causal_mechanism_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" CausalMechanismQualifierEnum : causal_mechanism_qualifier
        click CausalMechanismQualifierEnum href "../CausalMechanismQualifierEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : deprecated
        
      ChemicalAffectsBiologicalEntityAssociation : description
        
      ChemicalAffectsBiologicalEntityAssociation : elevate_to_prediction
        
      ChemicalAffectsBiologicalEntityAssociation : evidence_count
        
      ChemicalAffectsBiologicalEntityAssociation : has_attribute
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" Attribute : has_attribute
        click Attribute href "../Attribute/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : has_confidence_score
        
      ChemicalAffectsBiologicalEntityAssociation : has_evidence
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : has_evidence_of_type
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : has_supporting_studies
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" Study : has_supporting_studies
        click Study href "../Study/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : id
        
      ChemicalAffectsBiologicalEntityAssociation : iri
        
      ChemicalAffectsBiologicalEntityAssociation : knowledge_level
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "1" KnowledgeLevelEnum : knowledge_level
        click KnowledgeLevelEnum href "../KnowledgeLevelEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : knowledge_source
        
      ChemicalAffectsBiologicalEntityAssociation : name
        
      ChemicalAffectsBiologicalEntityAssociation : negated
        
      ChemicalAffectsBiologicalEntityAssociation : object
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "1" BiologicalEntity : object
        click BiologicalEntity href "../BiologicalEntity/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_aspect_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_category
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" OntologyClass : object_category
        click OntologyClass href "../OntologyClass/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_category_closure
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" OntologyClass : object_category_closure
        click OntologyClass href "../OntologyClass/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_closure
        
      ChemicalAffectsBiologicalEntityAssociation : object_context_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" AnatomicalEntity : object_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_direction_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_feature_name
        
      ChemicalAffectsBiologicalEntityAssociation : object_form_or_variant_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" ChemicalOrGeneOrGeneProductFormOrVariantEnum : object_form_or_variant_qualifier
        click ChemicalOrGeneOrGeneProductFormOrVariantEnum href "../ChemicalOrGeneOrGeneProductFormOrVariantEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : object_label_closure
        
      ChemicalAffectsBiologicalEntityAssociation : object_namespace
        
      ChemicalAffectsBiologicalEntityAssociation : object_part_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" GeneOrGeneProductOrChemicalPartQualifierEnum : object_part_qualifier
        click GeneOrGeneProductOrChemicalPartQualifierEnum href "../GeneOrGeneProductOrChemicalPartQualifierEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : original_object
        
      ChemicalAffectsBiologicalEntityAssociation : original_predicate
        
      ChemicalAffectsBiologicalEntityAssociation : original_subject
        
      ChemicalAffectsBiologicalEntityAssociation : p_value
        
      ChemicalAffectsBiologicalEntityAssociation : predicate
        
      ChemicalAffectsBiologicalEntityAssociation : primary_knowledge_source
        
      ChemicalAffectsBiologicalEntityAssociation : publications
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" Publication : publications
        click Publication href "../Publication/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : qualified_predicate
        
      ChemicalAffectsBiologicalEntityAssociation : qualifier
        
      ChemicalAffectsBiologicalEntityAssociation : qualifiers
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" OntologyClass : qualifiers
        click OntologyClass href "../OntologyClass/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : retrieval_source_ids
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" RetrievalSource : retrieval_source_ids
        click RetrievalSource href "../RetrievalSource/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : semmed_agreement_count
        
      ChemicalAffectsBiologicalEntityAssociation : sources
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : species_context_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" OrganismTaxon : species_context_qualifier
        click OrganismTaxon href "../OrganismTaxon/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "1" ChemicalEntity : subject
        click ChemicalEntity href "../ChemicalEntity/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_aspect_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_category
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_category_closure
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "*" OntologyClass : subject_category_closure
        click OntologyClass href "../OntologyClass/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_closure
        
      ChemicalAffectsBiologicalEntityAssociation : subject_context_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" AnatomicalEntity : subject_context_qualifier
        click AnatomicalEntity href "../AnatomicalEntity/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_derivative_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" ChemicalEntityDerivativeEnum : subject_derivative_qualifier
        click ChemicalEntityDerivativeEnum href "../ChemicalEntityDerivativeEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_direction_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_feature_name
        
      ChemicalAffectsBiologicalEntityAssociation : subject_form_or_variant_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" ChemicalOrGeneOrGeneProductFormOrVariantEnum : subject_form_or_variant_qualifier
        click ChemicalOrGeneOrGeneProductFormOrVariantEnum href "../ChemicalOrGeneOrGeneProductFormOrVariantEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : subject_label_closure
        
      ChemicalAffectsBiologicalEntityAssociation : subject_namespace
        
      ChemicalAffectsBiologicalEntityAssociation : subject_part_qualifier
        
          
    
        
        
        ChemicalAffectsBiologicalEntityAssociation --> "0..1" GeneOrGeneProductOrChemicalPartQualifierEnum : subject_part_qualifier
        click GeneOrGeneProductOrChemicalPartQualifierEnum href "../GeneOrGeneProductOrChemicalPartQualifierEnum/"
    

        
      ChemicalAffectsBiologicalEntityAssociation : supporting_text
        
      ChemicalAffectsBiologicalEntityAssociation : timepoint
        
      ChemicalAffectsBiologicalEntityAssociation : type
        
      ChemicalAffectsBiologicalEntityAssociation : update_date
...
| ---  | --- | --- | --- |
| [subject_form_or_variant_qualifier](subject_form_or_variant_qualifier.md) | 0..1 <br/> [ChemicalOrGeneOrGeneProductFormOrVariantEnum](ChemicalOrGeneOrGeneProductFormOrVariantEnum.md) | A qualifier that composes with a core subject/object concept to define a spec... | direct |
| [subject_part_qualifier](subject_part_qualifier.md) | 0..1 <br/> [GeneOrGeneProductOrChemicalPartQualifierEnum](GeneOrGeneProductOrChemicalPartQualifierEnum.md) | defines a specific part/component of the core concept (used in cases there th... | direct |
| [subject_derivative_qualifier](subject_derivative_qualifier.md) | 0..1 <br/> [ChemicalEntityDerivativeEnum](ChemicalEntityDerivativeEnum.md) | A qualifier that composes with a core subject/object  concept to describe som... | direct |
...
| [subject_context_qualifier](subject_context_qualifier.md) | 0..1 <br/> [AnatomicalEntity](AnatomicalEntity.md) | A qualifier describing the context in which the subject of an association hol... | direct |
...
| [object_form_or_variant_qualifier](object_form_or_variant_qualifier.md) | 0..1 <br/> [ChemicalOrGeneOrGeneProductFormOrVariantEnum](ChemicalOrGeneOrGeneProductFormOrVariantEnum.md) | A qualifier that composes with a core subject/object concept to define a spec... | direct |
| [object_part_qualifier](object_part_qualifier.md) | 0..1 <br/> [GeneOrGeneProductOrChemicalPartQualifierEnum](GeneOrGeneProductOrChemicalPartQualifierEnum.md) | defines a specific part/component of the core concept (used in cases there th... | direct |
...
| [object_context_qualifier](object_context_qualifier.md) | 0..1 <br/> [AnatomicalEntity](AnatomicalEntity.md) | A qualifier describing the context in which the object of an association hold... | direct |
...
| [anatomical_context_qualifier](anatomical_context_qualifier.md) | * <br/> [AnatomicalEntity](AnatomicalEntity.md) | A statement qualifier representing an anatomical location where an relationsh... | direct |
...
| [subject](subject.md) | 1 <br/> [ChemicalEntity](ChemicalEntity.md) | connects an association to the subject of the association | [Association](Association.md) |
...
| [object](object.md) | 1 <br/> [BiologicalEntity](BiologicalEntity.md) | connects an association to the object of the association | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:ChemicalAffectsBiologicalEntityAssociation |
| native | namo:ChemicalAffectsBiologicalEntityAssociation |
...
<details>
```yaml
name: chemical affects biological entity association
description: Describes an effect that a chemical has on a biological entity (e.g.
...
attributes:
  subject form or variant qualifier:
    ...
    owner: chemical affects biological entity association
    domain_of:
    - predicate mapping
