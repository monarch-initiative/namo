...
_A thing made or adapted for a particular purpose, especially a piece of mechanical or electronic equipment_
...
URI: [namo:Device](https://w3id.org/monarch-initiative/namo/Device)
...
```mermaid
 classDiagram
    ...
    click Device href "../Device/"
      ...
      Device : equivalent_identifiers
        
      Device : exact_synonym
      ...
      Device : information_content
        
      Device : iri
        
      Device : name
        
      Device : narrow_synonym
        
      Device : provided_by
        
      Device : related_synonym
...
| ---  | --- | --- | --- |
| [Treatment](Treatment.md) | [has_device](has_device.md) | range | [Device](Device.md) |
...
| self | namo:Device |
| native | namo:Device |
| narrow | UMLSSG:DEVI, STY:T074, STY:T075, STY:T203 |
