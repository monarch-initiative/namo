...
_A gene is transcribed and potentially translated to a gene product_
...
URI: [namo:GeneToGeneProductRelationship](https://w3id.org/monarch-initiative/namo/GeneToGeneProductRelationship)
 ...
 classDiagram
    ...
    click GeneToGeneProductRelationship href "../GeneToGeneProductRelationship/"
      ...
      GeneToGeneProductRelationship : agent_type
        ...
        GeneToGeneProductRelationship --> "1" AgentTypeEnum : agent_type
      ...
      GeneToGeneProductRelationship : elevate_to_prediction
        
      GeneToGeneProductRelationship : evidence_count
      ...
      GeneToGeneProductRelationship : has_confidence_score
      ...
      GeneToGeneProductRelationship : has_evidence
        ...
        GeneToGeneProductRelationship --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GeneToGeneProductRelationship : has_evidence_of_type
        
          
    
        
        
        GeneToGeneProductRelationship --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GeneToGeneProductRelationship : has_supporting_studies
        
          
    
        
        
        GeneToGeneProductRelationship --> "*" Study : has_supporting_studies
      ...
      GeneToGeneProductRelationship : knowledge_level
        ...
        GeneToGeneProductRelationship --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GeneToGeneProductRelationship : object
        ...
        GeneToGeneProductRelationship --> "1" GeneProductMixin : object
      ...
      GeneToGeneProductRelationship : object_category
        ...
        GeneToGeneProductRelationship --> "0..1" OntologyClass : object_category
      ...
      GeneToGeneProductRelationship : object_feature_name
      ...
      GeneToGeneProductRelationship : semmed_agreement_count
        
      GeneToGeneProductRelationship : sources
        
          
    
        
        
        GeneToGeneProductRelationship --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GeneToGeneProductRelationship : subject
        ...
        GeneToGeneProductRelationship --> "1" Gene : subject
      ...
      GeneToGeneProductRelationship : subject_category
        ...
        GeneToGeneProductRelationship --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| [object](object.md) | 1 <br/> [GeneProductMixin](GeneProductMixin.md) | connects an association to the object of the association | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GeneToGeneProductRelationship |
| native | namo:GeneToGeneProductRelationship |
...
attributes:
  subject:
    ...
    owner: gene to gene product relationship
    domain_of:
    - association
