...
# Slot: exposure_magnitude 


_Magnitude of an exposure event, e.g, parts per million of a toxic chemical._
...
URI: [namo:exposure_magnitude](https://w3id.org/monarch-initiative/namo/exposure_magnitude)
...
| ---  | ---  |
| self | namo:exposure_magnitude |
| native | namo:exposure_magnitude |
...
description: Magnitude of an exposure event, e.g, parts per million of a toxic chemical.
