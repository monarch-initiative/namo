...
_A sequence_variant is a non exact copy of a sequence_feature or genome exhibiting one or more sequence_alteration._
...
URI: [namo:SequenceVariant](https://w3id.org/monarch-initiative/namo/SequenceVariant)
...
```mermaid
 classDiagram
    ...
    click SequenceVariant href "../SequenceVariant/"
      ...
      SequenceVariant : equivalent_identifiers
        
      SequenceVariant : exact_synonym
      ...
      SequenceVariant : information_content
        
      SequenceVariant : iri
        
      SequenceVariant : name
        
      SequenceVariant : narrow_synonym
        
      SequenceVariant : provided_by
        
      SequenceVariant : related_synonym
        
      SequenceVariant : subsets
        
      SequenceVariant : synonym
        
      SequenceVariant : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **SequenceVariant** [ [GenomicEntity](GenomicEntity.md) [PhysicalEssence](PhysicalEssence.md) [OntologyClass](OntologyClass.md)]
                * [Snv](Snv.md)
...
| ---  | --- | --- | --- |
| [has_gene](has_gene.md) | * <br/> [Gene](Gene.md) | Each allele can be associated with any number of genes | direct |
| [hgvs_nomenclature](hgvs_nomenclature.md) | * <br/> [String](String.md) | HGVS syntax refers to the specific rules and conventions used by the Human Va... | direct |
| [has_biological_sequence](has_biological_sequence.md) | 0..1 <br/> [BiologicalSequence](BiologicalSequence.md) | The state of the sequence w | [GenomicEntity](GenomicEntity.md) |
...
| ---  | --- | --- | --- |
| [SequenceVariant](SequenceVariant.md) | [hgvs_nomenclature](hgvs_nomenclature.md) | domain | [SequenceVariant](SequenceVariant.md) |
| [Snv](Snv.md) | [hgvs_nomenclature](hgvs_nomenclature.md) | domain | [SequenceVariant](SequenceVariant.md) |
| [GenotypeToVariantAssociation](GenotypeToVariantAssociation.md) | [object](object.md) | range | [SequenceVariant](SequenceVariant.md) |
| [CaseToVariantAssociation](CaseToVariantAssociation.md) | [object](object.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantToGeneAssociation](VariantToGeneAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantToGeneExpressionAssociation](VariantToGeneExpressionAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantToPopulationAssociation](VariantToPopulationAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantToPhenotypicFeatureAssociation](VariantToPhenotypicFeatureAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantToDiseaseAssociation](VariantToDiseaseAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [VariantAsAModelOfDiseaseAssociation](VariantAsAModelOfDiseaseAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
| [SequenceVariantModulatesTreatmentAssociation](SequenceVariantModulatesTreatmentAssociation.md) | [subject](subject.md) | range | [SequenceVariant](SequenceVariant.md) |
...
| ---  | ---  |
| self | namo:SequenceVariant |
| native | namo:SequenceVariant |
...
attributes:
  ...
  hgvs nomenclature:
    ...
    description: HGVS syntax refers to the specific rules and conventions used by
      the Human Variant Nomenclature Committee to describe the location and change
      in DNA, RNA, and protein sequence variants.  This slot is used to capture all
      the different forms of HGVS nomenclature that may be used to describe a sequence
      variant, including genomic, transcript, and protein HGVS expressions/nomenclatures
      and is thus multivalued.
    comments:
