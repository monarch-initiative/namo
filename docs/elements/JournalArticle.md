...
_an article, typically presenting results of research, that is published in an issue of a scientific journal._
...
URI: [namo:JournalArticle](https://w3id.org/monarch-initiative/namo/JournalArticle)
...
```mermaid
 classDiagram
    ...
    click JournalArticle href "../JournalArticle/"
      ...
      JournalArticle : equivalent_identifiers
        
      JournalArticle : exact_synonym
      ...
      JournalArticle : information_content
      ...
      JournalArticle : related_synonym
...
| ---  | --- | --- | --- |
| [published_in](published_in.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | The enclosing parent serial containing the article should have industry-stand... | [Article](Article.md) |
| [iso_abbreviation](iso_abbreviation.md) | 0..1 <br/> [String](String.md) | Optional value, if used locally as a convenience, is set to the iso abbreviat... | [Article](Article.md) |
| [volume](volume.md) | 0..1 <br/> [String](String.md) | volume of a book or music release in a collection/series or a published colle... | [Article](Article.md) |
| [issue](issue.md) | 0..1 <br/> [String](String.md) | issue of a newspaper, a scientific journal or magazine for reference purpose | [Article](Article.md) |
...
| ---  | ---  |
| self | namo:JournalArticle |
| native | namo:JournalArticle |
| exact | IAO:0000013, fabio:JournalArticle |
