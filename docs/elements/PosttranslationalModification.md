...
_A chemical modification of a polypeptide or protein that occurs after translation, altering its structure, activity, localization, or interactions._
...
URI: [namo:PosttranslationalModification](https://w3id.org/monarch-initiative/namo/PosttranslationalModification)
...
```mermaid
 classDiagram
    ...
    click PosttranslationalModification href "../PosttranslationalModification/"
      ...
      PosttranslationalModification : broad_synonym
      ...
      PosttranslationalModification : equivalent_identifiers
        
      PosttranslationalModification : exact_synonym
      ...
      PosttranslationalModification : information_content
        
      PosttranslationalModification : iri
        
      PosttranslationalModification : name
        
      PosttranslationalModification : narrow_synonym
        
      PosttranslationalModification : provided_by
        
      PosttranslationalModification : related_synonym
        
      PosttranslationalModification : synonym
        
      PosttranslationalModification : taxon
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * **PosttranslationalModification** [ [GeneProductIsoformMixin](GeneProductIsoformMixin.md)]
...
| ---  | ---  |
| self | namo:PosttranslationalModification |
| native | namo:PosttranslationalModification |
| exact | MOD:00000 |
...
description: A chemical modification of a polypeptide or protein that occurs after
  translation, altering its structure, activity, localization, or interactions.
examples:
- value: MOD:00696
...
attributes:
  in taxon:
    ...
    inherited: true
    alias: in_taxon
    owner: posttranslational modification
    domain_of:
    - thing with taxon
