...
_an item that refers to a collection of data from a data source._
...
```mermaid
 classDiagram
    ...
    click Dataset href "../Dataset/"
      ...
      Dataset : equivalent_identifiers
        
      Dataset : exact_synonym
      ...
      Dataset : narrow_synonym
        
      Dataset : provided_by
        
      Dataset : related_synonym
...
| ---  | --- | --- | --- |
| [DatasetVersion](DatasetVersion.md) | [has_dataset](has_dataset.md) | range | [Dataset](Dataset.md) |
...
| self | namo:Dataset |
| native | namo:Dataset |
| exact | IAO:0000100, dctypes:Dataset, schema:dataset, dcid:Dataset |
