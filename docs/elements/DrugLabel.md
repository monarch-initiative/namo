...
URI: [namo:DrugLabel](https://w3id.org/monarch-initiative/namo/DrugLabel)
...
```mermaid
 classDiagram
    ...
    click DrugLabel href "../DrugLabel/"
      ...
      DrugLabel : equivalent_identifiers
        
      DrugLabel : exact_synonym
