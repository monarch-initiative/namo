...
```mermaid
 classDiagram
    ...
    click CellularSystem href "../CellularSystem/"
      ...
      CellularSystem : broad_synonym
        
      CellularSystem : category
      ...
      CellularSystem : deprecated
        
      CellularSystem : description
        
      CellularSystem : equivalent_identifiers
        
      CellularSystem : exact_synonym
        
      CellularSystem : full_name
        
      CellularSystem : has_attribute
        
          
    
        
        
        CellularSystem --> "*" Attribute : has_attribute
      ...
      CellularSystem : information_content
      ...
      CellularSystem : narrow_synonym
        
      CellularSystem : provided_by
      ...
      CellularSystem : related_synonym
        
      CellularSystem : spatial_context
        
      CellularSystem : synonym
        
      CellularSystem : taxon
