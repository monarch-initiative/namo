...
_The age group in which (disease) symptom manifestations appear._
...
URI: [namo:Onset](https://w3id.org/monarch-initiative/namo/Onset)
 ...
 classDiagram
    ...
    click Onset href "../Onset/"
      ...
      Onset : has_attribute_type
        ...
        Onset --> "1" OntologyClass : has_attribute_type
      ...
      Onset : has_qualitative_value
        ...
        Onset --> "0..1" NamedThing : has_qualitative_value
      ...
      Onset : information_content
        
      Onset : iri
        
      Onset : name
        
      Onset : narrow_synonym
        
      Onset : provided_by
        
      Onset : related_synonym
...
| ---  | --- | --- | --- |
| [DiseaseToPhenotypicFeatureAssociation](DiseaseToPhenotypicFeatureAssociation.md) | [onset_qualifier](onset_qualifier.md) | range | [Onset](Onset.md) |
| [CaseToPhenotypicFeatureAssociation](CaseToPhenotypicFeatureAssociation.md) | [onset_qualifier](onset_qualifier.md) | range | [Onset](Onset.md) |
| [CaseToDiseaseAssociation](CaseToDiseaseAssociation.md) | [onset_qualifier](onset_qualifier.md) | range | [Onset](Onset.md) |
...
* This class is in Biolink to support HP ontology annotations which use "onset" (with terms from HP) as an annotation on a disease to phenotypic feature association.  This should be the primary use case for this class.
