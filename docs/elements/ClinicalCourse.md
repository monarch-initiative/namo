...
URI: [namo:ClinicalCourse](https://w3id.org/monarch-initiative/namo/ClinicalCourse)
...
```mermaid
 classDiagram
    ...
    click ClinicalCourse href "../ClinicalCourse/"
      ...
      ClinicalCourse : equivalent_identifiers
        
      ClinicalCourse : exact_synonym
      ...
      ClinicalCourse : has_attribute_type
        ...
        ClinicalCourse --> "1" OntologyClass : has_attribute_type
      ...
      ClinicalCourse : has_qualitative_value
        ...
        ClinicalCourse --> "0..1" NamedThing : has_qualitative_value
      ...
      ClinicalCourse : information_content
        
      ClinicalCourse : iri
        
      ClinicalCourse : name
        
      ClinicalCourse : narrow_synonym
        
      ClinicalCourse : provided_by
        
      ClinicalCourse : related_synonym
        
      ClinicalCourse : subsets
        
      ClinicalCourse : synonym
        
      ClinicalCourse : taxon
...
| ---  | ---  |
| self | namo:ClinicalCourse |
| native | namo:ClinicalCourse |
| exact | HP:0031797 |
