...
_A functional association between a gene (or gene product or macromolecular complex) and a Gene Ontology (GO) term describing the molecular function, biological process, or cellular component in which it participates._
...
URI: [namo:GeneToGoTermAssociation](https://w3id.org/monarch-initiative/namo/GeneToGoTermAssociation)
 ...
 classDiagram
    ...
    click GeneToGoTermAssociation href "../GeneToGoTermAssociation/"
      ...
      GeneToGoTermAssociation : agent_type
        ...
        GeneToGoTermAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GeneToGoTermAssociation : knowledge_level
        ...
        GeneToGoTermAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GeneToGoTermAssociation : object
        ...
        GeneToGoTermAssociation --> "1" OntologyClass : object
      ...
      GeneToGoTermAssociation : object_category
        ...
        GeneToGoTermAssociation --> "0..1" OntologyClass : object_category
        click OntologyClass href "../OntologyClass/"
      ...
      GeneToGoTermAssociation : subject
        ...
        GeneToGoTermAssociation --> "1" Gene : subject
      ...
      GeneToGoTermAssociation : subject_category
        ...
        GeneToGoTermAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [Gene](Gene.md) | gene, product or macromolecular complex that has the function associated with... | [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GeneToGoTermAssociation |
| native | namo:GeneToGoTermAssociation |
| exact | WBVocab:Gene-GO-Association |
...
attributes:
  subject:
    ...
    owner: gene to go term association
    domain_of:
    - association
