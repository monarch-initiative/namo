...
_An association between a gene (or gene product) and a disease for which the gene is statistically correlated with the disease rather than asserted as causal. Such associations typically derive from GWAS, co-occurrence analyses, or other statistical methods, and are annotated with scores such as a z-score or a diseases confidence score._
...
URI: [namo:CorrelatedGeneToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/CorrelatedGeneToDiseaseAssociation)
 ...
 classDiagram
    ...
    click CorrelatedGeneToDiseaseAssociation href "../CorrelatedGeneToDiseaseAssociation/"
      ...
      CorrelatedGeneToDiseaseAssociation : agent_type
        ...
        CorrelatedGeneToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      CorrelatedGeneToDiseaseAssociation : allelic_requirement
      ...
      CorrelatedGeneToDiseaseAssociation : disease_context_qualifier
        
          
    
        
        
        CorrelatedGeneToDiseaseAssociation --> "0..1" Disease : disease_context_qualifier
        click Disease href "../Disease/"
    

        
      CorrelatedGeneToDiseaseAssociation : diseases_confidence_score
        
      CorrelatedGeneToDiseaseAssociation : elevate_to_prediction
        
      CorrelatedGeneToDiseaseAssociation : evidence_count
      ...
      CorrelatedGeneToDiseaseAssociation : has_confidence_score
      ...
      CorrelatedGeneToDiseaseAssociation : has_evidence
        ...
        CorrelatedGeneToDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      CorrelatedGeneToDiseaseAssociation : has_evidence_of_type
        
          
    
        
        
        CorrelatedGeneToDiseaseAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      CorrelatedGeneToDiseaseAssociation : has_supporting_studies
        
          
    
        
        
        CorrelatedGeneToDiseaseAssociation --> "*" Study : has_supporting_studies
      ...
      CorrelatedGeneToDiseaseAssociation : knowledge_level
        ...
        CorrelatedGeneToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      CorrelatedGeneToDiseaseAssociation : object
        ...
        CorrelatedGeneToDiseaseAssociation --> "1" Disease : object
        click Disease href "../Disease/"
      ...
      CorrelatedGeneToDiseaseAssociation : object_aspect_qualifier
        ...
        CorrelatedGeneToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      CorrelatedGeneToDiseaseAssociation : object_category
        ...
        CorrelatedGeneToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      CorrelatedGeneToDiseaseAssociation : object_direction_qualifier
        ...
        CorrelatedGeneToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      CorrelatedGeneToDiseaseAssociation : object_feature_name
      ...
      CorrelatedGeneToDiseaseAssociation : semmed_agreement_count
        
      CorrelatedGeneToDiseaseAssociation : sources
        
          
    
        
        
        CorrelatedGeneToDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      CorrelatedGeneToDiseaseAssociation : subject
        ...
        CorrelatedGeneToDiseaseAssociation --> "1" GeneOrGeneProduct : subject
      ...
      CorrelatedGeneToDiseaseAssociation : subject_aspect_qualifier
        ...
        CorrelatedGeneToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      CorrelatedGeneToDiseaseAssociation : subject_category
        ...
        CorrelatedGeneToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      CorrelatedGeneToDiseaseAssociation : subject_direction_qualifier
        ...
        CorrelatedGeneToDiseaseAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      CorrelatedGeneToDiseaseAssociation : subject_feature_name
        
      CorrelatedGeneToDiseaseAssociation : subject_form_or_variant_qualifier
        
      CorrelatedGeneToDiseaseAssociation : subject_label_closure
        
      CorrelatedGeneToDiseaseAssociation : subject_namespace
        
      CorrelatedGeneToDiseaseAssociation : supporting_text
        
      CorrelatedGeneToDiseaseAssociation : timepoint
        
      CorrelatedGeneToDiseaseAssociation : type
        
      CorrelatedGeneToDiseaseAssociation : update_date
        
      CorrelatedGeneToDiseaseAssociation : z_score
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **CorrelatedGeneToDiseaseAssociation** [ [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md) [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md)]
...
| ---  | --- | --- | --- |
| [z_score](z_score.md) | 0..1 <br/> [Float](Float.md) | A measure of the divergence of an individual experimental result from the mos... | direct |
| [diseases_confidence_score](diseases_confidence_score.md) | 0..1 <br/> [Float](Float.md) | A score defined by Jensen Lab Diseases that reports confidence level in an as... | direct |
...
| [allelic_requirement](allelic_requirement.md) | 0..1 <br/> [String](String.md) | The allele configuration of a particular gene or variant required for the exp... | direct |
...
| [subject](subject.md) | 1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | gene in which variation is shown to correlate with the disease | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | Has a value from the Biolink 'related_to' hierarchy | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
| [object](object.md) | 1 <br/> [Disease](Disease.md) | disease | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:CorrelatedGeneToDiseaseAssociation |
| native | namo:CorrelatedGeneToDiseaseAssociation |
...
description: An association between a gene (or gene product) and a disease for which
  the gene is statistically correlated with the disease rather than asserted as causal.
  Such associations typically derive from GWAS, co-occurrence analyses, or other statistical
  methods, and are annotated with scores such as a z-score or a diseases confidence
  score.
examples:
- object:
    subject: NCBIGene:8506
    predicate: biolink:occurs_together_in_literature_with
    object: MONDO:0004585
    category: biolink:CorrelatedGeneToDiseaseAssociation
    knowledge_level: text_co_occurrence
    agent_type: data_analysis_pipeline
- object:
    subject: UniProtKB:Q2KHT3-1
    predicate: biolink:occurs_together_in_literature_with
    object: MONDO:0005578
    category: biolink:CorrelatedGeneToDiseaseAssociation
    knowledge_level: text_co_occurrence
    agent_type: data_analysis_pipeline
...
attributes:
  z score:
    name: z score
    description: A measure of the divergence of an individual experimental result
      from the most probable result, the mean. Z is expressed in terms of the number
    ...
    domain: association
    alias: z_score
    owner: correlated gene to disease association
    domain_of:
