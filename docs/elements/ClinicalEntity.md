...
_Any entity or process that exists in the clinical domain and outside the biological realm. Diseases are placed under biological entities_
...
URI: [namo:ClinicalEntity](https://w3id.org/monarch-initiative/namo/ClinicalEntity)
...
```mermaid
 classDiagram
    ...
    click ClinicalEntity href "../ClinicalEntity/"
      ...
      ClinicalEntity : equivalent_identifiers
        
      ClinicalEntity : exact_synonym
      ...
      ClinicalEntity : information_content
        
      ClinicalEntity : iri
        
      ClinicalEntity : name
        
      ClinicalEntity : narrow_synonym
        
      ClinicalEntity : provided_by
        
      ClinicalEntity : related_synonym
        
      ClinicalEntity : synonym
        
      ClinicalEntity : taxon
...
| ---  | ---  |
| self | namo:ClinicalEntity |
| native | namo:ClinicalEntity |
