...
# Slot: subject_activity_qualifier 

<div data-search-exclude markdown="1">



URI: [namo:subject_activity_qualifier](https://w3id.org/monarch-initiative/namo/subject_activity_qualifier)
...
| ---  | ---  |
| self | namo:subject_activity_qualifier |
| native | namo:subject_activity_qualifier |
