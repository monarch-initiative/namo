...
_A small RNA molecule that is the product of a longer exogenous or endogenous dsRNA, which is either a bimolecular duplex or very long hairpin, processed (via the Dicer pathway) such that numerous siRNAs accumulate from both strands of the dsRNA. SRNAs trigger the cleavage of their target molecules._
...
URI: [namo:SiRNA](https://w3id.org/monarch-initiative/namo/SiRNA)
...
```mermaid
 classDiagram
    ...
    click SiRNA href "../SiRNA/"
      ...
      SiRNA : information_content
        
      SiRNA : iri
        
      SiRNA : name
        
      SiRNA : narrow_synonym
        
      SiRNA : provided_by
        
      SiRNA : related_synonym
...
| self | namo:SiRNA |
| native | namo:SiRNA |
| exact | SO:0000646, WIKIDATA:Q203221 |
