...
_A result of a concept count analysis._
...
URI: [namo:ConceptCountAnalysisResult](https://w3id.org/monarch-initiative/namo/ConceptCountAnalysisResult)
...
```mermaid
 classDiagram
    ...
    click ConceptCountAnalysisResult href "../ConceptCountAnalysisResult/"
      ...
      ConceptCountAnalysisResult : broad_synonym
      ...
      ConceptCountAnalysisResult : equivalent_identifiers
        
      ConceptCountAnalysisResult : exact_synonym
      ...
      ConceptCountAnalysisResult : information_content
        
      ConceptCountAnalysisResult : iri
        
      ConceptCountAnalysisResult : name
        
      ConceptCountAnalysisResult : narrow_synonym
        
      ConceptCountAnalysisResult : provided_by
        
      ConceptCountAnalysisResult : related_synonym
        
      ConceptCountAnalysisResult : synonym
        
      ConceptCountAnalysisResult : taxon
...
| ---  | ---  |
| self | namo:ConceptCountAnalysisResult |
| native | namo:ConceptCountAnalysisResult |
...
attributes:
  provided by:
    ...
    domain: named thing
    alias: provided_by
    owner: concept count analysis result
    domain_of:
    - named thing
    range: string
    multivalued: true
