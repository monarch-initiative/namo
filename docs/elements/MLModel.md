...
```mermaid
 classDiagram
    ...
    click MLModel href "../MLModel/"
      ...
      MLModel : equivalent_identifiers
        
      MLModel : exact_synonym
      ...
      MLModel : has_attribute
        
          
    
        
        
        MLModel --> "*" Attribute : has_attribute
