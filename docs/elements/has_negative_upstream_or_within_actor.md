...
# Slot: has_negative_upstream_or_within_actor 

<div data-search-exclude markdown="1">



URI: [namo:has_negative_upstream_or_within_actor](https://w3id.org/monarch-initiative/namo/has_negative_upstream_or_within_actor)
...
| Property | Value |
| --- | --- |
| Inverse | [acts_upstream_of_or_within_negative_effect](acts_upstream_of_or_within_negative_effect.md) |
...
| ---  | ---  |
| self | namo:has_negative_upstream_or_within_actor |
| native | namo:has_negative_upstream_or_within_actor |
