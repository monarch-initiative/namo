...
_A boolean flag indicating that an entity is no longer considered current or valid._
...
URI: [namo:deprecated](https://w3id.org/monarch-initiative/namo/deprecated)
...
| ---  | ---  |
| self | namo:deprecated |
| native | namo:deprecated |
