...
_Level of confidence in a statement_
...
URI: [namo:ConfidenceLevel](https://w3id.org/monarch-initiative/namo/ConfidenceLevel)
...
```mermaid
 classDiagram
    ...
    click ConfidenceLevel href "../ConfidenceLevel/"
      ...
      ConfidenceLevel : equivalent_identifiers
        
      ConfidenceLevel : exact_synonym
      ...
      ConfidenceLevel : information_content
      ...
      ConfidenceLevel : narrow_synonym
        
      ConfidenceLevel : provided_by
        
      ConfidenceLevel : related_synonym
        
      ConfidenceLevel : rights
        
      ConfidenceLevel : synonym
        
      ConfidenceLevel : taxon
...
| ---  | ---  |
| self | namo:ConfidenceLevel |
| native | namo:ConfidenceLevel |
| exact | CIO:0000028, SEPIO:0000187 |
| close | SEPIO:0000167 |
