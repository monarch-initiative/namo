...
_A member of a group of unicellular microorganisms lacking a nuclear membrane, that reproduce by binary fission and are often motile._
...
URI: [namo:Bacterium](https://w3id.org/monarch-initiative/namo/Bacterium)
...
```mermaid
 classDiagram
    ...
    click Bacterium href "../Bacterium/"
      ...
      Bacterium : equivalent_identifiers
        
      Bacterium : exact_synonym
      ...
      Bacterium : information_content
        
      Bacterium : iri
        
      Bacterium : name
        
      Bacterium : narrow_synonym
        
      Bacterium : provided_by
        
      Bacterium : related_synonym
...
| ---  | ---  |
| self | namo:Bacterium |
| native | namo:Bacterium |
| exact | NCBITaxon:1869227, STY:T007 |
