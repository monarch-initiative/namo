...
URI: [namo:GeographicLocation](https://w3id.org/monarch-initiative/namo/GeographicLocation)
...
```mermaid
 classDiagram
    ...
    click GeographicLocation href "../GeographicLocation/"
      ...
      GeographicLocation : broad_synonym
      ...
      GeographicLocation : equivalent_identifiers
        
      GeographicLocation : exact_synonym
      ...
      GeographicLocation : information_content
      ...
      GeographicLocation : narrow_synonym
        
      GeographicLocation : provided_by
        
      GeographicLocation : related_synonym
        
      GeographicLocation : synonym
        
      GeographicLocation : taxon
...
| ---  | --- | --- | --- |
| [latitude](latitude.md) | 0..1 <br/> [Float](Float.md) | latitude | direct |
| [longitude](longitude.md) | 0..1 <br/> [Float](Float.md) | longitude | direct |
...
| ---  | ---  |
| self | namo:GeographicLocation |
| native | namo:GeographicLocation |
| exact | UMLSSG:GEOG, STY:T083 |
