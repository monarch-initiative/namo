...
# Slot: chembl_drug_warning 


_Text describing warnings for use of chemicals as therapeutics._
...
URI: [namo:chembl_drug_warning](https://w3id.org/monarch-initiative/namo/chembl_drug_warning)
...
| ---  | ---  |
| self | namo:chembl_drug_warning |
| native | namo:chembl_drug_warning |
