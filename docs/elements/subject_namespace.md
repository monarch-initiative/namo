...
_Used to hold the subject namespace of an association. This is a denormalized field used primarily in the SQL serialization of a knowledge graph via KGX._
...
URI: [namo:subject_namespace](https://w3id.org/monarch-initiative/namo/subject_namespace)
...
| ---  | ---  |
| self | namo:subject_namespace |
| native | namo:subject_namespace |
