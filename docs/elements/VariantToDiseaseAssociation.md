...
_An association between a sequence variant and a disease, in which the allele state of the variant is linked to the disease state._
...
URI: [namo:VariantToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/VariantToDiseaseAssociation)
 ...
 classDiagram
    ...
    click VariantToDiseaseAssociation href "../VariantToDiseaseAssociation/"
      ...
      VariantToDiseaseAssociation : agent_type
        ...
        VariantToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      VariantToDiseaseAssociation : disease_context_qualifier
        
          
    
        
        
        VariantToDiseaseAssociation --> "0..1" Disease : disease_context_qualifier
        click Disease href "../Disease/"
    

        
      VariantToDiseaseAssociation : elevate_to_prediction
        
      VariantToDiseaseAssociation : evidence_count
      ...
      VariantToDiseaseAssociation : has_confidence_score
      ...
      VariantToDiseaseAssociation : has_evidence
        ...
        VariantToDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      VariantToDiseaseAssociation : has_evidence_of_type
        
          
    
        
        
        VariantToDiseaseAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      VariantToDiseaseAssociation : has_supporting_studies
        
          
    
        
        
        VariantToDiseaseAssociation --> "*" Study : has_supporting_studies
      ...
      VariantToDiseaseAssociation : knowledge_level
        ...
        VariantToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      VariantToDiseaseAssociation : object
        ...
        VariantToDiseaseAssociation --> "1" Disease : object
        click Disease href "../Disease/"
      ...
      VariantToDiseaseAssociation : object_aspect_qualifier
        ...
        VariantToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      VariantToDiseaseAssociation : object_category
        ...
        VariantToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      VariantToDiseaseAssociation : object_direction_qualifier
        ...
        VariantToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      VariantToDiseaseAssociation : object_feature_name
      ...
      VariantToDiseaseAssociation : semmed_agreement_count
        
      VariantToDiseaseAssociation : sources
        
          
    
        
        
        VariantToDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      VariantToDiseaseAssociation : subject
        ...
        VariantToDiseaseAssociation --> "1" SequenceVariant : subject
      ...
      VariantToDiseaseAssociation : subject_aspect_qualifier
        ...
        VariantToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      VariantToDiseaseAssociation : subject_category
        ...
        VariantToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      VariantToDiseaseAssociation : subject_direction_qualifier
        ...
        VariantToDiseaseAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      VariantToDiseaseAssociation : subject_feature_name
        
      VariantToDiseaseAssociation : subject_label_closure
        
      VariantToDiseaseAssociation : subject_namespace
        
      VariantToDiseaseAssociation : supporting_text
        
      VariantToDiseaseAssociation : timepoint
        
      VariantToDiseaseAssociation : type
        
      VariantToDiseaseAssociation : update_date
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToDiseaseAssociation** [ [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md) [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md)]
            * [VariantAsAModelOfDiseaseAssociation](VariantAsAModelOfDiseaseAssociation.md) [ [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md) [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md)]
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [SequenceVariant](SequenceVariant.md) | a sequence variant in which the allele state is associated in some way with t... | [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | E | [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [Association](Association.md) |
| [object](object.md) | 1 <br/> [Disease](Disease.md) | a disease that is associated with that variant | [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:VariantToDiseaseAssociation |
| native | namo:VariantToDiseaseAssociation |
...
description: An association between a sequence variant and a disease, in which the
...
attributes:
  subject:
    ...
    owner: variant to disease association
    domain_of:
    - association
