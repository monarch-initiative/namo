...
_An association between a sequence variant and a phenotypic feature, in which the allele state of the variant is linked to the manifestation of the phenotype._
...
URI: [namo:VariantToPhenotypicFeatureAssociation](https://w3id.org/monarch-initiative/namo/VariantToPhenotypicFeatureAssociation)
 ...
 classDiagram
    ...
    click VariantToPhenotypicFeatureAssociation href "../VariantToPhenotypicFeatureAssociation/"
      ...
      VariantToPhenotypicFeatureAssociation : agent_type
        ...
        VariantToPhenotypicFeatureAssociation --> "1" AgentTypeEnum : agent_type
      ...
      VariantToPhenotypicFeatureAssociation : disease_context_qualifier
        
          
    
        
        
        VariantToPhenotypicFeatureAssociation --> "0..1" Disease : disease_context_qualifier
        click Disease href "../Disease/"
    

        
      VariantToPhenotypicFeatureAssociation : elevate_to_prediction
        
      VariantToPhenotypicFeatureAssociation : evidence_count
      ...
      VariantToPhenotypicFeatureAssociation : has_confidence_score
      ...
      VariantToPhenotypicFeatureAssociation : has_evidence
        ...
        VariantToPhenotypicFeatureAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      VariantToPhenotypicFeatureAssociation : has_evidence_of_type
        
          
    
        
        
        VariantToPhenotypicFeatureAssociation --> "*" EvidenceType : has_evidence_of_type
      ...
      VariantToPhenotypicFeatureAssociation : has_supporting_studies
        
          
    
        
        
        VariantToPhenotypicFeatureAssociation --> "*" Study : has_supporting_studies
      ...
      VariantToPhenotypicFeatureAssociation : knowledge_level
        ...
        VariantToPhenotypicFeatureAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      VariantToPhenotypicFeatureAssociation : object
        ...
        VariantToPhenotypicFeatureAssociation --> "1" PhenotypicFeature : object
      ...
      VariantToPhenotypicFeatureAssociation : object_aspect_qualifier
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      VariantToPhenotypicFeatureAssociation : object_category
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" OntologyClass : object_category
      ...
      VariantToPhenotypicFeatureAssociation : object_direction_qualifier
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      VariantToPhenotypicFeatureAssociation : object_feature_name
      ...
      VariantToPhenotypicFeatureAssociation : semmed_agreement_count
      ...
      VariantToPhenotypicFeatureAssociation : sex_qualifier
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" BiologicalSex : sex_qualifier
        click BiologicalSex href "../BiologicalSex/"
    

        
      VariantToPhenotypicFeatureAssociation : sources
        
          
    
        
        
        VariantToPhenotypicFeatureAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      VariantToPhenotypicFeatureAssociation : subject
        ...
        VariantToPhenotypicFeatureAssociation --> "1" SequenceVariant : subject
      ...
      VariantToPhenotypicFeatureAssociation : subject_aspect_qualifier
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      VariantToPhenotypicFeatureAssociation : subject_category
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      VariantToPhenotypicFeatureAssociation : subject_direction_qualifier
        ...
        VariantToPhenotypicFeatureAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      VariantToPhenotypicFeatureAssociation : subject_feature_name
        
      VariantToPhenotypicFeatureAssociation : subject_label_closure
        
      VariantToPhenotypicFeatureAssociation : subject_namespace
        
      VariantToPhenotypicFeatureAssociation : supporting_text
        
      VariantToPhenotypicFeatureAssociation : timepoint
        
      VariantToPhenotypicFeatureAssociation : type
        
      VariantToPhenotypicFeatureAssociation : update_date
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToPhenotypicFeatureAssociation** [ [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md) [EntityToPhenotypicFeatureAssociationMixin](EntityToPhenotypicFeatureAssociationMixin.md)]
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [SequenceVariant](SequenceVariant.md) | a sequence variant in which the allele state is associated in some way with t... | [EntityToPhenotypicFeatureAssociationMixin](EntityToPhenotypicFeatureAssociationMixin.md), [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | Has a value from the Biolink 'related_to' hierarchy | [EntityToPhenotypicFeatureAssociationMixin](EntityToPhenotypicFeatureAssociationMixin.md), [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
| [object](object.md) | 1 <br/> [PhenotypicFeature](PhenotypicFeature.md) | connects an association to the object of the association | [EntityToPhenotypicFeatureAssociationMixin](EntityToPhenotypicFeatureAssociationMixin.md), [VariantToEntityAssociationMixin](VariantToEntityAssociationMixin.md), [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:VariantToPhenotypicFeatureAssociation |
| native | namo:VariantToPhenotypicFeatureAssociation |
...
description: An association between a sequence variant and a phenotypic feature, in
  which the allele state of the variant is linked to the manifestation of the phenotype.
...
attributes:
  subject:
    ...
    owner: variant to phenotypic feature association
    domain_of:
    - association
