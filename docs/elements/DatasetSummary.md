...
_an item that holds summary level information about a dataset._
...
URI: [namo:DatasetSummary](https://w3id.org/monarch-initiative/namo/DatasetSummary)
...
```mermaid
 classDiagram
    ...
    click DatasetSummary href "../DatasetSummary/"
      ...
      DatasetSummary : equivalent_identifiers
        
      DatasetSummary : exact_synonym
      ...
      DatasetSummary : information_content
      ...
      DatasetSummary : narrow_synonym
        
      DatasetSummary : provided_by
        
      DatasetSummary : related_synonym
...
| ---  | --- | --- | --- |
| [source_web_page](source_web_page.md) | 0..1 <br/> [String](String.md) | A URL of a web page that documents or serves as the landing page for a data s... | direct |
| [source_logo](source_logo.md) | 0..1 <br/> [String](String.md) | A URL referencing an image that serves as the visual logo of a data source | direct |
...
| ---  | --- | --- | --- |
| [DatasetSummary](DatasetSummary.md) | [source_web_page](source_web_page.md) | domain | [DatasetSummary](DatasetSummary.md) |
| [DatasetSummary](DatasetSummary.md) | [source_logo](source_logo.md) | domain | [DatasetSummary](DatasetSummary.md) |
...
| ---  | ---  |
| self | namo:DatasetSummary |
| native | namo:DatasetSummary |
...
attributes:
  source web page:
    ...
    description: A URL of a web page that documents or serves as the landing page
      for a data source.
    from_schema: https://w3id.org/monarch-initiative/namo
    broad_mappings:
    - dct:source
    ...
    owner: dataset summary
    domain_of:
    - dataset summary
    range: string
  source logo:
    name: source logo
    description: A URL referencing an image that serves as the visual logo of a data
      source.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    is_a: node property
