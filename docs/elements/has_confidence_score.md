...
# Slot: has_confidence_score 


_connects an association to a quantitative (numeric) value that can be interpreted as an indicator of the degree of confidence that a piece of information is true, and accurately reflects the aspect of reality it is about._
...
URI: [namo:has_confidence_score](https://w3id.org/monarch-initiative/namo/has_confidence_score)
...
| ---  | ---  |
| self | namo:has_confidence_score |
| native | namo:has_confidence_score |
| exact | SEPIO:0000168 |
| close | SEPIO:0000187, SEPIO:0000167 |
...
description: connects an association to a quantitative (numeric) value that can be
  interpreted as an indicator of the degree of confidence that a piece of information
