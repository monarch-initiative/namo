...
_A collection of data items from a study that are about a particular study subject or experimental unit (the 'focus' of the Result) - optionally with context/provenance metadata that may be relevant to the interpretation of this data as evidence._
...
URI: [namo:StudyResult](https://w3id.org/monarch-initiative/namo/StudyResult)
 ...
 classDiagram
    ...
    click StudyResult href "../StudyResult/"
      ...
      StudyResult <|-- ConceptCountAnalysisResult
        click ConceptCountAnalysisResult href "../ConceptCountAnalysisResult/"
      StudyResult <|-- ObservedExpectedFrequencyAnalysisResult
        click ObservedExpectedFrequencyAnalysisResult href "../ObservedExpectedFrequencyAnalysisResult/"
      ...
      StudyResult <|-- ChiSquaredAnalysisResult
        click ChiSquaredAnalysisResult href "../ChiSquaredAnalysisResult/"
      StudyResult <|-- LogOddsAnalysisResult
        click LogOddsAnalysisResult href "../LogOddsAnalysisResult/"
      ...
      StudyResult : narrow_synonym
        
      StudyResult : provided_by
        
      StudyResult : related_synonym
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **StudyResult**
            ...
            * [TextMiningStudyResult](TextMiningStudyResult.md)
            * [IceesStudyResult](IceesStudyResult.md)
...
| ---  | --- | --- | --- |
| [NAMStudy](NAMStudy.md) | [has_study_results](has_study_results.md) | range | [StudyResult](StudyResult.md) |
| [Study](Study.md) | [has_study_results](has_study_results.md) | range | [StudyResult](StudyResult.md) |
| [ClinicalTrial](ClinicalTrial.md) | [has_study_results](has_study_results.md) | range | [StudyResult](StudyResult.md) |
...
| ---  | ---  |
| self | namo:StudyResult |
| native | namo:StudyResult |
