...
URI: [namo:object_aspect_qualifier](https://w3id.org/monarch-initiative/namo/object_aspect_qualifier)
...
| ---  | ---  |
| self | namo:object_aspect_qualifier |
| native | namo:object_aspect_qualifier |
