...
```mermaid
 classDiagram
    ...
    click BiologicalSystem href "../BiologicalSystem/"
      ...
      BiologicalSystem : broad_synonym
        
      BiologicalSystem : category
        
      BiologicalSystem : deprecated
        
      BiologicalSystem : description
        
      BiologicalSystem : equivalent_identifiers
        
      BiologicalSystem : exact_synonym
        
      BiologicalSystem : full_name
        
      BiologicalSystem : has_attribute
        
          
    
        
        
        BiologicalSystem --> "*" Attribute : has_attribute
      ...
      BiologicalSystem : information_content
        
      BiologicalSystem : iri
        
      BiologicalSystem : name
        
      BiologicalSystem : narrow_synonym
        
      BiologicalSystem : provided_by
        
      BiologicalSystem : related_synonym
        
      BiologicalSystem : synonym
        
      BiologicalSystem : taxon
        
      BiologicalSystem : type
        
      BiologicalSystem : xref
