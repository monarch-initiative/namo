...
# Slot: exposure_start_age 


_Starting age of an exposure event._
...
URI: [namo:exposure_start_age](https://w3id.org/monarch-initiative/namo/exposure_start_age)
...
| ---  | ---  |
| self | namo:exposure_start_age |
| native | namo:exposure_start_age |
