...
URI: [namo:resistance_associated_with](https://w3id.org/monarch-initiative/namo/resistance_associated_with)
...
| Property | Value |
| --- | --- |
| Inverse | [associated_with_resistance_to](associated_with_resistance_to.md) |
...
| ---  | ---  |
| self | namo:resistance_associated_with |
| native | namo:resistance_associated_with |
