...
_An association between a genotype and a disease, in which the genotype (typically a combination of alleles at one or more loci) is linked to the disease state._
...
URI: [namo:GenotypeToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/GenotypeToDiseaseAssociation)
 ...
 classDiagram
    ...
    click GenotypeToDiseaseAssociation href "../GenotypeToDiseaseAssociation/"
      GenotypeToEntityAssociationMixin <|-- GenotypeToDiseaseAssociation
        click GenotypeToEntityAssociationMixin href "../GenotypeToEntityAssociationMixin/"
      ...
      GenotypeToDiseaseAssociation : agent_type
        ...
        GenotypeToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GenotypeToDiseaseAssociation : disease_context_qualifier
        
          
    
        
        
        GenotypeToDiseaseAssociation --> "0..1" Disease : disease_context_qualifier
        click Disease href "../Disease/"
    

        
      GenotypeToDiseaseAssociation : elevate_to_prediction
        
      GenotypeToDiseaseAssociation : evidence_count
      ...
      GenotypeToDiseaseAssociation : has_confidence_score
      ...
      GenotypeToDiseaseAssociation : has_evidence
        ...
        GenotypeToDiseaseAssociation --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GenotypeToDiseaseAssociation : has_evidence_of_type
        
          
    
        
        
        GenotypeToDiseaseAssociation --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GenotypeToDiseaseAssociation : has_supporting_studies
        
          
    
        
        
        GenotypeToDiseaseAssociation --> "*" Study : has_supporting_studies
      ...
      GenotypeToDiseaseAssociation : knowledge_level
        ...
        GenotypeToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GenotypeToDiseaseAssociation : object
        ...
        GenotypeToDiseaseAssociation --> "1" Disease : object
        click Disease href "../Disease/"
      ...
      GenotypeToDiseaseAssociation : object_aspect_qualifier
        ...
        GenotypeToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
      ...
      GenotypeToDiseaseAssociation : object_category
        ...
        GenotypeToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      GenotypeToDiseaseAssociation : object_direction_qualifier
        ...
        GenotypeToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      GenotypeToDiseaseAssociation : object_feature_name
      ...
      GenotypeToDiseaseAssociation : semmed_agreement_count
        
      GenotypeToDiseaseAssociation : sources
        
          
    
        
        
        GenotypeToDiseaseAssociation --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GenotypeToDiseaseAssociation : subject
        ...
        GenotypeToDiseaseAssociation --> "1" Genotype : subject
      ...
      GenotypeToDiseaseAssociation : subject_aspect_qualifier
        ...
        GenotypeToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
      ...
      GenotypeToDiseaseAssociation : subject_category
        ...
        GenotypeToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      GenotypeToDiseaseAssociation : subject_direction_qualifier
        ...
        GenotypeToDiseaseAssociation --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      GenotypeToDiseaseAssociation : subject_feature_name
        
      GenotypeToDiseaseAssociation : subject_label_closure
        
      GenotypeToDiseaseAssociation : subject_namespace
        
      GenotypeToDiseaseAssociation : supporting_text
        
      GenotypeToDiseaseAssociation : timepoint
        
      GenotypeToDiseaseAssociation : type
        
      GenotypeToDiseaseAssociation : update_date
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **GenotypeToDiseaseAssociation** [ [GenotypeToEntityAssociationMixin](GenotypeToEntityAssociationMixin.md) [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md)]
            * [GenotypeAsAModelOfDiseaseAssociation](GenotypeAsAModelOfDiseaseAssociation.md) [ [ModelToDiseaseAssociationMixin](ModelToDiseaseAssociationMixin.md) [EntityToDiseaseAssociationMixin](EntityToDiseaseAssociationMixin.md)]
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [Genotype](Genotype.md) | a genotype that is associated in some way with a disease state | [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md), [GenotypeToEntityAssociationMixin](GenotypeToEntityAssociationMixin.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | E | [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md), [GenotypeToEntityAssociationMixin](GenotypeToEntityAssociationMixin.md) |
| [object](object.md) | 1 <br/> [Disease](Disease.md) | a disease that is associated with that genotype | [FrequencyQualifierMixin](FrequencyQualifierMixin.md), [Association](Association.md), [GenotypeToEntityAssociationMixin](GenotypeToEntityAssociationMixin.md) |
...
| ---  | ---  |
| self | namo:GenotypeToDiseaseAssociation |
| native | namo:GenotypeToDiseaseAssociation |
...
description: An association between a genotype and a disease, in which the genotype
  (typically a combination of alleles at one or more loci) is linked to the disease
  state.
comments:
- TODO decide no how to model pathogenicity
...
attributes:
  subject:
    ...
    owner: genotype to disease association
    domain_of:
    - association
