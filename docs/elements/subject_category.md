...
_Used to hold the biolink class/category of an association. This is a denormalized field used primarily in the SQL serialization of a knowledge graph via KGX._
...
URI: [namo:subject_category](https://w3id.org/monarch-initiative/namo/subject_category)
...
| ---  | ---  |
| self | namo:subject_category |
| native | namo:subject_category |
