...
_Represents a protein that is a specific isoform of the canonical or reference RNA_
...
URI: [namo:RNAProductIsoform](https://w3id.org/monarch-initiative/namo/RNAProductIsoform)
...
```mermaid
 classDiagram
    ...
    click RNAProductIsoform href "../RNAProductIsoform/"
      ...
      RNAProductIsoform : broad_synonym
      ...
      RNAProductIsoform : exact_synonym
      ...
      RNAProductIsoform : narrow_synonym
        
      RNAProductIsoform : provided_by
        
      RNAProductIsoform : related_synonym
        
      RNAProductIsoform : synonym
        
      RNAProductIsoform : taxon
        ...
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * [Transcript](Transcript.md)
                * [RNAProduct](RNAProduct.md) [ [GeneProductMixin](GeneProductMixin.md)]
                    * **RNAProductIsoform** [ [GeneProductIsoformMixin](GeneProductIsoformMixin.md)]
...
| ---  | ---  |
| self | namo:RNAProductIsoform |
| native | namo:RNAProductIsoform |
