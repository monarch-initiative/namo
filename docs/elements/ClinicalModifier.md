...
_Used to characterize and specify the phenotypic abnormalities defined in the phenotypic abnormality sub-ontology, with respect to severity, laterality, and other aspects_
...
URI: [namo:ClinicalModifier](https://w3id.org/monarch-initiative/namo/ClinicalModifier)
...
```mermaid
 classDiagram
    ...
    click ClinicalModifier href "../ClinicalModifier/"
      ...
      ClinicalModifier : broad_synonym
      ...
      ClinicalModifier : exact_synonym
      ...
      ClinicalModifier : has_attribute_type
        ...
        ClinicalModifier --> "1" OntologyClass : has_attribute_type
      ...
      ClinicalModifier : has_qualitative_value
        ...
        ClinicalModifier --> "0..1" NamedThing : has_qualitative_value
      ...
      ClinicalModifier : narrow_synonym
        
      ClinicalModifier : provided_by
        
      ClinicalModifier : related_synonym
        
      ClinicalModifier : subsets
        
      ClinicalModifier : synonym
        
      ClinicalModifier : taxon
...
| ---  | ---  |
| self | namo:ClinicalModifier |
| native | namo:ClinicalModifier |
