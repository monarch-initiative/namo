...
_A qualifier describing the context in which the subject of an association holds._
...
URI: [namo:subject_context_qualifier](https://w3id.org/monarch-initiative/namo/subject_context_qualifier)
...
| ---  | ---  |
| self | namo:subject_context_qualifier |
| native | namo:subject_context_qualifier |
