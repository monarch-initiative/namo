...
# Slot: has_supporting_studies 


_Studies that produced information used as evidence to generate the knowledge expressed in an Association._
...
URI: [namo:has_supporting_studies](https://w3id.org/monarch-initiative/namo/has_supporting_studies)
...
| ---  | ---  |
| self | namo:has_supporting_studies |
| native | namo:has_supporting_studies |
| close | OBAN:has_study_id |
...
description: Studies that produced information used as evidence to generate the knowledge
  expressed in an Association.
