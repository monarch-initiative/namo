...
URI: [namo:CaseToEntityAssociationMixin](https://w3id.org/monarch-initiative/namo/CaseToEntityAssociationMixin)
 ...
 classDiagram
    ...
    click CaseToEntityAssociationMixin href "../CaseToEntityAssociationMixin/"
      ...
      CaseToEntityAssociationMixin : object
        ...
        CaseToEntityAssociationMixin --> "1" NamedThing : object
      ...
      CaseToEntityAssociationMixin : subject
        ...
        CaseToEntityAssociationMixin --> "1" Case : subject
...
| ---  | ---  |
| self | namo:CaseToEntityAssociationMixin |
| native | namo:CaseToEntityAssociationMixin |
...
attributes:
  subject:
    ...
    owner: case to entity association mixin
    domain_of:
    - association
