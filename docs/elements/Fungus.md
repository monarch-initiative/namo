...
# Class: Fungus  <span style="color: red;"><strong> (DEPRECATED) </strong></span> 

<div data-search-exclude markdown="1">



URI: [namo:Fungus](https://w3id.org/monarch-initiative/namo/Fungus)
...
```mermaid
 classDiagram
    ...
    click Fungus href "../Fungus/"
      ...
      Fungus : equivalent_identifiers
        
      Fungus : exact_synonym
      ...
      Fungus : information_content
        
      Fungus : iri
        
      Fungus : name
        
      Fungus : narrow_synonym
        
      Fungus : provided_by
        
      Fungus : related_synonym
...
| self | namo:Fungus |
| native | namo:Fungus |
| exact | STY:T004, NCIT:C14209, FOODON:03411261 |
| narrow | FOODON:03315605, NCBITaxon:1670606 |
