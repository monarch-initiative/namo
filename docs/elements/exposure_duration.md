...
_Duration of an exposure event._
...
URI: [namo:exposure_duration](https://w3id.org/monarch-initiative/namo/exposure_duration)
...
| ---  | ---  |
| self | namo:exposure_duration |
| native | namo:exposure_duration |
