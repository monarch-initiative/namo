...
```mermaid
 classDiagram
    ...
    click FunctionalAssay href "../FunctionalAssay/"
      ...
      FunctionalAssay : broad_synonym
        
      FunctionalAssay : category
        
      FunctionalAssay : deprecated
        
      FunctionalAssay : description
        
      FunctionalAssay : equivalent_identifiers
        
      FunctionalAssay : exact_synonym
        
      FunctionalAssay : full_name
        
      FunctionalAssay : has_attribute
        
          
    
        
        
        FunctionalAssay --> "*" Attribute : has_attribute
      ...
      FunctionalAssay : information_content
      ...
      FunctionalAssay : narrow_synonym
        
      FunctionalAssay : provided_by
        
      FunctionalAssay : reference_value
        
      FunctionalAssay : related_synonym
        
      FunctionalAssay : synonym
        
      FunctionalAssay : taxon
        
      FunctionalAssay : type
        
      FunctionalAssay : units
        
      FunctionalAssay : xref
