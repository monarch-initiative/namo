...
# Class: PathwayActivityResult 


_An activity and enrichment measurement for a single biological pathway._
...
URI: [namo:PathwayActivityResult](https://w3id.org/monarch-initiative/namo/PathwayActivityResult)
...
```mermaid
 classDiagram
    ...
    click PathwayActivityResult href "../PathwayActivityResult/"
      ...
      PathwayActivityResult : activity_score
        
      PathwayActivityResult : broad_synonym
        
      PathwayActivityResult : category
        
      PathwayActivityResult : deprecated
        
      PathwayActivityResult : description
        
      PathwayActivityResult : enrichment_score
        
      PathwayActivityResult : equivalent_identifiers
        
      PathwayActivityResult : exact_synonym
        
      PathwayActivityResult : full_name
        
      PathwayActivityResult : has_attribute
        
          
    
        
        
        PathwayActivityResult --> "*" Attribute : has_attribute
        click Attribute href "../Attribute/"
    

        
      PathwayActivityResult : id
        
      PathwayActivityResult : information_content
        
      PathwayActivityResult : iri
        
      PathwayActivityResult : name
        
      PathwayActivityResult : narrow_synonym
        
      PathwayActivityResult : pathway
        
          
    
        
        
        PathwayActivityResult --> "0..1" Pathway : pathway
        click Pathway href "../Pathway/"
    

        
      PathwayActivityResult : provided_by
        
      PathwayActivityResult : related_synonym
        
      PathwayActivityResult : synonym
        
      PathwayActivityResult : taxon
        
      PathwayActivityResult : type
        
      PathwayActivityResult : xref
...
| ---  | --- | --- | --- |
| [pathway](pathway.md) | 0..1 <br/> [Pathway](Pathway.md) | The pathway this measurement is about | direct |
...
| ---  | --- | --- | --- |
| [PathwayConcordance](PathwayConcordance.md) | [active_pathways](active_pathways.md) | range | [PathwayActivityResult](PathwayActivityResult.md) |
| [PathwayConcordance](PathwayConcordance.md) | [divergent_pathways](divergent_pathways.md) | range | [PathwayActivityResult](PathwayActivityResult.md) |
...
| ---  | ---  |
| self | namo:PathwayActivityResult |
| native | namo:PathwayActivityResult |
...
<details>
```yaml
name: PathwayActivityResult
description: An activity and enrichment measurement for a single biological pathway.
from_schema: https://w3id.org/monarch-initiative/namo
is_a: named thing
attributes:
  pathway:
    name: pathway
    description: The pathway this measurement is about. Identifier prefixes follow
      Biolink's `pathway` (REACT, KEGG, GO, ...), which replaces the former pathway_database
      / pathway_id attributes.
    from_schema: https://w3id.org/monarch-initiative/namo
    rank: 1000
    domain_of:
    - PathwayActivityResult
