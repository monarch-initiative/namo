...
| --- | --- | --- |
| [Attribute](Attribute.md) | A property or characteristic of an entity |  yes  |
| [Entity](Entity.md) | Root Biolink Model class for all things and informational relationships, real... |  no  |
| [MacromolecularMachineMixin](MacromolecularMachineMixin.md) | A union of gene locus, gene product, and macromolecular complex |  yes  |
...
| [Agent](Agent.md) | person, group, organization or project that provides a piece of information (... |  yes  |
...
| [GeneOrGeneProductOrGeneFamily](GeneOrGeneProductOrGeneFamily.md) | A union of gene family or gene loci or gene products, useful to define the as... |  no  |
...
| Domain Of | [Attribute](Attribute.md), [Entity](Entity.md), [MacromolecularMachineMixin](MacromolecularMachineMixin.md) |
