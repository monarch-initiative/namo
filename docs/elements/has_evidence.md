...
_Connects an association to detailed information providing supporting evidence._
...
URI: [namo:has_evidence](https://w3id.org/monarch-initiative/namo/has_evidence)
Alias: has_evidence
...
| ---  | ---  |
| self | namo:has_evidence |
| native | namo:has_evidence |
| exact | RO:0002558 |
