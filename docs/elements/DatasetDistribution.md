...
_an item that holds distribution level information about a dataset._
...
URI: [namo:DatasetDistribution](https://w3id.org/monarch-initiative/namo/DatasetDistribution)
...
```mermaid
 classDiagram
    ...
    click DatasetDistribution href "../DatasetDistribution/"
      ...
      DatasetDistribution : broad_synonym
      ...
      DatasetDistribution : equivalent_identifiers
        
      DatasetDistribution : exact_synonym
      ...
      DatasetDistribution : information_content
      ...
      DatasetDistribution : narrow_synonym
        
      DatasetDistribution : provided_by
        
      DatasetDistribution : related_synonym
        
      DatasetDistribution : rights
        
      DatasetDistribution : synonym
        
      DatasetDistribution : taxon
...
| ---  | --- | --- | --- |
| [distribution_download_url](distribution_download_url.md) | 0..1 <br/> [String](String.md) | A URL from which a specific distribution (serialization or format) of a datas... | direct |
...
| ---  | --- | --- | --- |
| [DatasetDistribution](DatasetDistribution.md) | [distribution_download_url](distribution_download_url.md) | domain | [DatasetDistribution](DatasetDistribution.md) |
| [DatasetVersion](DatasetVersion.md) | [has_distribution](has_distribution.md) | range | [DatasetDistribution](DatasetDistribution.md) |
...
| ---  | ---  |
| self | namo:DatasetDistribution |
| native | namo:DatasetDistribution |
...
attributes:
  distribution download url:
    ...
    description: A URL from which a specific distribution (serialization or format)
      of a dataset may be directly downloaded; corresponds to dcat:downloadURL specialised
