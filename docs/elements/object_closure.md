...
_Used to hold the object closure of an association. This is a denormalized field used primarily in the SQL serialization of a knowledge graph via KGX._
...
URI: [namo:object_closure](https://w3id.org/monarch-initiative/namo/object_closure)
...
| ---  | ---  |
| self | namo:object_closure |
| native | namo:object_closure |
