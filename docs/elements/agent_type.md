...
_Describes the high-level category of agent who originally generated a statement of knowledge or other type of information._
...
URI: [namo:agent_type](https://w3id.org/monarch-initiative/namo/agent_type)
Alias: agent_type
...
| Property | Value |
| --- | --- |
| Range | [AgentTypeEnum](AgentTypeEnum.md) |
...
| ---  | ---  |
| self | namo:agent_type |
| native | namo:agent_type |
...
```yaml
name: agent type
description: Describes the high-level category of agent who originally generated a
