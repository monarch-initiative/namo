...
_A series of actions conducted in a certain order or manner_
...
URI: [namo:Procedure](https://w3id.org/monarch-initiative/namo/Procedure)
...
```mermaid
 classDiagram
    ...
    click Procedure href "../Procedure/"
      ...
      Procedure : equivalent_identifiers
        
      Procedure : exact_synonym
      ...
      Procedure : information_content
        
      Procedure : iri
        
      Procedure : name
        
      Procedure : narrow_synonym
        
      Procedure : provided_by
        
      Procedure : related_synonym
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **Procedure** [ [ActivityAndBehavior](ActivityAndBehavior.md)]
...
| ---  | --- | --- | --- |
| [Treatment](Treatment.md) | [has_procedure](has_procedure.md) | range | [Procedure](Procedure.md) |
...
| ---  | ---  |
| self | namo:Procedure |
| native | namo:Procedure |
| exact | UMLSSG:PROC, dcid:MedicalProcedure |
| narrow | STY:T059, STY:T060, STY:T061, STY:T063, MAXO:0000001 |
