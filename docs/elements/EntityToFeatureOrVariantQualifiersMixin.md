...
# Class: EntityToFeatureOrVariantQualifiersMixin 


_Qualifiers for entity to variant associations._
...
URI: [namo:EntityToFeatureOrVariantQualifiersMixin](https://w3id.org/monarch-initiative/namo/EntityToFeatureOrVariantQualifiersMixin)
...
```mermaid
 classDiagram
    ...
    click EntityToFeatureOrVariantQualifiersMixin href "../EntityToFeatureOrVariantQualifiersMixin/"
      ...
      EntityToFeatureOrVariantQualifiersMixin : frequency_qualifier
        
      EntityToFeatureOrVariantQualifiersMixin : object
        
          
    
        
        
        EntityToFeatureOrVariantQualifiersMixin --> "1" NamedThing : object
        click NamedThing href "../NamedThing/"
    

        
      EntityToFeatureOrVariantQualifiersMixin : object_aspect_qualifier
        
          
    
        
        
        EntityToFeatureOrVariantQualifiersMixin --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : object_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
    

        
      EntityToFeatureOrVariantQualifiersMixin : object_direction_qualifier
        
          
    
        
        
        EntityToFeatureOrVariantQualifiersMixin --> "0..1" DirectionQualifierEnum : object_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
    

        
      EntityToFeatureOrVariantQualifiersMixin : predicate
        
      EntityToFeatureOrVariantQualifiersMixin : qualified_predicate
        
      EntityToFeatureOrVariantQualifiersMixin : subject
        
          
    
        
        
        EntityToFeatureOrVariantQualifiersMixin --> "1" NamedThing : subject
        click NamedThing href "../NamedThing/"
    

        
      EntityToFeatureOrVariantQualifiersMixin : subject_aspect_qualifier
        
          
    
        
        
        EntityToFeatureOrVariantQualifiersMixin --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
        click GeneOrGeneProductOrChemicalEntityAspectEnum href "../GeneOrGeneProductOrChemicalEntityAspectEnum/"
    

        
      EntityToFeatureOrVariantQualifiersMixin : subject_direction_qualifier
        
          
    
        
        
        EntityToFeatureOrVariantQualifiersMixin --> "0..1" DirectionQualifierEnum : subject_direction_qualifier
        click DirectionQualifierEnum href "../DirectionQualifierEnum/"
...
| ---  | ---  |
| self | namo:EntityToFeatureOrVariantQualifiersMixin |
| native | namo:EntityToFeatureOrVariantQualifiersMixin |
...
<details>
```yaml
name: entity to feature or variant qualifiers mixin
description: Qualifiers for entity to variant associations.
...
attributes:
  subject aspect qualifier:
    ...
    owner: entity to feature or variant qualifiers mixin
    domain_of:
    - predicate mapping
