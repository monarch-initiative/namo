...
# Slot: object_namespace 


_Used to hold the object namespace of an association. This is a denormalized field used primarily in the SQL serialization of a knowledge graph via KGX._
...
URI: [namo:object_namespace](https://w3id.org/monarch-initiative/namo/object_namespace)
...
| ---  | ---  |
| self | namo:object_namespace |
| native | namo:object_namespace |
