...
URI: [namo:negated](https://w3id.org/monarch-initiative/namo/negated)
...
| Domain Of | [Association](Association.md), [CaseToPhenotypicFeatureAssociation](CaseToPhenotypicFeatureAssociation.md) |
