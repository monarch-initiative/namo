...
_An interaction relationship between two taxa. This may be a symbiotic relationship (encompassing mutualism and parasitism), or it may be non-symbiotic. Example: plague transmitted_by flea; cattle domesticated_by Homo sapiens; plague infects Homo sapiens_
...
URI: [namo:OrganismTaxonToOrganismTaxonInteraction](https://w3id.org/monarch-initiative/namo/OrganismTaxonToOrganismTaxonInteraction)
...
```mermaid
 classDiagram
    class OrganismTaxonToOrganismTaxonInteraction
    click OrganismTaxonToOrganismTaxonInteraction href "../OrganismTaxonToOrganismTaxonInteraction/"
      ...
      OrganismTaxonToOrganismTaxonInteraction : agent_type
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "1" AgentTypeEnum : agent_type
      ...
      OrganismTaxonToOrganismTaxonInteraction : elevate_to_prediction
        
      OrganismTaxonToOrganismTaxonInteraction : evidence_count
      ...
      OrganismTaxonToOrganismTaxonInteraction : has_confidence_score
      ...
      OrganismTaxonToOrganismTaxonInteraction : has_evidence
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      OrganismTaxonToOrganismTaxonInteraction : has_evidence_of_type
        
          
    
        
        
        OrganismTaxonToOrganismTaxonInteraction --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      OrganismTaxonToOrganismTaxonInteraction : has_supporting_studies
        
          
    
        
        
        OrganismTaxonToOrganismTaxonInteraction --> "*" Study : has_supporting_studies
      ...
      OrganismTaxonToOrganismTaxonInteraction : knowledge_level
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      OrganismTaxonToOrganismTaxonInteraction : object
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "1" OrganismTaxon : object
      ...
      OrganismTaxonToOrganismTaxonInteraction : object_category
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "0..1" OntologyClass : object_category
      ...
      OrganismTaxonToOrganismTaxonInteraction : object_feature_name
      ...
      OrganismTaxonToOrganismTaxonInteraction : semmed_agreement_count
        
      OrganismTaxonToOrganismTaxonInteraction : sources
        
          
    
        
        
        OrganismTaxonToOrganismTaxonInteraction --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      OrganismTaxonToOrganismTaxonInteraction : subject
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "1" OrganismTaxon : subject
        click OrganismTaxon href "../OrganismTaxon/"
      ...
      OrganismTaxonToOrganismTaxonInteraction : subject_category
        ...
        OrganismTaxonToOrganismTaxonInteraction --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [associated_environmental_context](associated_environmental_context.md) | 0..1 <br/> [String](String.md) | the environment in which the two taxa interact | direct |
| [subject](subject.md) | 1 <br/> [OrganismTaxon](OrganismTaxon.md) | the taxon that is the subject of the association | [OrganismTaxonToEntityAssociation](OrganismTaxonToEntityAssociation.md), [Association](Association.md) |
| [predicate](predicate.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | Has a value from the Biolink 'related_to' hierarchy | [OrganismTaxonToEntityAssociation](OrganismTaxonToEntityAssociation.md), [Association](Association.md) |
| [object](object.md) | 1 <br/> [OrganismTaxon](OrganismTaxon.md) | the taxon that is the subject of the association | [OrganismTaxonToEntityAssociation](OrganismTaxonToEntityAssociation.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:OrganismTaxonToOrganismTaxonInteraction |
| native | namo:OrganismTaxonToOrganismTaxonInteraction |
...
attributes:
  associated environmental context:
    ...
    owner: organism taxon to organism taxon interaction
    domain_of:
