...
URI: [namo:is_splice_site_variant_of](https://w3id.org/monarch-initiative/namo/is_splice_site_variant_of)
...
| ---  | ---  |
| self | namo:is_splice_site_variant_of |
| native | namo:is_splice_site_variant_of |
| exact | SO:0001629 |
