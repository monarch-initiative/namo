...
_Describes the level of knowledge expressed in a statement, based on the reasoning or analysis methods used to generate the statement, or the scope or specificity of what the statement expresses to be true._
...
URI: [namo:knowledge_level](https://w3id.org/monarch-initiative/namo/knowledge_level)
...
| Property | Value |
| --- | --- |
| Range | [KnowledgeLevelEnum](KnowledgeLevelEnum.md) |
...
| ---  | ---  |
| self | namo:knowledge_level |
| native | namo:knowledge_level |
