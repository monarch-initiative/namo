...
URI: [namo:GenotypicSex](https://w3id.org/monarch-initiative/namo/GenotypicSex)
...
```mermaid
 classDiagram
    ...
    click GenotypicSex href "../GenotypicSex/"
      ...
      GenotypicSex : equivalent_identifiers
        
      GenotypicSex : exact_synonym
      ...
      GenotypicSex : has_attribute_type
        ...
        GenotypicSex --> "1" OntologyClass : has_attribute_type
      ...
      GenotypicSex : has_qualitative_value
        ...
        GenotypicSex --> "0..1" NamedThing : has_qualitative_value
      ...
      GenotypicSex : information_content
        
      GenotypicSex : iri
        
      GenotypicSex : name
        
      GenotypicSex : narrow_synonym
        
      GenotypicSex : provided_by
        
      GenotypicSex : related_synonym
        
      GenotypicSex : subsets
...
| ---  | ---  |
| self | namo:GenotypicSex |
| native | namo:GenotypicSex |
| exact | PATO:0020000 |
