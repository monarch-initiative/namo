...
URI: [namo:knowledge_source](https://w3id.org/monarch-initiative/namo/knowledge_source)
...
| ---  | ---  |
| self | namo:knowledge_source |
| native | namo:knowledge_source |
| close | pav:providedBy |
