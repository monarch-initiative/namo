...
_A gene-to-disease association that is asserted on the grounds that the gene harbours a sequence variant that contributes to the disease. Qualifies the gene with the form or variant that underlies the contribution._
...
URI: [namo:GeneHasVariantThatContributesToDiseaseAssociation](https://w3id.org/monarch-initiative/namo/GeneHasVariantThatContributesToDiseaseAssociation)
 ...
 classDiagram
    ...
    click GeneHasVariantThatContributesToDiseaseAssociation href "../GeneHasVariantThatContributesToDiseaseAssociation/"
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : agent_type
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "1" AgentTypeEnum : agent_type
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : knowledge_level
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : object
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "1" Disease : object
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : object_category
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "0..1" OntologyClass : object_category
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : object_direction_qualifier
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "0..1" DirectionQualifierEnum : object_direction_qualifier
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : predicate
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "1" GeneToDiseasePredicateEnum : predicate
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : subject
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "1" GeneOrGeneProduct : subject
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : subject_aspect_qualifier
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "0..1" GeneOrGeneProductOrChemicalEntityAspectEnum : subject_aspect_qualifier
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : subject_category
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
      ...
      GeneHasVariantThatContributesToDiseaseAssociation : subject_form_or_variant_qualifier
        ...
        GeneHasVariantThatContributesToDiseaseAssociation --> "0..1" ChemicalOrGeneOrGeneProductFormOrVariantEnum : subject_form_or_variant_qualifier
...
| [subject_aspect_qualifier](subject_aspect_qualifier.md) | 0..1 <br/> [GeneOrGeneProductOrChemicalEntityAspectEnum](GeneOrGeneProductOrChemicalEntityAspectEnum.md) | Composes with the core concept to describe new concepts of a different ontolo... | [GeneToDiseaseAssociation](GeneToDiseaseAssociation.md) |
| [object_direction_qualifier](object_direction_qualifier.md) | 0..1 <br/> [DirectionQualifierEnum](DirectionQualifierEnum.md) | Composes with the core concept (+ aspect if provided) to describe a change in... | [GeneToDiseaseAssociation](GeneToDiseaseAssociation.md) |
...
| [qualified_predicate](qualified_predicate.md) | 0..1 <br/> [Uriorcurie](Uriorcurie.md) | Predicate to be used in an association when subject and object qualifiers are... | [GeneToDiseaseAssociation](GeneToDiseaseAssociation.md) |
...
| [subject](subject.md) | 1 <br/> [GeneOrGeneProduct](GeneOrGeneProduct.md) | A gene that has a role in modeling the disease | [GeneToEntityAssociationMixin](GeneToEntityAssociationMixin.md), [Association](Association.md) |
...
| ---  | ---  |
| self | namo:GeneHasVariantThatContributesToDiseaseAssociation |
| native | namo:GeneHasVariantThatContributesToDiseaseAssociation |
...
attributes:
  subject form or variant qualifier:
    ...
    owner: gene has variant that contributes to disease association
    domain_of:
    - predicate mapping
