...
URI: [namo:GenotypeToEntityAssociationMixin](https://w3id.org/monarch-initiative/namo/GenotypeToEntityAssociationMixin)
 ...
 classDiagram
    ...
    click GenotypeToEntityAssociationMixin href "../GenotypeToEntityAssociationMixin/"
      ...
      GenotypeToEntityAssociationMixin : object
        ...
        GenotypeToEntityAssociationMixin --> "1" NamedThing : object
      ...
      GenotypeToEntityAssociationMixin : subject
        ...
        GenotypeToEntityAssociationMixin --> "1" Genotype : subject
...
| ---  | --- | --- | --- |
| [subject](subject.md) | 1 <br/> [Genotype](Genotype.md) | genotype that is the subject of the association | direct |
...
| ---  | ---  |
| self | namo:GenotypeToEntityAssociationMixin |
| native | namo:GenotypeToEntityAssociationMixin |
...
attributes:
  subject:
    ...
    owner: genotype to entity association mixin
    domain_of:
    - association
