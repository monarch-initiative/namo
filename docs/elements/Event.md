...
_Something that happens at a given place and time._
...
URI: [namo:Event](https://w3id.org/monarch-initiative/namo/Event)
...
```mermaid
 classDiagram
    ...
    click Event href "../Event/"
      ...
      Event : narrow_synonym
        
      Event : provided_by
        
      Event : related_synonym
