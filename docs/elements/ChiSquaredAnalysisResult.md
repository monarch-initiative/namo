...
_A result of a chi squared analysis._
...
URI: [namo:ChiSquaredAnalysisResult](https://w3id.org/monarch-initiative/namo/ChiSquaredAnalysisResult)
...
```mermaid
 classDiagram
    ...
    click ChiSquaredAnalysisResult href "../ChiSquaredAnalysisResult/"
      ...
      ChiSquaredAnalysisResult : broad_synonym
      ...
      ChiSquaredAnalysisResult : equivalent_identifiers
        
      ChiSquaredAnalysisResult : exact_synonym
      ...
      ChiSquaredAnalysisResult : information_content
        
      ChiSquaredAnalysisResult : iri
        
      ChiSquaredAnalysisResult : name
        
      ChiSquaredAnalysisResult : narrow_synonym
        
      ChiSquaredAnalysisResult : provided_by
        
      ChiSquaredAnalysisResult : related_synonym
        
      ChiSquaredAnalysisResult : synonym
        
      ChiSquaredAnalysisResult : taxon
...
| ---  | ---  |
| self | namo:ChiSquaredAnalysisResult |
| native | namo:ChiSquaredAnalysisResult |
...
attributes:
  provided by:
    ...
    domain: named thing
    alias: provided_by
    owner: chi squared analysis result
    domain_of:
    - named thing
    range: string
    multivalued: true
