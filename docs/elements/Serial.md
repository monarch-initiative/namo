...
URI: [namo:Serial](https://w3id.org/monarch-initiative/namo/Serial)
...
```mermaid
 classDiagram
    ...
    click Serial href "../Serial/"
      ...
      Serial : equivalent_identifiers
        
      Serial : exact_synonym
...
| ---  | --- | --- | --- |
| [iso_abbreviation](iso_abbreviation.md) | 0..1 <br/> [String](String.md) | Standard abbreviation for periodicals in the International Organization for S... | direct |
...
| [id](id.md) | 1 <br/> [String](String.md) | Serials (journals) should have industry-standard identifier such as from ISSN | [Entity](Entity.md) |
...
| [type](type.md) | * <br/> [String](String.md) | Should generally be set to an ontology class defined term for 'serial' or 'jo... | [Entity](Entity.md) |
