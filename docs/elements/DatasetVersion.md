...
_an item that holds version level information about a dataset._
...
URI: [namo:DatasetVersion](https://w3id.org/monarch-initiative/namo/DatasetVersion)
...
```mermaid
 classDiagram
    ...
    click DatasetVersion href "../DatasetVersion/"
      ...
      DatasetVersion : equivalent_identifiers
        
      DatasetVersion : exact_synonym
      ...
      DatasetVersion : has_dataset
        ...
        DatasetVersion --> "0..1" Dataset : has_dataset
      ...
      DatasetVersion : has_distribution
        ...
        DatasetVersion --> "0..1" DatasetDistribution : has_distribution
      ...
      DatasetVersion : information_content
      ...
      DatasetVersion : narrow_synonym
        
      DatasetVersion : provided_by
        
      DatasetVersion : related_synonym
        
      DatasetVersion : rights
        
      DatasetVersion : synonym
        
      DatasetVersion : taxon
...
| ---  | --- | --- | --- |
| [has_dataset](has_dataset.md) | 0..1 <br/> [Dataset](Dataset.md) | Links a dataset version to the underlying dataset that it is a version of | direct |
| [ingest_date](ingest_date.md) | 0..1 <br/> [String](String.md) | The date on which a dataset version was ingested into the local knowledge gra... | direct |
| [has_distribution](has_distribution.md) | 0..1 <br/> [DatasetDistribution](DatasetDistribution.md) | Links a dataset version to one of its dataset distributions (a specific repre... | direct |
...
| ---  | --- | --- | --- |
| [DatasetVersion](DatasetVersion.md) | [has_dataset](has_dataset.md) | domain | [DatasetVersion](DatasetVersion.md) |
| [DatasetVersion](DatasetVersion.md) | [ingest_date](ingest_date.md) | domain | [DatasetVersion](DatasetVersion.md) |
| [DatasetVersion](DatasetVersion.md) | [has_distribution](has_distribution.md) | domain | [DatasetVersion](DatasetVersion.md) |
...
| ---  | ---  |
| self | namo:DatasetVersion |
| native | namo:DatasetVersion |
