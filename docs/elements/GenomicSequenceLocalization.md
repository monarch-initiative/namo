...
URI: [namo:GenomicSequenceLocalization](https://w3id.org/monarch-initiative/namo/GenomicSequenceLocalization)
...
```mermaid
 classDiagram
    class GenomicSequenceLocalization
    click GenomicSequenceLocalization href "../GenomicSequenceLocalization/"
      ...
      GenomicSequenceLocalization : agent_type
        ...
        GenomicSequenceLocalization --> "1" AgentTypeEnum : agent_type
      ...
      GenomicSequenceLocalization : elevate_to_prediction
        
      GenomicSequenceLocalization : end_interbase_coordinate
        
      GenomicSequenceLocalization : evidence_count
      ...
      GenomicSequenceLocalization : genome_build
        ...
        GenomicSequenceLocalization --> "0..1" StrandEnum : genome_build
      ...
      GenomicSequenceLocalization : has_confidence_score
      ...
      GenomicSequenceLocalization : has_evidence
        ...
        GenomicSequenceLocalization --> "*" InformationContentEntity : has_evidence
        click InformationContentEntity href "../InformationContentEntity/"
    

        
      GenomicSequenceLocalization : has_evidence_of_type
        
          
    
        
        
        GenomicSequenceLocalization --> "*" EvidenceType : has_evidence_of_type
        click EvidenceType href "../EvidenceType/"
    

        
      GenomicSequenceLocalization : has_supporting_studies
        
          
    
        
        
        GenomicSequenceLocalization --> "*" Study : has_supporting_studies
      ...
      GenomicSequenceLocalization : knowledge_level
        ...
        GenomicSequenceLocalization --> "1" KnowledgeLevelEnum : knowledge_level
      ...
      GenomicSequenceLocalization : object
        ...
        GenomicSequenceLocalization --> "1" NucleicAcidEntity : object
      ...
      GenomicSequenceLocalization : object_category
        ...
        GenomicSequenceLocalization --> "0..1" OntologyClass : object_category
      ...
      GenomicSequenceLocalization : object_feature_name
      ...
      GenomicSequenceLocalization : phase
        ...
        GenomicSequenceLocalization --> "0..1" PhaseEnum : phase
      ...
      GenomicSequenceLocalization : semmed_agreement_count
        
      GenomicSequenceLocalization : sources
        
          
    
        
        
        GenomicSequenceLocalization --> "*" RetrievalSource : sources
        click RetrievalSource href "../RetrievalSource/"
      ...
      GenomicSequenceLocalization : strand
        ...
        GenomicSequenceLocalization --> "0..1" StrandEnum : strand
        click StrandEnum href "../StrandEnum/"
      ...
      GenomicSequenceLocalization : subject
        ...
        GenomicSequenceLocalization --> "1" NucleicAcidEntity : subject
        click NucleicAcidEntity href "../NucleicAcidEntity/"
      ...
      GenomicSequenceLocalization : subject_category
        ...
        GenomicSequenceLocalization --> "0..1" OntologyClass : subject_category
        click OntologyClass href "../OntologyClass/"
...
| ---  | --- | --- | --- |
| [start_interbase_coordinate](start_interbase_coordinate.md) | 0..1 <br/> [Integer](Integer.md) | The position at which the subject nucleic acid entity starts on the chromosom... | direct |
| [end_interbase_coordinate](end_interbase_coordinate.md) | 0..1 <br/> [Integer](Integer.md) | The position at which the subject nucleic acid entity ends on the chromosome ... | direct |
| [genome_build](genome_build.md) | 0..1 <br/> [StrandEnum](StrandEnum.md) | The version of the genome on which a feature is located | direct |
| [strand](strand.md) | 0..1 <br/> [StrandEnum](StrandEnum.md) | The strand on which a feature is located | direct |
| [phase](phase.md) | 0..1 <br/> [PhaseEnum](PhaseEnum.md) | The phase for a coding sequence entity | direct |
| [subject](subject.md) | 1 <br/> [NucleicAcidEntity](NucleicAcidEntity.md) | connects an association to the subject of the association | [Association](Association.md) |
...
| [object](object.md) | 1 <br/> [NucleicAcidEntity](NucleicAcidEntity.md) | connects an association to the object of the association | [Association](Association.md) |
...
| ---  | --- | --- | --- |
| [GenomicSequenceLocalization](GenomicSequenceLocalization.md) | [start_interbase_coordinate](start_interbase_coordinate.md) | domain | [GenomicSequenceLocalization](GenomicSequenceLocalization.md) |
| [GenomicSequenceLocalization](GenomicSequenceLocalization.md) | [end_interbase_coordinate](end_interbase_coordinate.md) | domain | [GenomicSequenceLocalization](GenomicSequenceLocalization.md) |
| [GenomicSequenceLocalization](GenomicSequenceLocalization.md) | [genome_build](genome_build.md) | domain | [GenomicSequenceLocalization](GenomicSequenceLocalization.md) |
| [GenomicSequenceLocalization](GenomicSequenceLocalization.md) | [strand](strand.md) | domain | [GenomicSequenceLocalization](GenomicSequenceLocalization.md) |
...
| ---  | ---  |
| self | namo:GenomicSequenceLocalization |
| native | namo:GenomicSequenceLocalization |
