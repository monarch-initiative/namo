...
_A section of a book that forms a discrete unit of a larger published work and may be independently authored or cited._
...
URI: [namo:BookChapter](https://w3id.org/monarch-initiative/namo/BookChapter)
...
```mermaid
 classDiagram
    ...
    click BookChapter href "../BookChapter/"
      ...
      BookChapter : equivalent_identifiers
        
      BookChapter : exact_synonym
      ...
      BookChapter : information_content
...
| ---  | --- | --- | --- |
| [published_in](published_in.md) | 1 <br/> [Uriorcurie](Uriorcurie.md) | The enclosing parent book containing the chapter should have industry-standar... | direct |
...
| [chapter](chapter.md) | 0..1 <br/> [String](String.md) | chapter of a book | direct |
...
| ---  | --- | --- | --- |
| [BookChapter](BookChapter.md) | [chapter](chapter.md) | domain | [BookChapter](BookChapter.md) |
...
| ---  | ---  |
| self | namo:BookChapter |
| native | namo:BookChapter |
...
```yaml
name: book chapter
description: A section of a book that forms a discrete unit of a larger published
  work and may be independently authored or cited.
in_subset:
