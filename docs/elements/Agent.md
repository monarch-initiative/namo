...
URI: [namo:Agent](https://w3id.org/monarch-initiative/namo/Agent)
...
```mermaid
 classDiagram
    ...
    click Agent href "../Agent/"
      ...
      Agent : information_content
        
      Agent : iri
        
      Agent : name
        
      Agent : narrow_synonym
        
      Agent : provided_by
        
      Agent : related_synonym
...
| ---  | --- | --- | --- |
| [affiliation](affiliation.md) | * <br/> [Uriorcurie](Uriorcurie.md) | a professional relationship between one provider (often a person) within anot... | direct |
...
| [id](id.md) | 1 <br/> [String](String.md) | Different classes of agents have distinct preferred identifiers | [Entity](Entity.md) |
