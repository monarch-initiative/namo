...
URI: [namo:GenomicBackgroundExposure](https://w3id.org/monarch-initiative/namo/GenomicBackgroundExposure)
...
```mermaid
 classDiagram
    ...
    click GenomicBackgroundExposure href "../GenomicBackgroundExposure/"
      ...
      GenomicBackgroundExposure : broad_synonym
      ...
      GenomicBackgroundExposure : exact_synonym
      ...
      GenomicBackgroundExposure : narrow_synonym
        
      GenomicBackgroundExposure : provided_by
        
      GenomicBackgroundExposure : related_synonym
        
      GenomicBackgroundExposure : subsets
...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [ExposureEvent](ExposureEvent.md) [ [OntologyClass](OntologyClass.md)]
            * **GenomicBackgroundExposure** [ [GeneGroupingMixin](GeneGroupingMixin.md) [PhysicalEssence](PhysicalEssence.md) [GenomicEntity](GenomicEntity.md) [ThingWithTaxon](ThingWithTaxon.md) [OntologyClass](OntologyClass.md)]
...
| ---  | ---  |
| self | namo:GenomicBackgroundExposure |
| native | namo:GenomicBackgroundExposure |
