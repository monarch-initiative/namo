...
_A small (~22 nucleotide) RNA molecule that is the endogenous transcript of a miRNA gene. Produced from precursor molecules that form hairpin structures, which are processed (typically via the Dicer pathway) to yield a single miRNA molecule. miRNAs function by triggering cleavage of target molecules or acting as translational repressors._
...
URI: [namo:MicroRNA](https://w3id.org/monarch-initiative/namo/MicroRNA)
...
```mermaid
 classDiagram
    ...
    click MicroRNA href "../MicroRNA/"
      ...
      MicroRNA : equivalent_identifiers
        
      MicroRNA : exact_synonym
      ...
      MicroRNA : information_content
        
      MicroRNA : iri
        
      MicroRNA : name
        
      MicroRNA : narrow_synonym
        
      MicroRNA : provided_by
        
      MicroRNA : related_synonym
    ...
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * [Transcript](Transcript.md)
                * [RNAProduct](RNAProduct.md) [ [GeneProductMixin](GeneProductMixin.md)]
...
| ---  | ---  |
| self | namo:MicroRNA |
| native | namo:MicroRNA |
| exact | SO:0000276, SIO:001397, WIKIDATA:Q310899 |
...
- WormBase
- mirbase
description: A small (~22 nucleotide) RNA molecule that is the endogenous transcript
  of a miRNA gene. Produced from precursor molecules that form hairpin structures,
  which are processed (typically via the Dicer pathway) to yield a single miRNA molecule.
  miRNAs function by triggering cleavage of target molecules or acting as translational
  repressors.
in_subset:
