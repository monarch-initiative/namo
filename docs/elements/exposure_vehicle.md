...
# Slot: exposure_vehicle 


_Type of an exposure event._
...
URI: [namo:exposure_vehicle](https://w3id.org/monarch-initiative/namo/exposure_vehicle)
...
| ---  | ---  |
| self | namo:exposure_vehicle |
| native | namo:exposure_vehicle |
