...
URI: [namo:has_attribute](https://w3id.org/monarch-initiative/namo/has_attribute)
Alias: has_attribute
...
| [OrganismalEntity](OrganismalEntity.md) | A named entity that is either a part of an organism, a whole organism, popula... |  yes  |
...
| [ClinicalFinding](ClinicalFinding.md) | this category is currently considered broad enough to tag clinical lab measur... |  yes  |
...
| [SocioeconomicExposure](SocioeconomicExposure.md) | A socioeconomic exposure is a factor relating to social and financial status ... |  yes  |
