...
_A virus is a microorganism that replicates itself as a microRNA and infects the host cell._
...
URI: [namo:Virus](https://w3id.org/monarch-initiative/namo/Virus)
...
```mermaid
 classDiagram
    ...
    click Virus href "../Virus/"
      ...
      Virus : information_content
        
      Virus : iri
        
      Virus : name
        
      Virus : narrow_synonym
        
      Virus : provided_by
        
      Virus : related_synonym
    ...
    * [NamedThing](NamedThing.md)
        * [BiologicalEntity](BiologicalEntity.md) [ [ThingWithTaxon](ThingWithTaxon.md)]
            * [OrganismalEntity](OrganismalEntity.md) [ [SubjectOfInvestigation](SubjectOfInvestigation.md)]
                * **Virus** [ [SubjectOfInvestigation](SubjectOfInvestigation.md)]
...
| self | namo:Virus |
| native | namo:Virus |
| exact | NCBITaxon:10239, STY:T005 |
