...
```mermaid
 classDiagram
    ...
    click Reproducibility href "../Reproducibility/"
      ...
      Reproducibility : equivalent_identifiers
        
      Reproducibility : exact_synonym
        
      Reproducibility : full_name
        
      Reproducibility : has_attribute
        
          
    
        
        
        Reproducibility --> "*" Attribute : has_attribute
      ...
      Reproducibility : information_content
      ...
      Reproducibility : narrow_synonym
        
      Reproducibility : provided_by
      ...
      Reproducibility : related_synonym
