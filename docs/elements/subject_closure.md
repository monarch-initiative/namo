...
_Used to hold the subject closure of an association. This is a denormalized field used primarily in the SQL serialization of a knowledge graph via KGX._
...
URI: [namo:subject_closure](https://w3id.org/monarch-initiative/namo/subject_closure)
...
| ---  | ---  |
| self | namo:subject_closure |
| native | namo:subject_closure |
